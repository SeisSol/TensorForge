        ...
        // C = abs(TMP)
        {
          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              if (v8_lead < 8) {
                #pragma unroll
                for (int32_t v474_k1 = 0; v474_k1 < 8; ++v474_k1) {
                  int32_t v480_a = v474_k1 * 8;
                  int32_t v481_a = v8_lead + v480_a;
                  float v485_data = s0[(v481_a ^ ((v481_a >> 5) & 31))];
                  glb_m2[(v8_lead + v480_a)] = (sycl::fabs(v485_data));
                }
              }
            }
          }
