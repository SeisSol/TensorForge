        ...
        // C = abs(TMP)
        {
          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              if (v8_lead < 8) {
                #pragma unroll
                for (int32_t v464_k1 = 0; v464_k1 < 8; ++v464_k1) {
                  int32_t v470_a = v464_k1 * 8;
                  int32_t v471_a = v8_lead + v470_a;
                  float v475_data = s0[(v471_a ^ ((v471_a >> 5) & 31))];
                  glb_m2[(v8_lead + v470_a)] = (sycl::fabs(v475_data));
                }
              }
            }
          }
