          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              *(sycl::vec<float, 4>*)&s0[0 + 0 + 4 * item.get_local_id(0) + 64] = *(sycl::vec<float, 4>*)&glb_m2[0 + 0 + 4 * item.get_local_id(0) + 64];
              ...
              int32_t v15_a = 0_i32 + 12;
              tensorforge::intel_esimd::simd<float, 16> v19_data;
              v19_data.copy_from(glb_m1 + (12_i32));
              int32_t v22_a = 0_i32 + 24;
              tensorforge::intel_esimd::simd<float, 16> v26_data;
              v26_data.copy_from(glb_m1 + (24_i32));
              int32_t v29_a = 0_i32 + 36;
              tensorforge::intel_esimd::simd<float, 16> v33_data;
              v33_data.copy_from(glb_m1 + (36_i32));
              int32_t v36_a = 0_i32 + 48;
              tensorforge::intel_esimd::simd<float, 16> v40_data;
              v40_data.copy_from(glb_m1 + (48_i32));
              int32_t v43_a = 0_i32 + 60;
              tensorforge::intel_esimd::simd<float, 16> v47_data;
              v47_data.copy_from(glb_m1 + (60_i32));
              int32_t v50_a = 0_i32 + 72;
              tensorforge::intel_esimd::simd<float, 16> v54_data;
              v54_data.copy_from(glb_m1 + (72_i32));
              int32_t v57_a = 0_i32 + 84;
              tensorforge::intel_esimd::simd<float, 16> v61_data;
              v61_data.copy_from(glb_m1 + (84_i32));
              int32_t v64_a = 0_i32 + 96;
              tensorforge::intel_esimd::simd<float, 16> v68_data;
              v68_data.copy_from(glb_m1 + (96_i32));
              int32_t v71_a = 0_i32 + 108;
              tensorforge::intel_esimd::simd<float, 16> v75_data;
              v75_data.copy_from(glb_m1 + (108_i32));
              int32_t v78_a = 0_i32 + 120;
              tensorforge::intel_esimd::simd<float, 16> v82_data;
              v82_data.copy_from(glb_m1 + (120_i32));
              int32_t v85_a = 0_i32 + 132;
              tensorforge::intel_esimd::simd<float, 16> v89_data;
              v89_data.copy_from(glb_m1 + (132_i32));
              int32_t v92_a = 0_i32 + 144;
              tensorforge::intel_esimd::simd<float, 16> v96_data;
              v96_data.copy_from(glb_m1 + (144_i32));
              int32_t v99_a = 0_i32 + 156;
              tensorforge::intel_esimd::simd<float, 16> v103_data;
              v103_data.copy_from(glb_m1 + (156_i32));
              int32_t v106_a = 0_i32 + 168;
              tensorforge::intel_esimd::simd<float, 16> v110_data;
              v110_data.copy_from(glb_m1 + (168_i32));
              int32_t v113_a = 0_i32 + 180;
              tensorforge::intel_esimd::simd<float, 16> v117_data;
              v117_data.copy_from(glb_m1 + (180_i32));
              ...
              #pragma unroll
              for (int32_t v438_n1 = 0; v438_n1 < 8; ++v438_n1) {
                int32_t v439_a = v438_n1 * 16;
                int32_t v440_a = 0 + v439_a;
                tensorforge::intel_esimd::simd<float, 12> v443_data;
                v443_data.copy_from(ir0 + (v439_a));
                int32_t v446_a = v438_n1 * 12;
                int32_t v447_a = 0_i32 + v446_a;
                tensorforge::intel_esimd::simd<float, 12> v452_data;
                v452_data.copy_from(glb_m0 + (v446_a));
                (v452_data + v443_data).copy_to(r0 + (v439_a));
              }
              // glb_m0 = store{r>g}(r0);
              #pragma unroll
              for (int32_t v456_i1 = 0; v456_i1 < 8; ++v456_i1) {
                int32_t v457_a = v456_i1 * 16;
                int32_t v458_a = 0 + v457_a;
                tensorforge::intel_esimd::simd<float, 12> v461_data;
                v461_data.copy_from(r0 + (v457_a));
                v461_data.copy_to(glb_m0 + ((v456_i1 * 12)));
              }
            }
          }
        }
