          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              *(sycl::vec<float, 4>*)&s0[0 + 0 + 4 * item.get_local_id(0) + 64] = *(sycl::vec<float, 4>*)&glb_m2[0 + 0 + 4 * item.get_local_id(0) + 64];
              ...
              v13_data.copy_from(glb_m1 + (12_i32));
              tensorforge::intel_esimd::simd<float, 16> v17_data;
              v17_data.copy_from(glb_m1 + (24_i32));
              tensorforge::intel_esimd::simd<float, 16> v21_data;
              v21_data.copy_from(glb_m1 + (36_i32));
              ...
              #pragma unroll
              for (int32_t v366_n1 = 0; v366_n1 < 8; ++v366_n1) {
                int32_t v367_a = v366_n1 * 16;
                tensorforge::intel_esimd::simd<float, 12> v369_data;
                v369_data.copy_from(ir0 + (v367_a));
                tensorforge::intel_esimd::simd<float, 12> v374_data;
                v374_data.copy_from(glb_m0 + ((v366_n1 * 12)));
                (v374_data + v369_data).copy_to(r0 + (v367_a));
              }
              // glb_m0 = store{r>g}(r0);
              #pragma unroll
              for (int32_t v378_i1 = 0; v378_i1 < 8; ++v378_i1) {
                tensorforge::intel_esimd::simd<float, 12> v381_data;
                v381_data.copy_from(r0 + ((v378_i1 * 16)));
                v381_data.copy_to(glb_m0 + ((v378_i1 * 12)));
              }
            }
          }
        }
