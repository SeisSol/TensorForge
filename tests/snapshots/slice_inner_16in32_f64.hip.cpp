    ...
    // m0 16×8(16×8) {0..16}×{0..8} strided({0..16}×{0..8})[0, 1] = m1 32×32(32×32) {0..32}×{0..32} strided({0..16}×{0..16})[0, -1]×m2 16×8(16×8) {0..16}×{0..8} strided({0..16}×{0..8})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          r1[2] = v30_lin;
          double v31_lin = glb_m2[48 + threadIdx.x * 1];
          r1[3] = v31_lin;
          double v32_lin = glb_m2[64 + threadIdx.x * 1];
          r1[4] = v32_lin;
          double v33_lin = glb_m2[80 + threadIdx.x * 1];
          r1[5] = v33_lin;
          double v34_lin = glb_m2[96 + threadIdx.x * 1];
          r1[6] = v34_lin;
          double v35_lin = glb_m2[112 + threadIdx.x * 1];
          r1[7] = v35_lin;
          ...
          for (int32_t v72_i0 = 0; v72_i0 < 1; ++v72_i0) {
            int32_t v80_lead = v13_lead + (v72_i0 * 16);
            #pragma unroll
