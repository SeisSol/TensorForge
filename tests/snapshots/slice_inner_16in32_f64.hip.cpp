        ...
        if (allowed) {
          ...
          for (int32_t v8_i0 = 0; v8_i0 < 1; ++v8_i0) {
            ...
            for (int32_t v9_i1 = 8; v9_i1 < 24; ++v9_i1) {
              ...
              double v26_data = __builtin_nontemporal_load(&glb_m1[(v23_off + v16_a)]);
          ...
          for (int32_t v74_i0 = 0; v74_i0 < 1; ++v74_i0) {
            int32_t v83_lead = v7_lead + (v74_i0 * 16);
            #pragma unroll
            for (int32_t v75_i1 = 0; v75_i1 < 8; ++v75_i1) {
              int32_t v76_a = v74_i0 + v75_i1;
              double v78_data = r2[(v74_i0 + v75_i1)];
              glb_m0[(v83_lead + (v75_i1 * 16))] = v78_data;
            }
          }
        }
      }
