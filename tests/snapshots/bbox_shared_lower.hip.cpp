// === base name ===
kernel_69eb0a4d3b2f7ed0

// === header ===
void launcher_kernel_69eb0a4d3b2f7ed0(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_69eb0a4d3b2f7ed0(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  dim3 block (16, 16, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_RES(hipOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_69eb0a4d3b2f7ed0, block.x * block.y * block.z, 256 * sizeof(float)));
        CHECK_ERR;
        if (blocksPerSM > 0) {
  ...
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        CHECK_RES(hipFuncSetAttribute(reinterpret_cast<const void*>(&kernel_kernel_69eb0a4d3b2f7ed0), hipFuncAttributeMaxDynamicSharedMemorySize, 256 * sizeof(float)));
        CHECK_ERR;
        shmemsizeset = true;
      }
      
  hipStream_t stream = (streamPtr != nullptr) ? static_cast<hipStream_t>(streamPtr) : 0;
  hipLaunchKernelGGL(kernel_kernel_69eb0a4d3b2f7ed0, grid, block, 256 * sizeof(float), stream,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}
...
__launch_bounds__(256)
 kernel_kernel_69eb0a4d3b2f7ed0(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 ) {
        ...
        if (allowed) {
          ...
          if (v13_lead < 12) {
            ...
            for (int32_t v15_i1 = 0; v15_i1 < 16; ++v15_i1) {
              float v25_data = __builtin_nontemporal_load(&glb_m1[(v22_a + (v15_i1 * 12))]);
              r0[v15_i1] = v25_data;
            }
          }
          float r1[8]{};
          ...
          // glb_m0 = store{r>g}(r2);
          if (v13_lead < 12) {
            int32_t v146_a = ((v13_lead + 16_i32) + -12) - 4;
            #pragma unroll
            for (int32_t v137_i1 = 0; v137_i1 < 8; ++v137_i1) {
              float v139_data = r2[v137_i1];
              glb_m0[(v146_a + (v137_i1 * 12))] = v139_data;
            }
          }
        }
      }
