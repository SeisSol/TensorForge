        ...
        if (allowed) {
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v12_i1 = 0; v12_i1 < 16; ++v12_i1) {
              float v22_data = __builtin_nontemporal_load(&glb_m1[(v19_a + (v12_i1 * 12))]);
              r0[v12_i1] = v22_data;
            }
          }
          float r1[8]{};
          ...
          float v45_data = r0[2];
          float v46_data = r0[3];
          tensorforge::VectorT<float, 4> v47_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v38_tp, v43_data, v42_acc, 2, 0, 0);
          ...
          float v53_data = r0[6];
          float v54_data = r0[7];
          tensorforge::VectorT<float, 4> v55_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v38_tp, v51_data, v50_acc, 2, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v63_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v38_tp, v59_data, v58_acc, 2, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v71_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v38_tp, v67_data, v66_acc, 2, 3, 0);
          ...
          tensorforge::VectorT<float, 4> v92_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v83_tp, v43_data, v87_acc, 2, 0, 0);
          ...
          tensorforge::VectorT<float, 4> v100_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v83_tp, v51_data, v95_acc, 2, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v108_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v83_tp, v59_data, v103_acc, 2, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v116_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v83_tp, v67_data, v111_acc, 2, 3, 0);
          ...
          // glb_m0 = store{r>g}(r2);
          if (v10_lead < 12) {
            int32_t v137_a = ((v10_lead + 16_i32) + -12) - 4;
            #pragma unroll
            for (int32_t v128_i1 = 0; v128_i1 < 8; ++v128_i1) {
              float v130_data = r2[v128_i1];
              glb_m0[(v137_a + (v128_i1 * 12))] = v130_data;
            }
          }
        }
      }
