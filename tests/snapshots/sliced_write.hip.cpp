    ...
    // m0 32×13(32×13) {0..32}×{0..13} strided({0..32}×{6..13})[0, 1] = m1 32×13(32×13) {0..32}×{0..13} strided({0..32}×{10..13})[0, -1]×m2 13×13(13×13) {0..13}×{0..13} strided({10..13}×{6..13})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          tensorforge::fmacdpp16<0>(v25_acc, v33_bc, v22_data);
          tensorforge::fmacdpp16<1>(v25_acc, v33_bc, v23_data);
          tensorforge::fmacdpp16<2>(v25_acc, v33_bc, v24_data);
          tensorforge::fmacdpp16<3>(v26_acc, v33_bc, v22_data);
          tensorforge::fmacdpp16<4>(v26_acc, v33_bc, v23_data);
          tensorforge::fmacdpp16<5>(v26_acc, v33_bc, v24_data);
          tensorforge::fmacdpp16<6>(v27_acc, v33_bc, v22_data);
          tensorforge::fmacdpp16<7>(v27_acc, v33_bc, v23_data);
          tensorforge::fmacdpp16<8>(v27_acc, v33_bc, v24_data);
          tensorforge::fmacdpp16<9>(v28_acc, v33_bc, v22_data);
          tensorforge::fmacdpp16<10>(v28_acc, v33_bc, v23_data);
          tensorforge::fmacdpp16<11>(v28_acc, v33_bc, v24_data);
          tensorforge::fmacdpp16<12>(v29_acc, v33_bc, v22_data);
          tensorforge::fmacdpp16<13>(v29_acc, v33_bc, v23_data);
          tensorforge::fmacdpp16<14>(v29_acc, v33_bc, v24_data);
          tensorforge::fmacdpp16<15>(v30_acc, v33_bc, v22_data);
          float v34_bc = tensorforge::broadcast<32, 16, 1>(v32_lin);
          tensorforge::fmacdpp16<0>(v30_acc, v34_bc, v23_data);
          tensorforge::fmacdpp16<1>(v30_acc, v34_bc, v24_data);
          tensorforge::fmacdpp16<2>(v31_acc, v34_bc, v22_data);
          tensorforge::fmacdpp16<3>(v31_acc, v34_bc, v23_data);
          tensorforge::fmacdpp16<4>(v31_acc, v34_bc, v24_data);
          ir2[0] = v25_acc;
          ir2[1] = v26_acc;
          ir2[2] = v27_acc;
          ir2[3] = v28_acc;
          ...
          for (int32_t v38_i0 = 0; v38_i0 < 1; ++v38_i0) {
            int32_t v43_lead = v38_i0 * 32;
            int32_t v45_a = (v37_lead + v43_lead) + 0;
            glb_m0[v45_a] = 0.0f;
            int32_t v52_a = (v37_lead + v43_lead) + 32;
            glb_m0[v52_a] = 0.0f;
            int32_t v59_a = (v37_lead + v43_lead) + 64;
            glb_m0[v59_a] = 0.0f;
            int32_t v66_a = (v37_lead + v43_lead) + 96;
            glb_m0[v66_a] = 0.0f;
            int32_t v73_a = (v37_lead + v43_lead) + 128;
            glb_m0[v73_a] = 0.0f;
            int32_t v80_a = (v37_lead + v43_lead) + 160;
            glb_m0[v80_a] = 0.0f;
            int32_t v81_a = v38_i0 + 0;
            float v83_data = r2[v38_i0];
            int32_t v89_a = (v37_lead + v43_lead) + 192;
            glb_m0[v89_a] = v83_data;
            int32_t v90_a = v38_i0 + 1;
            float v92_data = r2[(v38_i0 + 1)];
            int32_t v98_a = (v37_lead + v43_lead) + 224;
            glb_m0[v98_a] = v92_data;
            int32_t v99_a = v38_i0 + 2;
            float v101_data = r2[(v38_i0 + 2)];
            int32_t v107_a = (v37_lead + v43_lead) + 256;
            glb_m0[v107_a] = v101_data;
            int32_t v108_a = v38_i0 + 3;
            float v110_data = r2[(v38_i0 + 3)];
            int32_t v116_a = (v37_lead + v43_lead) + 288;
            glb_m0[v116_a] = v110_data;
            int32_t v117_a = v38_i0 + 4;
            float v119_data = r2[(v38_i0 + 4)];
            int32_t v125_a = (v37_lead + v43_lead) + 320;
            glb_m0[v125_a] = v119_data;
            int32_t v126_a = v38_i0 + 5;
            float v128_data = r2[(v38_i0 + 5)];
            int32_t v134_a = (v37_lead + v43_lead) + 352;
            glb_m0[v134_a] = v128_data;
            int32_t v135_a = v38_i0 + 6;
            float v137_data = r2[(v38_i0 + 6)];
            int32_t v143_a = (v37_lead + v43_lead) + 384;
