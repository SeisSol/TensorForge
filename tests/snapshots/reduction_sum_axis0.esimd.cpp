// === base name ===
kernel_92d3e15d98da5d8e

// === header ===
void launcher_kernel_92d3e15d98da5d8e(const float* m0, size_t m0_extraOffset, float* m1, size_t m1_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_92d3e15d98da5d8e(const float* m0, size_t m0_extraOffset, float* m1, size_t m1_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  ...
  kernel_kernel_92d3e15d98da5d8e(stream, grid, block,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_92d3e15d98da5d8e(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, const float* m0, size_t m0_extraOffset, float* m1, size_t m1_extraOffset, size_t numElements0, unsigned* flags0 ) {
        ...
        // OUT = +(A, dims=[0])
        {
          ...
          for (size_t v2_batchId0 = (item.get_local_id(1) + item.get_group().get_local_range(1) * (item.get_group().get_group_id(0))); v2_batchId0 < numElements0; v2_batchId0 += (item.get_global_range(0) * item.get_group().get_local_range(1))) {
            ...
            if (allowed) {
              ...
              tensorforge::intel_esimd::simd<int32_t, 16> v13_lead = tensorforge::intel_esimd::simd<int32_t, 16>(0, 1);
              #pragma unroll
              for (int32_t v12_k1 = 0; v12_k1 < 16; ++v12_k1) {
                tensorforge::intel_esimd::simd<float, 16> v18_data;
                v18_data.copy_from(glb_m0 + ((v12_k1 * 16)));
                glb_m1[v12_k1] = (tensorforge::intel_esimd::reduce<float>(v18_data, std::plus<>()));
              }
            }
          }
        }
