// === base name ===
kernel_edd43a8054030155

// === header ===
void launcher_kernel_edd43a8054030155(const float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, float* m3, size_t m3_extraOffset, const float* m4, size_t m4_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_edd43a8054030155(const float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, float* m3, size_t m3_extraOffset, const float* m4, size_t m4_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  dim3 block (16, 8, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_ERR;
        cudaOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_edd43a8054030155, block.x * block.y * block.z, 2688 * sizeof(float));
        CHECK_ERR;
        if (blocksPerSM > 0) {
  ...
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        cudaFuncSetAttribute(kernel_kernel_edd43a8054030155, cudaFuncAttributeMaxDynamicSharedMemorySize, 2688 * sizeof(float));
        CHECK_ERR;
        shmemsizeset = true;
      }
      
  cudaStream_t stream = (streamPtr != nullptr) ? static_cast<cudaStream_t>(streamPtr) : 0;
  kernel_kernel_edd43a8054030155<<<grid,block,2688 * sizeof(float),stream>>>( m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  m3,  m3_extraOffset,  m4,  m4_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}
...
__launch_bounds__(128)
 kernel_kernel_edd43a8054030155(const float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, float* m3, size_t m3_extraOffset, const float* m4, size_t m4_extraOffset, size_t numElements0, unsigned* flags0 ) {
    ...
    // m3 32×32(12×12) {0..12}×{0..12} strided({0..12}×{0..12})[0, 1] = m4 32×32(12×12) {0..12}×{0..12} strided({0..12}×{0..12})[0, -1]×t0 12×12(12×12) {0..12}×{0..12} pointer_based({0..12}×{0..12})[-1, 1]
    {
      ...
      for (size_t v5_batchId0 = (threadIdx.y + blockDim.y * (blockIdx.x)); v5_batchId0 < numElements0; v5_batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          const float *const __restrict__ glb_m2 = &m2[v5_batchId0 * 72 + 0 + m2_extraOffset];
          float *const __restrict__ glb_m3 = &m3[v5_batchId0 * 144 + 0 + m3_extraOffset];
          const float *const __restrict__ glb_m4 = &m4[v5_batchId0 * 144 + 0 + m4_extraOffset];
          float r0[12]{};
          // r0 = load{g>r}(glb_m0);
          ...
          if (v21_lead < 6) {
            ...
            for (int32_t v23_i1 = 0; v23_i1 < 12; ++v23_i1) {
              float v31_data = __ldcg(&glb_m0[(v21_lead + (v23_i1 * 6))]);
              r0[v23_i1] = v31_data;
            }
          }
          ...
          if (v21_lead < 6) {
            ...
            for (int32_t v39_i1 = 0; v39_i1 < 12; ++v39_i1) {
              float v47_data = __ldcg(&glb_m2[(v21_lead + (v39_i1 * 6))]);
              r2[v39_i1] = v47_data;
            }
          }
          ...
          if (v21_lead < 6) {
            ...
            float v144_data = s0[61];
            float v146_data = r1[5];
            r1[5] = (v146_data + (v118_data * v144_data));
            float v149_data = s0[73];
            float v151_data = r1[6];
            r1[6] = (v151_data + (v118_data * v149_data));
            float v154_data = s0[85];
            float v156_data = r1[7];
            r1[7] = (v156_data + (v118_data * v154_data));
            float v159_data = s0[97];
            float v161_data = r1[8];
            r1[8] = (v161_data + (v118_data * v159_data));
            float v164_data = s0[109];
            float v166_data = r1[9];
            r1[9] = (v166_data + (v118_data * v164_data));
            float v169_data = s0[121];
            float v171_data = r1[10];
            r1[10] = (v171_data + (v118_data * v169_data));
            float v174_data = s0[133];
            float v176_data = r1[11];
            r1[11] = (v176_data + (v118_data * v174_data));
          }
          if (v21_lead < 6) {
            ...
            float v208_data = s0[62];
            float v210_data = r1[5];
            r1[5] = (v210_data + (v182_data * v208_data));
            float v213_data = s0[74];
            float v215_data = r1[6];
            r1[6] = (v215_data + (v182_data * v213_data));
            float v218_data = s0[86];
            float v220_data = r1[7];
            r1[7] = (v220_data + (v182_data * v218_data));
            float v223_data = s0[98];
            float v225_data = r1[8];
            r1[8] = (v225_data + (v182_data * v223_data));
            float v228_data = s0[110];
            float v230_data = r1[9];
            r1[9] = (v230_data + (v182_data * v228_data));
            float v233_data = s0[122];
            float v235_data = r1[10];
            r1[10] = (v235_data + (v182_data * v233_data));
            float v238_data = s0[134];
            float v240_data = r1[11];
            r1[11] = (v240_data + (v182_data * v238_data));
          }
          if (v21_lead < 6) {
            float v246_data = r0[3];
            float v247_data = s0[3];
            float v249_data = r1[0];
            r1[0] = (v249_data + (v246_data * v247_data));
            float v252_data = s0[15];
            float v254_data = r1[1];
            r1[1] = (v254_data + (v246_data * v252_data));
            float v257_data = s0[27];
            float v259_data = r1[2];
            r1[2] = (v259_data + (v246_data * v257_data));
            float v262_data = s0[39];
            float v264_data = r1[3];
            r1[3] = (v264_data + (v246_data * v262_data));
            float v267_data = s0[51];
            float v269_data = r1[4];
            r1[4] = (v269_data + (v246_data * v267_data));
            float v272_data = s0[63];
            float v274_data = r1[5];
            r1[5] = (v274_data + (v246_data * v272_data));
            float v277_data = s0[75];
            float v279_data = r1[6];
            r1[6] = (v279_data + (v246_data * v277_data));
            float v282_data = s0[87];
            float v284_data = r1[7];
            r1[7] = (v284_data + (v246_data * v282_data));
            float v287_data = s0[99];
            float v289_data = r1[8];
            r1[8] = (v289_data + (v246_data * v287_data));
            float v292_data = s0[111];
            float v294_data = r1[9];
            r1[9] = (v294_data + (v246_data * v292_data));
            float v297_data = s0[123];
            float v299_data = r1[10];
            r1[10] = (v299_data + (v246_data * v297_data));
            float v302_data = s0[135];
            float v304_data = r1[11];
            r1[11] = (v304_data + (v246_data * v302_data));
          }
          if (v21_lead < 6) {
            ...
            float v326_data = s0[40];
            float v328_data = r1[3];
            r1[3] = (v328_data + (v310_data * v326_data));
            float v331_data = s0[52];
            float v333_data = r1[4];
            r1[4] = (v333_data + (v310_data * v331_data));
            float v336_data = s0[64];
            float v338_data = r1[5];
            r1[5] = (v338_data + (v310_data * v336_data));
            float v341_data = s0[76];
            float v343_data = r1[6];
            r1[6] = (v343_data + (v310_data * v341_data));
            float v346_data = s0[88];
            float v348_data = r1[7];
            r1[7] = (v348_data + (v310_data * v346_data));
            float v351_data = s0[100];
            float v353_data = r1[8];
            r1[8] = (v353_data + (v310_data * v351_data));
            float v356_data = s0[112];
            float v358_data = r1[9];
            r1[9] = (v358_data + (v310_data * v356_data));
            float v361_data = s0[124];
            float v363_data = r1[10];
            r1[10] = (v363_data + (v310_data * v361_data));
            float v366_data = s0[136];
            float v368_data = r1[11];
            r1[11] = (v368_data + (v310_data * v366_data));
          }
          if (v21_lead < 6) {
            float v374_data = r0[5];
            float v375_data = s0[5];
            float v377_data = r1[0];
            r1[0] = (v377_data + (v374_data * v375_data));
            float v380_data = s0[17];
            float v382_data = r1[1];
            r1[1] = (v382_data + (v374_data * v380_data));
            float v385_data = s0[29];
            float v387_data = r1[2];
            r1[2] = (v387_data + (v374_data * v385_data));
            float v390_data = s0[41];
            float v392_data = r1[3];
            r1[3] = (v392_data + (v374_data * v390_data));
            float v395_data = s0[53];
            float v397_data = r1[4];
            r1[4] = (v397_data + (v374_data * v395_data));
            float v400_data = s0[65];
            float v402_data = r1[5];
            r1[5] = (v402_data + (v374_data * v400_data));
            float v405_data = s0[77];
            float v407_data = r1[6];
            r1[6] = (v407_data + (v374_data * v405_data));
            float v410_data = s0[89];
            float v412_data = r1[7];
            r1[7] = (v412_data + (v374_data * v410_data));
            float v415_data = s0[101];
            float v417_data = r1[8];
            r1[8] = (v417_data + (v374_data * v415_data));
            float v420_data = s0[113];
            float v422_data = r1[9];
            r1[9] = (v422_data + (v374_data * v420_data));
            float v425_data = s0[125];
            float v427_data = r1[10];
            r1[10] = (v427_data + (v374_data * v425_data));
            float v430_data = s0[137];
            float v432_data = r1[11];
            r1[11] = (v432_data + (v374_data * v430_data));
          }
          if (v21_lead < 6) {
            float v438_data = r0[6];
            float v439_data = s0[6];
            float v441_data = r1[0];
            r1[0] = (v441_data + (v438_data * v439_data));
            float v444_data = s0[18];
            float v446_data = r1[1];
            r1[1] = (v446_data + (v438_data * v444_data));
            float v449_data = s0[30];
            float v451_data = r1[2];
            r1[2] = (v451_data + (v438_data * v449_data));
            float v454_data = s0[42];
            float v456_data = r1[3];
            r1[3] = (v456_data + (v438_data * v454_data));
            float v459_data = s0[54];
            float v461_data = r1[4];
            r1[4] = (v461_data + (v438_data * v459_data));
            float v464_data = s0[66];
            float v466_data = r1[5];
            r1[5] = (v466_data + (v438_data * v464_data));
            float v469_data = s0[78];
            float v471_data = r1[6];
            r1[6] = (v471_data + (v438_data * v469_data));
            float v474_data = s0[90];
            float v476_data = r1[7];
            r1[7] = (v476_data + (v438_data * v474_data));
            float v479_data = s0[102];
            float v481_data = r1[8];
            r1[8] = (v481_data + (v438_data * v479_data));
            float v484_data = s0[114];
            float v486_data = r1[9];
            r1[9] = (v486_data + (v438_data * v484_data));
            float v489_data = s0[126];
            float v491_data = r1[10];
            r1[10] = (v491_data + (v438_data * v489_data));
            float v494_data = s0[138];
            float v496_data = r1[11];
            r1[11] = (v496_data + (v438_data * v494_data));
          }
          if (v21_lead < 6) {
            float v502_data = r0[7];
            float v503_data = s0[7];
            float v505_data = r1[0];
            r1[0] = (v505_data + (v502_data * v503_data));
            float v508_data = s0[19];
            float v510_data = r1[1];
            r1[1] = (v510_data + (v502_data * v508_data));
            float v513_data = s0[31];
            float v515_data = r1[2];
            r1[2] = (v515_data + (v502_data * v513_data));
            float v518_data = s0[43];
            float v520_data = r1[3];
            r1[3] = (v520_data + (v502_data * v518_data));
            float v523_data = s0[55];
            float v525_data = r1[4];
            r1[4] = (v525_data + (v502_data * v523_data));
            float v528_data = s0[67];
            float v530_data = r1[5];
            r1[5] = (v530_data + (v502_data * v528_data));
            float v533_data = s0[79];
            float v535_data = r1[6];
            r1[6] = (v535_data + (v502_data * v533_data));
            float v538_data = s0[91];
            float v540_data = r1[7];
            r1[7] = (v540_data + (v502_data * v538_data));
            float v543_data = s0[103];
            float v545_data = r1[8];
            r1[8] = (v545_data + (v502_data * v543_data));
            float v548_data = s0[115];
            float v550_data = r1[9];
            r1[9] = (v550_data + (v502_data * v548_data));
            float v553_data = s0[127];
            float v555_data = r1[10];
            r1[10] = (v555_data + (v502_data * v553_data));
            float v558_data = s0[139];
            float v560_data = r1[11];
            r1[11] = (v560_data + (v502_data * v558_data));
          }
          if (v21_lead < 6) {
            float v566_data = r0[8];
            float v567_data = s0[8];
            float v569_data = r1[0];
            r1[0] = (v569_data + (v566_data * v567_data));
            float v572_data = s0[20];
            float v574_data = r1[1];
            r1[1] = (v574_data + (v566_data * v572_data));
            float v577_data = s0[32];
            float v579_data = r1[2];
            r1[2] = (v579_data + (v566_data * v577_data));
            float v582_data = s0[44];
            float v584_data = r1[3];
            r1[3] = (v584_data + (v566_data * v582_data));
            float v587_data = s0[56];
            float v589_data = r1[4];
            r1[4] = (v589_data + (v566_data * v587_data));
            float v592_data = s0[68];
            float v594_data = r1[5];
            r1[5] = (v594_data + (v566_data * v592_data));
            float v597_data = s0[80];
            float v599_data = r1[6];
            r1[6] = (v599_data + (v566_data * v597_data));
            float v602_data = s0[92];
            float v604_data = r1[7];
            r1[7] = (v604_data + (v566_data * v602_data));
            float v607_data = s0[104];
            float v609_data = r1[8];
            r1[8] = (v609_data + (v566_data * v607_data));
            float v612_data = s0[116];
            float v614_data = r1[9];
            r1[9] = (v614_data + (v566_data * v612_data));
            float v617_data = s0[128];
            float v619_data = r1[10];
            r1[10] = (v619_data + (v566_data * v617_data));
            float v622_data = s0[140];
            float v624_data = r1[11];
            r1[11] = (v624_data + (v566_data * v622_data));
          }
          if (v21_lead < 6) {
            float v630_data = r0[9];
            float v631_data = s0[9];
            float v633_data = r1[0];
            r1[0] = (v633_data + (v630_data * v631_data));
            float v636_data = s0[21];
            float v638_data = r1[1];
            r1[1] = (v638_data + (v630_data * v636_data));
            float v641_data = s0[33];
            float v643_data = r1[2];
            r1[2] = (v643_data + (v630_data * v641_data));
            float v646_data = s0[45];
            float v648_data = r1[3];
            r1[3] = (v648_data + (v630_data * v646_data));
            float v651_data = s0[57];
            float v653_data = r1[4];
            r1[4] = (v653_data + (v630_data * v651_data));
            float v656_data = s0[69];
            float v658_data = r1[5];
            r1[5] = (v658_data + (v630_data * v656_data));
            float v661_data = s0[81];
            float v663_data = r1[6];
            r1[6] = (v663_data + (v630_data * v661_data));
            float v666_data = s0[93];
            float v668_data = r1[7];
            r1[7] = (v668_data + (v630_data * v666_data));
            float v671_data = s0[105];
            float v673_data = r1[8];
            r1[8] = (v673_data + (v630_data * v671_data));
            float v676_data = s0[117];
            float v678_data = r1[9];
            r1[9] = (v678_data + (v630_data * v676_data));
            float v681_data = s0[129];
            float v683_data = r1[10];
            r1[10] = (v683_data + (v630_data * v681_data));
            float v686_data = s0[141];
            float v688_data = r1[11];
            r1[11] = (v688_data + (v630_data * v686_data));
          }
          if (v21_lead < 6) {
            float v694_data = r0[10];
            float v695_data = s0[10];
            float v697_data = r1[0];
            r1[0] = (v697_data + (v694_data * v695_data));
            float v700_data = s0[22];
            float v702_data = r1[1];
            r1[1] = (v702_data + (v694_data * v700_data));
            float v705_data = s0[34];
            float v707_data = r1[2];
            r1[2] = (v707_data + (v694_data * v705_data));
            float v710_data = s0[46];
            float v712_data = r1[3];
            r1[3] = (v712_data + (v694_data * v710_data));
            float v715_data = s0[58];
            float v717_data = r1[4];
            r1[4] = (v717_data + (v694_data * v715_data));
            float v720_data = s0[70];
            float v722_data = r1[5];
            r1[5] = (v722_data + (v694_data * v720_data));
            float v725_data = s0[82];
            float v727_data = r1[6];
            r1[6] = (v727_data + (v694_data * v725_data));
            float v730_data = s0[94];
            float v732_data = r1[7];
            r1[7] = (v732_data + (v694_data * v730_data));
            float v735_data = s0[106];
            float v737_data = r1[8];
            r1[8] = (v737_data + (v694_data * v735_data));
            float v740_data = s0[118];
            float v742_data = r1[9];
            r1[9] = (v742_data + (v694_data * v740_data));
            float v745_data = s0[130];
            float v747_data = r1[10];
            r1[10] = (v747_data + (v694_data * v745_data));
            float v750_data = s0[142];
            float v752_data = r1[11];
            r1[11] = (v752_data + (v694_data * v750_data));
          }
          if (v21_lead < 6) {
            float v758_data = r0[11];
            float v759_data = s0[11];
            float v761_data = r1[0];
            r1[0] = (v761_data + (v758_data * v759_data));
            float v764_data = s0[23];
            float v766_data = r1[1];
            r1[1] = (v766_data + (v758_data * v764_data));
            float v769_data = s0[35];
            float v771_data = r1[2];
            r1[2] = (v771_data + (v758_data * v769_data));
            float v774_data = s0[47];
            float v776_data = r1[3];
            r1[3] = (v776_data + (v758_data * v774_data));
            float v779_data = s0[59];
            float v781_data = r1[4];
            r1[4] = (v781_data + (v758_data * v779_data));
            float v784_data = s0[71];
            float v786_data = r1[5];
            r1[5] = (v786_data + (v758_data * v784_data));
            float v789_data = s0[83];
            float v791_data = r1[6];
            r1[6] = (v791_data + (v758_data * v789_data));
            float v794_data = s0[95];
            float v796_data = r1[7];
            r1[7] = (v796_data + (v758_data * v794_data));
            float v799_data = s0[107];
            float v801_data = r1[8];
            r1[8] = (v801_data + (v758_data * v799_data));
            float v804_data = s0[119];
            float v806_data = r1[9];
            r1[9] = (v806_data + (v758_data * v804_data));
            float v809_data = s0[131];
            float v811_data = r1[10];
            r1[10] = (v811_data + (v758_data * v809_data));
            float v814_data = s0[143];
            float v816_data = r1[11];
            r1[11] = (v816_data + (v758_data * v814_data));
          }
          // s1 = store{r>s}(localShrMem0, r1);
          if (v21_lead < 6) {
            #pragma unroll
            for (int32_t v822_i1 = 0; v822_i1 < 12; ++v822_i1) {
              float v824_data = r1[v822_i1];
              int32_t v831_a = v21_lead + (v822_i1 * 12);
              s1[(v831_a ^ ((v831_a >> 4) & 15))] = v824_data;
            }
          }
          float r4[12]{};
          // r4 = load{g>r}(glb_m4);
          if (v21_lead < 12) {
            ...
            for (int32_t v840_i1 = 0; v840_i1 < 12; ++v840_i1) {
              float v848_data = __ldcg(&glb_m4[(v21_lead + (v840_i1 * 12))]);
              r4[v840_i1] = v848_data;
            }
          }
          ...
          if (v21_lead < 6) {
            ...
            for (int32_t v1624_n1 = 0; v1624_n1 < 12; ++v1624_n1) {
              float v1626_data = ir3[v1624_n1];
              r3[v1624_n1] = v1626_data;
            }
          }
          // s1 = store{r>s}(localShrMem0, r3);
          if (v21_lead < 6) {
            int32_t v1640_off = v21_lead + 6;
            #pragma unroll
            for (int32_t v1632_i1 = 0; v1632_i1 < 12; ++v1632_i1) {
              float v1634_data = r3[v1632_i1];
              int32_t v1642_a = v1640_off + (v1632_i1 * 12);
              s1[(v1642_a ^ ((v1642_a >> 4) & 15))] = v1634_data;
            }
          }
          ...
          if (v21_lead < 12) {
            ...
            for (int32_t v2420_n1 = 0; v2420_n1 < 12; ++v2420_n1) {
              float v2422_data = ir5[v2420_n1];
              r5[v2420_n1] = v2422_data;
            }
          }
          // glb_m3 = store{r>g}(r5);
          if (v21_lead < 12) {
            ...
            for (int32_t v2428_i1 = 0; v2428_i1 < 12; ++v2428_i1) {
              float v2430_data = r5[v2428_i1];
              glb_m3[(v21_lead + (v2428_i1 * 12))] = v2430_data;
            }
          }
          __syncwarp(0x0000ffffu << (threadIdx.y % 2 * 16));
        }
