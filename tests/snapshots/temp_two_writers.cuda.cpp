      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          if (v8_lead < 6) {
            ...
            ir1[8] = (v290_data + (v247_data * v288_data));
            float v293_data = s0[111];
            float v295_data = ir1[9];
            ir1[9] = (v295_data + (v247_data * v293_data));
            float v298_data = s0[123];
            float v300_data = ir1[10];
            ir1[10] = (v300_data + (v247_data * v298_data));
            float v303_data = s0[135];
            float v305_data = ir1[11];
            ir1[11] = (v305_data + (v247_data * v303_data));
          }
          if (v8_lead < 6) {
