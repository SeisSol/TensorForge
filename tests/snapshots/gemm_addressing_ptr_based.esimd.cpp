// === base name ===
kernel_53bd8863dfdc10fd

// === header ===
void launcher_kernel_53bd8863dfdc10fd(float** m0, size_t m0_extraOffset, const float** m1, size_t m1_extraOffset, const float** m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_53bd8863dfdc10fd(float** m0, size_t m0_extraOffset, const float** m1, size_t m1_extraOffset, const float** m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  ...
  kernel_kernel_53bd8863dfdc10fd(stream, grid, block,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_53bd8863dfdc10fd(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, float** m0, size_t m0_extraOffset, const float** m1, size_t m1_extraOffset, const float** m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 ) {
      ...
      cgh.parallel_for(sycl::nd_range<3>{{group_size.get(0), group_size.get(1), group_count.get(0) * group_size.get(2)}, group_size}, sycl::ext::oneapi::experimental::properties{sycl::ext::intel::experimental::grf_size<256>}, [=](sycl::nd_item<3> item) [[intel::sycl_explicit_simd]] [[intel::kernel_args_restrict]] {
        ...
        // m0 16×16(16×16) {0..16}×{0..16} pointer_based({0..16}×{0..16})[0, 1] = m1 16×16(16×16) {0..16}×{0..16} pointer_based({0..16}×{0..16})[0, -1]×m2 16×16(16×16) {0..16}×{0..16} pointer_based({0..16}×{0..16})[-1, 1]
        {
          ...
          for (size_t v3_batchId0 = (item.get_local_id(1) + item.get_group().get_local_range(1) * (item.get_group().get_group_id(0))); v3_batchId0 < numElements0; v3_batchId0 += (item.get_global_range(0) * item.get_group().get_local_range(1))) {
            ...
            if (allowed) {
              float *const __restrict__ glb_m0 = &m0[v3_batchId0][0 + m0_extraOffset];
              ...
              v28_ld.copy_from(glb_m2 + (0 + 0 + 4 * item.get_local_id(0) + 192));
              v28_ld.copy_to(s0 + (0 + 0 + 4 * item.get_local_id(0) + 192));
              ...
              v458_data.copy_from(s0 + (176_i32));
              v454_acc += ((static_cast<float>(v458_data[0])) * v31_data);
              v454_acc += ((static_cast<float>(v458_data[1])) * v32_data);
              v454_acc += ((static_cast<float>(v458_data[2])) * v33_data);
              v454_acc += ((static_cast<float>(v458_data[3])) * v34_data);
              v454_acc += ((static_cast<float>(v458_data[4])) * v35_data);
              v454_acc += ((static_cast<float>(v458_data[5])) * v36_data);
              v454_acc += ((static_cast<float>(v458_data[6])) * v37_data);
              v454_acc += ((static_cast<float>(v458_data[7])) * v38_data);
              v454_acc += ((static_cast<float>(v458_data[8])) * v39_data);
              v454_acc += ((static_cast<float>(v458_data[9])) * v40_data);
              v454_acc += ((static_cast<float>(v458_data[10])) * v41_data);
              v454_acc += ((static_cast<float>(v458_data[11])) * v42_data);
              v454_acc += ((static_cast<float>(v458_data[12])) * v43_data);
              v454_acc += ((static_cast<float>(v458_data[13])) * v44_data);
              v454_acc += ((static_cast<float>(v458_data[14])) * v45_data);
              v454_acc += ((static_cast<float>(v458_data[15])) * v46_data);
              v454_acc.copy_to(ir1 + (176));
              tensorforge::intel_esimd::simd<float, 16> v491_acc{};
              tensorforge::intel_esimd::simd<float, 16> v495_data;
              v495_data.copy_from(s0 + (192_i32));
              v491_acc += ((static_cast<float>(v495_data[0])) * v31_data);
              v491_acc += ((static_cast<float>(v495_data[1])) * v32_data);
              v491_acc += ((static_cast<float>(v495_data[2])) * v33_data);
              v491_acc += ((static_cast<float>(v495_data[3])) * v34_data);
              v491_acc += ((static_cast<float>(v495_data[4])) * v35_data);
              v491_acc += ((static_cast<float>(v495_data[5])) * v36_data);
              v491_acc += ((static_cast<float>(v495_data[6])) * v37_data);
              v491_acc += ((static_cast<float>(v495_data[7])) * v38_data);
              v491_acc += ((static_cast<float>(v495_data[8])) * v39_data);
              v491_acc += ((static_cast<float>(v495_data[9])) * v40_data);
              v491_acc += ((static_cast<float>(v495_data[10])) * v41_data);
              v491_acc += ((static_cast<float>(v495_data[11])) * v42_data);
              v491_acc += ((static_cast<float>(v495_data[12])) * v43_data);
              v491_acc += ((static_cast<float>(v495_data[13])) * v44_data);
              v491_acc += ((static_cast<float>(v495_data[14])) * v45_data);
              v491_acc += ((static_cast<float>(v495_data[15])) * v46_data);
              v491_acc.copy_to(ir1 + (192));
              tensorforge::intel_esimd::simd<float, 16> v528_acc{};
              tensorforge::intel_esimd::simd<float, 16> v532_data;
              v532_data.copy_from(s0 + (208_i32));
              v528_acc += ((static_cast<float>(v532_data[0])) * v31_data);
              v528_acc += ((static_cast<float>(v532_data[1])) * v32_data);
              v528_acc += ((static_cast<float>(v532_data[2])) * v33_data);
              v528_acc += ((static_cast<float>(v532_data[3])) * v34_data);
              v528_acc += ((static_cast<float>(v532_data[4])) * v35_data);
              v528_acc += ((static_cast<float>(v532_data[5])) * v36_data);
              v528_acc += ((static_cast<float>(v532_data[6])) * v37_data);
              v528_acc += ((static_cast<float>(v532_data[7])) * v38_data);
              v528_acc += ((static_cast<float>(v532_data[8])) * v39_data);
              v528_acc += ((static_cast<float>(v532_data[9])) * v40_data);
              v528_acc += ((static_cast<float>(v532_data[10])) * v41_data);
              v528_acc += ((static_cast<float>(v532_data[11])) * v42_data);
              v528_acc += ((static_cast<float>(v532_data[12])) * v43_data);
              v528_acc += ((static_cast<float>(v532_data[13])) * v44_data);
              v528_acc += ((static_cast<float>(v532_data[14])) * v45_data);
              v528_acc += ((static_cast<float>(v532_data[15])) * v46_data);
              v528_acc.copy_to(ir1 + (208));
              tensorforge::intel_esimd::simd<float, 16> v565_acc{};
              tensorforge::intel_esimd::simd<float, 16> v569_data;
              v569_data.copy_from(s0 + (224_i32));
              v565_acc += ((static_cast<float>(v569_data[0])) * v31_data);
              v565_acc += ((static_cast<float>(v569_data[1])) * v32_data);
              v565_acc += ((static_cast<float>(v569_data[2])) * v33_data);
              v565_acc += ((static_cast<float>(v569_data[3])) * v34_data);
              v565_acc += ((static_cast<float>(v569_data[4])) * v35_data);
              v565_acc += ((static_cast<float>(v569_data[5])) * v36_data);
              v565_acc += ((static_cast<float>(v569_data[6])) * v37_data);
              v565_acc += ((static_cast<float>(v569_data[7])) * v38_data);
              v565_acc += ((static_cast<float>(v569_data[8])) * v39_data);
              v565_acc += ((static_cast<float>(v569_data[9])) * v40_data);
              v565_acc += ((static_cast<float>(v569_data[10])) * v41_data);
              v565_acc += ((static_cast<float>(v569_data[11])) * v42_data);
              v565_acc += ((static_cast<float>(v569_data[12])) * v43_data);
              v565_acc += ((static_cast<float>(v569_data[13])) * v44_data);
              v565_acc += ((static_cast<float>(v569_data[14])) * v45_data);
              v565_acc += ((static_cast<float>(v569_data[15])) * v46_data);
              v565_acc.copy_to(ir1 + (224));
              tensorforge::intel_esimd::simd<float, 16> v602_acc{};
              tensorforge::intel_esimd::simd<float, 16> v606_data;
              v606_data.copy_from(s0 + (240_i32));
              v602_acc += ((static_cast<float>(v606_data[0])) * v31_data);
              v602_acc += ((static_cast<float>(v606_data[1])) * v32_data);
              v602_acc += ((static_cast<float>(v606_data[2])) * v33_data);
              v602_acc += ((static_cast<float>(v606_data[3])) * v34_data);
              v602_acc += ((static_cast<float>(v606_data[4])) * v35_data);
              v602_acc += ((static_cast<float>(v606_data[5])) * v36_data);
              v602_acc += ((static_cast<float>(v606_data[6])) * v37_data);
              v602_acc += ((static_cast<float>(v606_data[7])) * v38_data);
              v602_acc += ((static_cast<float>(v606_data[8])) * v39_data);
              v602_acc += ((static_cast<float>(v606_data[9])) * v40_data);
              v602_acc += ((static_cast<float>(v606_data[10])) * v41_data);
              v602_acc += ((static_cast<float>(v606_data[11])) * v42_data);
              v602_acc += ((static_cast<float>(v606_data[12])) * v43_data);
              v602_acc += ((static_cast<float>(v606_data[13])) * v44_data);
              v602_acc += ((static_cast<float>(v606_data[14])) * v45_data);
              v602_acc += ((static_cast<float>(v606_data[15])) * v46_data);
              v602_acc.copy_to(ir1 + (240));
              #pragma unroll
              for (int32_t v639_n0 = 0; v639_n0 < 1; ++v639_n0) {
                int32_t v641_a = v639_n0 * 16;
                #pragma unroll
                for (int32_t v640_n1 = 0; v640_n1 < 16; ++v640_n1) {
                  int32_t v643_a = v641_a + (v640_n1 * 16);
                  tensorforge::intel_esimd::simd<float, 16> v644_data;
                  v644_data.copy_from(ir1 + (v643_a));
                  v644_data.copy_to(r1 + (v643_a));
                }
              }
              // glb_m0 = store{r>g}(r1);
              #pragma unroll
              for (int32_t v648_i0 = 0; v648_i0 < 1; ++v648_i0) {
                int32_t v650_a = v648_i0 * 16;
                #pragma unroll
                for (int32_t v649_i1 = 0; v649_i1 < 16; ++v649_i1) {
                  int32_t v652_a = v650_a + (v649_i1 * 16);
                  tensorforge::intel_esimd::simd<float, 16> v653_data;
                  v653_data.copy_from(r1 + (v652_a));
                  v653_data.copy_to(glb_m0 + (v652_a));
                }
              }
            }
          }
