...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_30b4532394518068 = {{8, 32, 1}, 8, 8, 1, 32, 9216, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_30b4532394518068(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_30b4532394518068(const float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_30b4532394518068(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
  dim3 block (8, 32, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_RES(hipOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_30b4532394518068, block.x * block.y * block.z, 2304 * sizeof(float)));
        CHECK_ERR;
        int gfxMajor = 0;
        ...
        if (gfxMajor >= 10 && (2304 * sizeof(float)) > 0) {
          ...
          CHECK_RES(hipOccupancyMaxActiveBlocksPerMultiprocessor(&blocksNoLds, kernel_kernel_30b4532394518068, block.x * block.y * block.z, 0));
...
void launcher_kernel_30b4532394518068(const float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_30b4532394518068(numElements0, streamPtr);
  dim3 block (config.block[0], config.block[1], config.block[2]);
  dim3 grid (config.grid[0], config.grid[1], config.grid[2]);
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        CHECK_RES(hipFuncSetAttribute(reinterpret_cast<const void*>(&kernel_kernel_30b4532394518068), hipFuncAttributeMaxDynamicSharedMemorySize, config.sharedMemBytes));
        CHECK_ERR;
        shmemsizeset = true;
      }
  ...
  hipLaunchKernelGGL(kernel_kernel_30b4532394518068, grid, block, config.sharedMemBytes, stream, m0Arg, m0_extraOffset, m1Arg, m1_extraOffset, m2Arg, m2_extraOffset, numElements0, flags0Arg);
  CHECK_ERR;
}
        ...
        if (allowed) {
          ...
          for (int32_t v20_i0 = 0; v20_i0 < 1; ++v20_i0) {
            ...
            for (int32_t v21_i1 = 0; v21_i1 < 8; ++v21_i1) {
              float v26_data = __builtin_nontemporal_load(&glb_m0[(v23_lead + (v21_i1 * 8))]);
          ...
          for (int32_t v29_i0 = 0; v29_i0 < 1; ++v29_i0) {
            ...
            for (int32_t v30_i1 = 0; v30_i1 < 8; ++v30_i1) {
              float v35_data = __builtin_nontemporal_load(&glb_m1[(v32_lead + (v30_i1 * 8))]);
          ...
          for (int32_t v96_i0 = 0; v96_i0 < 1; ++v96_i0) {
            ...
            for (int32_t v97_i1 = 0; v97_i1 < 8; ++v97_i1) {
              ...
              int32_t v103_a = v101_lead + (v97_i1 * 8);
              s0[(v103_a ^ ((v103_a >> 5) & 31))] = v99_data;
            }
          }
          // glb_m2 = abs(s0)
          #pragma unroll
          for (int32_t v107_k0 = 0; v107_k0 < 1; ++v107_k0) {
            int32_t v110_lead = v19_lead + (v107_k0 * 8);
            #pragma unroll
            for (int32_t v108_k1 = 0; v108_k1 < 8; ++v108_k1) {
              int32_t v112_a = v110_lead + (v108_k1 * 8);
              float v116_data = s0[(v112_a ^ ((v112_a >> 5) & 31))];
              glb_m2[v112_a] = (fabsf(v116_data));
            }
          }
        }
      }
