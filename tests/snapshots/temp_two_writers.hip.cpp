    ...
    // m3 32×32(12×12) {0..12}×{0..12} strided({0..12}×{0..12})[0, 1] = m4 32×32(12×12) {0..12}×{0..12} strided({0..12}×{0..12})[0, -1]×t0 12×12(12×12) {0..12}×{0..12} pointer_based({0..12}×{0..12})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          float v271_tp{};
          float v272_tp{};
          tensorforge::transpose4x4b32(v269_tp, v270_tp, v271_tp, v272_tp, v115_data, v116_data, v117_data, v118_data);
          ...
          float v308_tp{};
          float v309_tp{};
          tensorforge::transpose4x4b32(v306_tp, v307_tp, v308_tp, v309_tp, v152_data, v153_data, v154_data, v155_data);
          ...
          float v345_tp{};
          float v346_tp{};
          tensorforge::transpose4x4b32(v343_tp, v344_tp, v345_tp, v346_tp, v189_data, v190_data, v191_data, v192_data);
          ...
          if (v8_lead < 12) {
            ...
            for (int32_t v430_i1 = 0; v430_i1 < 12; ++v430_i1) {
              ...
              glb_m3[(v8_lead + (v430_i1 * 12))] = v433_data;
            }
          }
        }
      }
