        ...
        if (allowed) {
          ...
          if (v16_lead < 6) {
            ...
            for (int32_t v224_i1 = 0; v224_i1 < 12; ++v224_i1) {
              ...
              int32_t v233_a = v16_lead + (v224_i1 * 12);
          ...
          if (v16_lead < 12) {
            ...
            for (int32_t v242_i1 = 0; v242_i1 < 12; ++v242_i1) {
              float v250_data = __builtin_nontemporal_load(&glb_m4[(v16_lead + (v242_i1 * 12))]);
          ...
          float v259_tp{};
          float v260_tp{};
          tensorforge::transpose4x4b32(v257_tp, v258_tp, v259_tp, v260_tp, v109_data, v110_data, v111_data, v112_data);
          ...
          float v296_tp{};
          float v297_tp{};
          tensorforge::transpose4x4b32(v294_tp, v295_tp, v296_tp, v297_tp, v146_data, v147_data, v148_data, v149_data);
          ...
          float v333_tp{};
          float v334_tp{};
          tensorforge::transpose4x4b32(v331_tp, v332_tp, v333_tp, v334_tp, v183_data, v184_data, v185_data, v186_data);
          ...
          if (v16_lead < 12) {
            ...
            for (int32_t v447_i1 = 0; v447_i1 < 12; ++v447_i1) {
              ...
              glb_m3[(v16_lead + (v447_i1 * 12))] = v449_data;
            }
          }
        }
      }
