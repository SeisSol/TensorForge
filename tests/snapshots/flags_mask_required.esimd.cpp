...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_ef3ae3a768984620 = {{1, 16, 1}, 16, 16, 1, 16, 17408, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_ef3ae3a768984620(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_ef3ae3a768984620(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_ef3ae3a768984620(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
...
void launcher_kernel_ef3ae3a768984620(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_ef3ae3a768984620(numElements0, streamPtr);
  ...
  kernel_kernel_ef3ae3a768984620(stream, grid, block, m0, m0_extraOffset, m1, m1_extraOffset, m2, m2_extraOffset, numElements0, flags0);
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_ef3ae3a768984620(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0) {
      ...
      tensorforge::slmReserve<4352 * sizeof(float)>(); {
        ...
        // tensorforge-meta: {"fp":"float","launch":{"active_threads":16,"block":[1,16,1],"cooperative":false,"lead_width":1,"mults_per_block":16,"persistent":true,"sections":[{"barrier":false,"mults_per_block":16,"shared_elements":4352}],"shared_bytes":17408,"shared_elements":4352,"threads_per_mult":16},"loops":[],"operands":[{"addressing":"strided","alias":"C","bbox":[[0,0],[16,16]],"name":"m0","ordered":false,"parts":1,"shape":[16,16],"variant":false},{"addressing":"strided","alias":"A","bbox":[[0,0],[16,16]],"name":"m1","ordered":false,"parts":1,"shape":[16,16],"variant":false},{"addressing":"strided","alias":"B","bbox":[[0,0],[16,16]],"name":"m2","ordered":false,"parts":1,"shape":[16,16],"variant":false}],"operations":[{"add":false,"dest":{"addressing":"strided","bbox":[[0,0],[16,16]],"is_tmp":false,"name":"m0","offset":[0,0],"shape":[16,16]},"kind":"multilinear","ops":[{"addressing":"strided","bbox":[[0,0],[16,16]],"is_tmp":false,"name":"m1","offset":[0,0],"shape":[16,16]},{"addressing":"strided","bbox":[[0,0],[16,16]],"is_tmp":false,"name":"m2","offset":[0,0],"shape":[16,16]}],"permute":[[0,1],[0,1]],"target":[[0,-1],[-1,1]]}],"version":"0.0.1\n"}
        {
          ...
          for (size_t v5_batchId0 = (item.get_local_id(1) + item.get_group().get_local_range(1) * (item.get_group().get_group_id(2))); v5_batchId0 < numElements0; v5_batchId0 += (item.get_group_range(2) * item.get_group().get_local_range(1))) {
            ...
            const bool allowed = static_cast<bool>(flags0[v5_batchId0]);
            if (allowed) {
              ...
              v27_ld.copy_from(glb_m2 + (0 + 0 + 4 * 0 + 128));
              tensorforge::slmStore<float, 64>(s0 + (0 + 0 + 4 * 0 + 128), v27_ld);
              tensorforge::intel_esimd::simd<float, 64> v28_ld;
              v28_ld.copy_from(glb_m2 + (0 + 0 + 4 * 0 + 192));
              tensorforge::slmStore<float, 64>(s0 + (0 + 0 + 4 * 0 + 192), v28_ld);
              ...
              tensorforge::intel_esimd::simd<float, 16> v436_data = tensorforge::slmLoad<float, 16>(s0 + (176_i32));
              v434_acc += ((static_cast<float>(v436_data[0])) * v31_data);
              v434_acc += ((static_cast<float>(v436_data[1])) * v32_data);
              v434_acc += ((static_cast<float>(v436_data[2])) * v33_data);
              v434_acc += ((static_cast<float>(v436_data[3])) * v34_data);
              v434_acc += ((static_cast<float>(v436_data[4])) * v35_data);
              v434_acc += ((static_cast<float>(v436_data[5])) * v36_data);
              v434_acc += ((static_cast<float>(v436_data[6])) * v37_data);
              v434_acc += ((static_cast<float>(v436_data[7])) * v38_data);
              v434_acc += ((static_cast<float>(v436_data[8])) * v39_data);
              v434_acc += ((static_cast<float>(v436_data[9])) * v40_data);
              v434_acc += ((static_cast<float>(v436_data[10])) * v41_data);
              v434_acc += ((static_cast<float>(v436_data[11])) * v42_data);
              v434_acc += ((static_cast<float>(v436_data[12])) * v43_data);
              v434_acc += ((static_cast<float>(v436_data[13])) * v44_data);
              v434_acc += ((static_cast<float>(v436_data[14])) * v45_data);
              v434_acc += ((static_cast<float>(v436_data[15])) * v46_data);
              ir1.template select<16, 1>(176) = v434_acc;
              tensorforge::intel_esimd::simd<float, 16> v469_acc{};
              tensorforge::intel_esimd::simd<float, 16> v471_data = tensorforge::slmLoad<float, 16>(s0 + (192_i32));
              v469_acc += ((static_cast<float>(v471_data[0])) * v31_data);
              v469_acc += ((static_cast<float>(v471_data[1])) * v32_data);
              v469_acc += ((static_cast<float>(v471_data[2])) * v33_data);
              v469_acc += ((static_cast<float>(v471_data[3])) * v34_data);
              v469_acc += ((static_cast<float>(v471_data[4])) * v35_data);
              v469_acc += ((static_cast<float>(v471_data[5])) * v36_data);
              v469_acc += ((static_cast<float>(v471_data[6])) * v37_data);
              v469_acc += ((static_cast<float>(v471_data[7])) * v38_data);
              v469_acc += ((static_cast<float>(v471_data[8])) * v39_data);
              v469_acc += ((static_cast<float>(v471_data[9])) * v40_data);
              v469_acc += ((static_cast<float>(v471_data[10])) * v41_data);
              v469_acc += ((static_cast<float>(v471_data[11])) * v42_data);
              v469_acc += ((static_cast<float>(v471_data[12])) * v43_data);
              v469_acc += ((static_cast<float>(v471_data[13])) * v44_data);
              v469_acc += ((static_cast<float>(v471_data[14])) * v45_data);
              v469_acc += ((static_cast<float>(v471_data[15])) * v46_data);
              ir1.template select<16, 1>(192) = v469_acc;
              tensorforge::intel_esimd::simd<float, 16> v504_acc{};
              tensorforge::intel_esimd::simd<float, 16> v506_data = tensorforge::slmLoad<float, 16>(s0 + (208_i32));
              v504_acc += ((static_cast<float>(v506_data[0])) * v31_data);
              v504_acc += ((static_cast<float>(v506_data[1])) * v32_data);
              v504_acc += ((static_cast<float>(v506_data[2])) * v33_data);
              v504_acc += ((static_cast<float>(v506_data[3])) * v34_data);
              v504_acc += ((static_cast<float>(v506_data[4])) * v35_data);
              v504_acc += ((static_cast<float>(v506_data[5])) * v36_data);
              v504_acc += ((static_cast<float>(v506_data[6])) * v37_data);
              v504_acc += ((static_cast<float>(v506_data[7])) * v38_data);
              v504_acc += ((static_cast<float>(v506_data[8])) * v39_data);
              v504_acc += ((static_cast<float>(v506_data[9])) * v40_data);
              v504_acc += ((static_cast<float>(v506_data[10])) * v41_data);
              v504_acc += ((static_cast<float>(v506_data[11])) * v42_data);
              v504_acc += ((static_cast<float>(v506_data[12])) * v43_data);
              v504_acc += ((static_cast<float>(v506_data[13])) * v44_data);
              v504_acc += ((static_cast<float>(v506_data[14])) * v45_data);
              v504_acc += ((static_cast<float>(v506_data[15])) * v46_data);
              ir1.template select<16, 1>(208) = v504_acc;
              tensorforge::intel_esimd::simd<float, 16> v539_acc{};
              tensorforge::intel_esimd::simd<float, 16> v541_data = tensorforge::slmLoad<float, 16>(s0 + (224_i32));
              v539_acc += ((static_cast<float>(v541_data[0])) * v31_data);
              v539_acc += ((static_cast<float>(v541_data[1])) * v32_data);
              v539_acc += ((static_cast<float>(v541_data[2])) * v33_data);
              v539_acc += ((static_cast<float>(v541_data[3])) * v34_data);
              v539_acc += ((static_cast<float>(v541_data[4])) * v35_data);
              v539_acc += ((static_cast<float>(v541_data[5])) * v36_data);
              v539_acc += ((static_cast<float>(v541_data[6])) * v37_data);
              v539_acc += ((static_cast<float>(v541_data[7])) * v38_data);
              v539_acc += ((static_cast<float>(v541_data[8])) * v39_data);
              v539_acc += ((static_cast<float>(v541_data[9])) * v40_data);
              v539_acc += ((static_cast<float>(v541_data[10])) * v41_data);
              v539_acc += ((static_cast<float>(v541_data[11])) * v42_data);
              v539_acc += ((static_cast<float>(v541_data[12])) * v43_data);
              v539_acc += ((static_cast<float>(v541_data[13])) * v44_data);
              v539_acc += ((static_cast<float>(v541_data[14])) * v45_data);
              v539_acc += ((static_cast<float>(v541_data[15])) * v46_data);
              ir1.template select<16, 1>(224) = v539_acc;
              tensorforge::intel_esimd::simd<float, 16> v574_acc{};
              tensorforge::intel_esimd::simd<float, 16> v576_data = tensorforge::slmLoad<float, 16>(s0 + (240_i32));
              v574_acc += ((static_cast<float>(v576_data[0])) * v31_data);
              v574_acc += ((static_cast<float>(v576_data[1])) * v32_data);
              v574_acc += ((static_cast<float>(v576_data[2])) * v33_data);
              v574_acc += ((static_cast<float>(v576_data[3])) * v34_data);
              v574_acc += ((static_cast<float>(v576_data[4])) * v35_data);
              v574_acc += ((static_cast<float>(v576_data[5])) * v36_data);
              v574_acc += ((static_cast<float>(v576_data[6])) * v37_data);
              v574_acc += ((static_cast<float>(v576_data[7])) * v38_data);
              v574_acc += ((static_cast<float>(v576_data[8])) * v39_data);
              v574_acc += ((static_cast<float>(v576_data[9])) * v40_data);
              v574_acc += ((static_cast<float>(v576_data[10])) * v41_data);
              v574_acc += ((static_cast<float>(v576_data[11])) * v42_data);
              v574_acc += ((static_cast<float>(v576_data[12])) * v43_data);
              v574_acc += ((static_cast<float>(v576_data[13])) * v44_data);
              v574_acc += ((static_cast<float>(v576_data[14])) * v45_data);
              v574_acc += ((static_cast<float>(v576_data[15])) * v46_data);
              ir1.template select<16, 1>(240) = v574_acc;
              // r1 = ir1
              #pragma unroll
              for (int32_t v609_n0 = 0; v609_n0 < 1; ++v609_n0) {
                int32_t v611_a = v609_n0 * 16;
                #pragma unroll
                for (int32_t v610_n1 = 0; v610_n1 < 16; ++v610_n1) {
                  int32_t v613_a = v611_a + (v610_n1 * 16);
                  tensorforge::intel_esimd::simd<float, 16> v614_data(ir1.template select<16, 1>(v613_a));
                  r1.template select<16, 1>(v613_a) = v614_data;
                }
              }
              // glb_m0 = store{r>g}(r1);
              #pragma unroll
              for (int32_t v615_i0 = 0; v615_i0 < 1; ++v615_i0) {
                int32_t v617_a = v615_i0 * 16;
                #pragma unroll
                for (int32_t v616_i1 = 0; v616_i1 < 16; ++v616_i1) {
                  int32_t v619_a = v617_a + (v616_i1 * 16);
                  tensorforge::intel_esimd::simd<float, 16> v620_data(r1.template select<16, 1>(v619_a));
                  v620_data.copy_to(glb_m0 + (v619_a));
                }
              }
            }
          }
