    ...
    // m0 16×8(16×8) {0..16}×{0..8} strided({0..16}×{0..8})[0, 1] = m1 16×16(16×16) {0..16}×{0..16} strided({0..16}×{0..16})[0, -1]×m2 16×8(16×8) {0..16}×{0..8} strided({0..16}×{0..8})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          float r1[8]{};
          // r1 = load{g>r}(glb_m2);
          tensorforge::VectorT<float, 4> v30_lin = *(tensorforge::VectorT<float, 4>*)&glb_m2[0 + threadIdx.x * 4];
          *(tensorforge::VectorRelaxedT<float, 4>*)&r1[0] = v30_lin;
          tensorforge::VectorT<float, 4> v31_lin = *(tensorforge::VectorT<float, 4>*)&glb_m2[64 + threadIdx.x * 4];
          *(tensorforge::VectorRelaxedT<float, 4>*)&r1[4] = v31_lin;
          ...
          // glb_m0 = store{r>g}(r2);
          #pragma unroll
          for (int32_t v126_i0 = 0; v126_i0 < 1; ++v126_i0) {
            int32_t v135_lead = v10_lead + (v126_i0 * 16);
            #pragma unroll
            for (int32_t v127_i1 = 0; v127_i1 < 8; ++v127_i1) {
              int32_t v128_a = v126_i0 + v127_i1;
              float v130_data = r2[(v126_i0 + v127_i1)];
              glb_m0[(v135_lead + (v127_i1 * 16))] = v130_data;
            }
          }
        }
      }
