        ...
        if (allowed) {
          ...
          *(tensorforge::VectorT<float, 4>*)&r1[4] = v27_lin;
          ...
          for (int32_t v122_i0 = 0; v122_i0 < 1; ++v122_i0) {
            int32_t v131_lead = v6_lead + (v122_i0 * 16);
            #pragma unroll
            for (int32_t v123_i1 = 0; v123_i1 < 8; ++v123_i1) {
              int32_t v124_a = v122_i0 + v123_i1;
              float v126_data = r2[(v122_i0 + v123_i1)];
              glb_m0[(v131_lead + (v123_i1 * 16))] = v126_data;
            }
          }
        }
      }
