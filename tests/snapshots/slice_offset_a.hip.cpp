        ...
        if (allowed) {
          ...
          if (v2_lead < 12) {
            ...
            for (int32_t v4_i1 = 0; v4_i1 < 16; ++v4_i1) {
              ...
              float v23_data = __builtin_nontemporal_load(&glb_m1[(v20_a + v12_a)]);
          ...
          float v31_tp{};
          float v32_tp{};
          tensorforge::transpose4x4b32(v29_tp, v30_tp, v31_tp, v32_tp, v25_data, v26_data, v27_data, v28_data);
          tensorforge::VectorT<float, 4> v33_acc{};
          float v34_data = r0[0];
          float v35_data = r0[1];
          float v36_data = r0[2];
          float v37_data = r0[3];
          tensorforge::VectorT<float, 4> v38_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v29_tp, v34_data, v33_acc, 2, 0, 0);
          ...
          float v44_data = r0[6];
          float v45_data = r0[7];
          tensorforge::VectorT<float, 4> v46_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v29_tp, v42_data, v41_acc, 2, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v54_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v29_tp, v50_data, v49_acc, 2, 2, 0);
          ...
          float v58_data = r0[12];
          float v59_data = r0[13];
          float v60_data = r0[14];
          float v61_data = r0[15];
          tensorforge::VectorT<float, 4> v62_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v29_tp, v58_data, v57_acc, 2, 3, 0);
          ...
          tensorforge::VectorT<float, 4> v83_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v74_tp, v34_data, v78_acc, 2, 0, 0);
          ...
          tensorforge::VectorT<float, 4> v91_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v74_tp, v42_data, v86_acc, 2, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v99_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v74_tp, v50_data, v94_acc, 2, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v107_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v74_tp, v58_data, v102_acc, 2, 3, 0);
          ...
          if (v117_lead < 12) {
            ...
            for (int32_t v119_i1 = 0; v119_i1 < 8; ++v119_i1) {
              ...
              float v122_data = r2[v119_i1];
              int32_t v129_a = v117_lead + (v119_i1 * 12);
              glb_m0[v129_a] = v122_data;
            }
          }
          ;
        }
