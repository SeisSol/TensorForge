        ...
        if (allowed) {
          ...
          for (int32_t v7_i0 = 0; v7_i0 < 1; ++v7_i0) {
            ...
            for (int32_t v8_i1 = 0; v8_i1 < 16; ++v8_i1) {
              ...
              double v23_data = __builtin_nontemporal_load(&glb_m1[(v20_lead + v14_a)]);
          ...
          for (int32_t v94_i0 = 0; v94_i0 < 1; ++v94_i0) {
            int32_t v103_lead = v6_lead + (v94_i0 * 16);
            #pragma unroll
            for (int32_t v95_i1 = 0; v95_i1 < 16; ++v95_i1) {
              int32_t v96_a = v94_i0 + v95_i1;
              double v98_data = r2[(v94_i0 + v95_i1)];
              glb_m0[(v103_lead + (v95_i1 * 16))] = v98_data;
            }
          }
        }
      }
