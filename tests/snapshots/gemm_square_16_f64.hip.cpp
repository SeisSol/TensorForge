        ...
        if (allowed) {
          ...
          for (int32_t v11_i0 = 0; v11_i0 < 1; ++v11_i0) {
            ...
            for (int32_t v12_i1 = 0; v12_i1 < 16; ++v12_i1) {
              double v20_data = __builtin_nontemporal_load(&glb_m1[(v17_lead + (v12_i1 * 16))]);
          ...
          for (int32_t v91_i0 = 0; v91_i0 < 1; ++v91_i0) {
            int32_t v99_lead = v10_lead + (v91_i0 * 16);
            #pragma unroll
            for (int32_t v92_i1 = 0; v92_i1 < 16; ++v92_i1) {
              double v94_data = r2[(v91_i0 + v92_i1)];
              glb_m0[(v99_lead + (v92_i1 * 16))] = v94_data;
            }
          }
        }
      }
