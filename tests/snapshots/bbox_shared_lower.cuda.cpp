          ...
          __syncwarp();
          {
            ...
            if (v3_lead < 12) {
              ...
              for (int32_t v735_n1 = 0; v735_n1 < 8; ++v735_n1) {
                int32_t v736_a = 0 + v735_n1;
                float v738_data = ir1[v735_n1];
                int32_t v739_a = 0 + v735_n1;
                r1[v735_n1] = v738_data;
              }
            }
          }
          // glb_m0 = store{r>g}(r1);
          if (v3_lead < 12) {
            int32_t v755_a = ((v3_lead + 16_i32) + -12) - 4;
            #pragma unroll
            for (int32_t v745_i1 = 0; v745_i1 < 8; ++v745_i1) {
              int32_t v746_a = 0 + v745_i1;
              float v748_data = r1[v745_i1];
              int32_t v757_a = v755_a + (v745_i1 * 12);
              glb_m0[v757_a] = v748_data;
            }
          }
          __syncwarp();
        }
