        ...
        if (allowed) {
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v12_i1 = 0; v12_i1 < 16; ++v12_i1) {
              float v22_data = __ldcg(&glb_m1[(v19_a + (v12_i1 * 12))]);
              r0[v12_i1] = v22_data;
            }
          }
          ...
          if (v10_lead < 12) {
            ...
            float v607_data = ir1[0];
            ir1[0] = (v607_data + (v604_data * v605_data));
            float v610_data = s0[28];
            float v612_data = ir1[1];
            ir1[1] = (v612_data + (v604_data * v610_data));
            float v615_data = s0[47];
            float v617_data = ir1[2];
            ir1[2] = (v617_data + (v604_data * v615_data));
            float v620_data = s0[62];
            float v622_data = ir1[3];
            ir1[3] = (v622_data + (v604_data * v620_data));
            float v625_data = s0[73];
            float v627_data = ir1[4];
            ir1[4] = (v627_data + (v604_data * v625_data));
            float v630_data = s0[88];
            float v632_data = ir1[5];
            ir1[5] = (v632_data + (v604_data * v630_data));
            float v635_data = s0[107];
            float v637_data = ir1[6];
            ir1[6] = (v637_data + (v604_data * v635_data));
            float v640_data = s0[122];
            float v642_data = ir1[7];
            ir1[7] = (v642_data + (v604_data * v640_data));
          }
          if (v10_lead < 12) {
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v736_n1 = 0; v736_n1 < 8; ++v736_n1) {
              float v738_data = ir1[v736_n1];
              r1[v736_n1] = v738_data;
            }
          }
          // glb_m0 = store{r>g}(r1);
          if (v10_lead < 12) {
            int32_t v753_a = ((v10_lead + 16_i32) + -12) - 4;
            #pragma unroll
            for (int32_t v744_i1 = 0; v744_i1 < 8; ++v744_i1) {
              float v746_data = r1[v744_i1];
              glb_m0[(v753_a + (v744_i1 * 12))] = v746_data;
            }
          }
          __syncwarp();
        }
