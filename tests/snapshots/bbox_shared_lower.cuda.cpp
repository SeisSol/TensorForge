        ...
        if (allowed) {
          ...
          if (v3_lead < 12) {
            ...
            for (int32_t v736_n1 = 0; v736_n1 < 8; ++v736_n1) {
              ...
              float v739_data = ir1[v736_n1];
              int32_t v740_a = 0 + v736_n1;
              r1[v736_n1] = v739_data;
            }
          }
          // glb_m0 = store{r>g}(r1);
          if (v3_lead < 12) {
            int32_t v756_a = ((v3_lead + 16_i32) + -12) - 4;
            #pragma unroll
            for (int32_t v746_i1 = 0; v746_i1 < 8; ++v746_i1) {
              int32_t v747_a = 0 + v746_i1;
              float v749_data = r1[v746_i1];
              int32_t v758_a = v756_a + (v746_i1 * 12);
              glb_m0[v758_a] = v749_data;
            }
          }
          __syncwarp();
        }
