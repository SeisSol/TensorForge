// === base name ===
kernel_17da4769a7e8bbdf

// === header ===
void launcher_kernel_17da4769a7e8bbdf(const float* m0, size_t m0_extraOffset, float* m1, size_t m1_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_17da4769a7e8bbdf(const float* m0, size_t m0_extraOffset, float* m1, size_t m1_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  ...
  kernel_kernel_17da4769a7e8bbdf(stream, grid, block,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_17da4769a7e8bbdf(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, const float* m0, size_t m0_extraOffset, float* m1, size_t m1_extraOffset, size_t numElements0, unsigned* flags0 ) {
            ...
            if (allowed) {
              ...
              for (int32_t v15_k0 = 0; v15_k0 < 1; ++v15_k0) {
                ...
                for (int32_t v16_k1 = 0; v16_k1 < 16; ++v16_k1) {
                  ...
                  glb_m1[(v30_lead + v22_a)] = (sycl::log(v24_data));
                }
              }
