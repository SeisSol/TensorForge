    ...
    // m0 12×8(12×8) {0..12}×{0..8} strided({0..12}×{0..8})[0, 1] += m7 12×12(12×12) {0..12}×{0..12} strided({0..12}×{0..12})[0, -1]×m8 12×8(12×8) {0..12}×{0..8} strided({0..12}×{0..8})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          float r9[12]{};
          // r9 = load{g>r}(glb_m7);
          int32_t v109_lead = threadIdx.x % 16;
          if (v109_lead < 12) {
            #pragma unroll
            for (int32_t v111_i1 = 0; v111_i1 < 12; ++v111_i1) {
              int32_t v118_a = v109_lead + (v111_i1 * 12);
              float v119_data;
              {
                v119_data = __builtin_nontemporal_load(&glb_m7[v118_a]);
              }
              int32_t v120_a = 0 + v111_i1;
              r9[v120_a] = v119_data;
            }
          }
          ...
          float r8[8]{};
          {
            ...
            // [(0, 12), (0, 8)] [(0, 12)]
            float ir8[8]{};
            float v121_data = r6[0];
            float v122_data = r6[1];
            float v123_data = r6[2];
            float v124_data = r6[3];
            float v125_data = r6[4];
            float v126_data = r6[5];
            float v127_data = r6[6];
            float v128_data = r6[7];
            float v129_data = r6[8];
            float v130_data = r6[9];
            float v131_data = r6[10];
            float v132_data = r6[11];
            float v133_acc{};
            float v134_acc{};
            float v135_acc{};
            float v136_acc{};
            ...
            float v140_acc{};
            float v141_lin = r7[0];
            tensorforge::fmacdpp16<0>(v133_acc, v141_lin, v121_data);
            tensorforge::fmacdpp16<1>(v133_acc, v141_lin, v122_data);
            tensorforge::fmacdpp16<2>(v133_acc, v141_lin, v123_data);
            tensorforge::fmacdpp16<3>(v133_acc, v141_lin, v124_data);
            tensorforge::fmacdpp16<4>(v133_acc, v141_lin, v125_data);
            tensorforge::fmacdpp16<5>(v133_acc, v141_lin, v126_data);
            tensorforge::fmacdpp16<6>(v133_acc, v141_lin, v127_data);
            tensorforge::fmacdpp16<7>(v133_acc, v141_lin, v128_data);
            tensorforge::fmacdpp16<8>(v133_acc, v141_lin, v129_data);
            tensorforge::fmacdpp16<9>(v133_acc, v141_lin, v130_data);
            tensorforge::fmacdpp16<10>(v133_acc, v141_lin, v131_data);
            tensorforge::fmacdpp16<11>(v133_acc, v141_lin, v132_data);
            tensorforge::fmacdpp16<12>(v134_acc, v141_lin, v121_data);
            tensorforge::fmacdpp16<13>(v134_acc, v141_lin, v122_data);
            tensorforge::fmacdpp16<14>(v134_acc, v141_lin, v123_data);
            tensorforge::fmacdpp16<15>(v134_acc, v141_lin, v124_data);
            float v142_lin = r7[1];
            tensorforge::fmacdpp16<0>(v134_acc, v142_lin, v125_data);
            tensorforge::fmacdpp16<1>(v134_acc, v142_lin, v126_data);
            tensorforge::fmacdpp16<2>(v134_acc, v142_lin, v127_data);
            tensorforge::fmacdpp16<3>(v134_acc, v142_lin, v128_data);
            tensorforge::fmacdpp16<4>(v134_acc, v142_lin, v129_data);
            tensorforge::fmacdpp16<5>(v134_acc, v142_lin, v130_data);
            tensorforge::fmacdpp16<6>(v134_acc, v142_lin, v131_data);
            tensorforge::fmacdpp16<7>(v134_acc, v142_lin, v132_data);
            tensorforge::fmacdpp16<8>(v135_acc, v142_lin, v121_data);
            tensorforge::fmacdpp16<9>(v135_acc, v142_lin, v122_data);
            tensorforge::fmacdpp16<10>(v135_acc, v142_lin, v123_data);
            tensorforge::fmacdpp16<11>(v135_acc, v142_lin, v124_data);
            tensorforge::fmacdpp16<12>(v135_acc, v142_lin, v125_data);
            tensorforge::fmacdpp16<13>(v135_acc, v142_lin, v126_data);
            tensorforge::fmacdpp16<14>(v135_acc, v142_lin, v127_data);
            tensorforge::fmacdpp16<15>(v135_acc, v142_lin, v128_data);
            float v143_lin = r7[2];
            tensorforge::fmacdpp16<0>(v135_acc, v143_lin, v129_data);
            tensorforge::fmacdpp16<1>(v135_acc, v143_lin, v130_data);
            tensorforge::fmacdpp16<2>(v135_acc, v143_lin, v131_data);
            tensorforge::fmacdpp16<3>(v135_acc, v143_lin, v132_data);
            tensorforge::fmacdpp16<4>(v136_acc, v143_lin, v121_data);
            tensorforge::fmacdpp16<5>(v136_acc, v143_lin, v122_data);
            tensorforge::fmacdpp16<6>(v136_acc, v143_lin, v123_data);
            tensorforge::fmacdpp16<7>(v136_acc, v143_lin, v124_data);
            tensorforge::fmacdpp16<8>(v136_acc, v143_lin, v125_data);
            tensorforge::fmacdpp16<9>(v136_acc, v143_lin, v126_data);
            tensorforge::fmacdpp16<10>(v136_acc, v143_lin, v127_data);
            tensorforge::fmacdpp16<11>(v136_acc, v143_lin, v128_data);
            tensorforge::fmacdpp16<12>(v136_acc, v143_lin, v129_data);
            tensorforge::fmacdpp16<13>(v136_acc, v143_lin, v130_data);
            tensorforge::fmacdpp16<14>(v136_acc, v143_lin, v131_data);
            tensorforge::fmacdpp16<15>(v136_acc, v143_lin, v132_data);
            float v144_lin = r7[3];
            tensorforge::fmacdpp16<0>(v137_acc, v144_lin, v121_data);
            tensorforge::fmacdpp16<1>(v137_acc, v144_lin, v122_data);
            tensorforge::fmacdpp16<2>(v137_acc, v144_lin, v123_data);
            tensorforge::fmacdpp16<3>(v137_acc, v144_lin, v124_data);
            tensorforge::fmacdpp16<4>(v137_acc, v144_lin, v125_data);
            tensorforge::fmacdpp16<5>(v137_acc, v144_lin, v126_data);
            tensorforge::fmacdpp16<6>(v137_acc, v144_lin, v127_data);
            tensorforge::fmacdpp16<7>(v137_acc, v144_lin, v128_data);
            tensorforge::fmacdpp16<8>(v137_acc, v144_lin, v129_data);
            tensorforge::fmacdpp16<9>(v137_acc, v144_lin, v130_data);
            tensorforge::fmacdpp16<10>(v137_acc, v144_lin, v131_data);
            tensorforge::fmacdpp16<11>(v137_acc, v144_lin, v132_data);
            tensorforge::fmacdpp16<12>(v138_acc, v144_lin, v121_data);
            tensorforge::fmacdpp16<13>(v138_acc, v144_lin, v122_data);
            tensorforge::fmacdpp16<14>(v138_acc, v144_lin, v123_data);
            tensorforge::fmacdpp16<15>(v138_acc, v144_lin, v124_data);
            float v145_lin = r7[4];
            tensorforge::fmacdpp16<0>(v138_acc, v145_lin, v125_data);
            tensorforge::fmacdpp16<1>(v138_acc, v145_lin, v126_data);
            tensorforge::fmacdpp16<2>(v138_acc, v145_lin, v127_data);
            tensorforge::fmacdpp16<3>(v138_acc, v145_lin, v128_data);
            tensorforge::fmacdpp16<4>(v138_acc, v145_lin, v129_data);
            tensorforge::fmacdpp16<5>(v138_acc, v145_lin, v130_data);
            tensorforge::fmacdpp16<6>(v138_acc, v145_lin, v131_data);
            tensorforge::fmacdpp16<7>(v138_acc, v145_lin, v132_data);
            tensorforge::fmacdpp16<8>(v139_acc, v145_lin, v121_data);
            tensorforge::fmacdpp16<9>(v139_acc, v145_lin, v122_data);
            tensorforge::fmacdpp16<10>(v139_acc, v145_lin, v123_data);
            tensorforge::fmacdpp16<11>(v139_acc, v145_lin, v124_data);
            tensorforge::fmacdpp16<12>(v139_acc, v145_lin, v125_data);
            tensorforge::fmacdpp16<13>(v139_acc, v145_lin, v126_data);
            tensorforge::fmacdpp16<14>(v139_acc, v145_lin, v127_data);
            tensorforge::fmacdpp16<15>(v139_acc, v145_lin, v128_data);
            float v146_lin = r7[5];
            tensorforge::fmacdpp16<0>(v139_acc, v146_lin, v129_data);
            tensorforge::fmacdpp16<1>(v139_acc, v146_lin, v130_data);
            tensorforge::fmacdpp16<2>(v139_acc, v146_lin, v131_data);
            tensorforge::fmacdpp16<3>(v139_acc, v146_lin, v132_data);
            tensorforge::fmacdpp16<4>(v140_acc, v146_lin, v121_data);
            tensorforge::fmacdpp16<5>(v140_acc, v146_lin, v122_data);
            tensorforge::fmacdpp16<6>(v140_acc, v146_lin, v123_data);
            tensorforge::fmacdpp16<7>(v140_acc, v146_lin, v124_data);
            tensorforge::fmacdpp16<8>(v140_acc, v146_lin, v125_data);
            tensorforge::fmacdpp16<9>(v140_acc, v146_lin, v126_data);
            tensorforge::fmacdpp16<10>(v140_acc, v146_lin, v127_data);
            tensorforge::fmacdpp16<11>(v140_acc, v146_lin, v128_data);
            tensorforge::fmacdpp16<12>(v140_acc, v146_lin, v129_data);
            tensorforge::fmacdpp16<13>(v140_acc, v146_lin, v130_data);
            tensorforge::fmacdpp16<14>(v140_acc, v146_lin, v131_data);
            tensorforge::fmacdpp16<15>(v140_acc, v146_lin, v132_data);
            ir8[0] = v133_acc;
            ir8[1] = v134_acc;
            ir8[2] = v135_acc;
            ir8[3] = v136_acc;
            ...
            if ((threadIdx.x % 16) < 12) {
              #pragma unroll
              for (int32_t v151_n1 = 0; v151_n1 < 8; ++v151_n1) {
                int32_t v152_a = 0 + v151_n1;
                float v154_data = ir8[v151_n1];
                int32_t v155_a = 0 + v151_n1;
                float v157_data = r5[v151_n1];
                int32_t v159_a = 0 + v151_n1;
                r8[v159_a] = (v157_data + v154_data);
              }
            }
          }
          float r10[8]{};
          ...
          float r11[8]{};
          {
            ...
            // [(0, 12), (0, 8)] [(0, 12)]
            float ir11[8]{};
            float v160_data = r9[0];
            float v161_data = r9[1];
            float v162_data = r9[2];
            float v163_data = r9[3];
            float v164_data = r9[4];
            float v165_data = r9[5];
            float v166_data = r9[6];
            float v167_data = r9[7];
            float v168_data = r9[8];
            float v169_data = r9[9];
            float v170_data = r9[10];
            float v171_data = r9[11];
            float v172_acc{};
            float v173_acc{};
            float v174_acc{};
            float v175_acc{};
            ...
            if ((threadIdx.x % 16) < 12) {
              ...
              for (int32_t v190_n1 = 0; v190_n1 < 8; ++v190_n1) {
                ...
                float v193_data = ir11[v190_n1];
                int32_t v194_a = 0 + v190_n1;
                float v196_data = r8[v190_n1];
                int32_t v198_a = 0 + v190_n1;
                r11[v198_a] = (v196_data + v193_data);
              }
            }
          }
          // glb_m0 = store{r>g}(r11);
          int32_t v201_lead = threadIdx.x % 16;
          if (v201_lead < 12) {
            #pragma unroll
            for (int32_t v203_i1 = 0; v203_i1 < 8; ++v203_i1) {
              int32_t v204_a = 0 + v203_i1;
              float v206_data = r11[v203_i1];
              int32_t v213_a = v201_lead + (v203_i1 * 12);
              glb_m0[v213_a] = v206_data;
            }
          }
          ;
        }
