          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              *(sycl::vec<float, 4>*)&s0[0 + 0 + 4 * item.get_local_id(0) + 64] = *(sycl::vec<float, 4>*)&glb_m2[0 + 0 + 4 * item.get_local_id(0) + 64];
              ...
              #pragma unroll
              for (int32_t v406_n0 = 0; v406_n0 < 1; ++v406_n0) {
                int32_t v408_a = v406_n0 * 16;
                #pragma unroll
                for (int32_t v407_n1 = 0; v407_n1 < 8; ++v407_n1) {
                  int32_t v410_a = v408_a + (v407_n1 * 16);
                  tensorforge::intel_esimd::simd<float, 16> v411_data;
                  v411_data.copy_from(ir0 + (v410_a));
                  v411_data.copy_to(r0 + (v410_a));
                }
              }
              // glb_m0 = store{r>g}(r0);
              #pragma unroll
              for (int32_t v415_i0 = 0; v415_i0 < 1; ++v415_i0) {
                int32_t v417_a = v415_i0 * 16;
                #pragma unroll
                for (int32_t v416_i1 = 0; v416_i1 < 8; ++v416_i1) {
                  int32_t v419_a = v417_a + (v416_i1 * 16);
                  tensorforge::intel_esimd::simd<float, 16> v420_data;
                  v420_data.copy_from(r0 + (v419_a));
                  v420_data.copy_to(glb_m0 + (v419_a));
                }
              }
            }
          }
