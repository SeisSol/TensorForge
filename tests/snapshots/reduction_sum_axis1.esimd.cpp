...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_05f125862a2c9fdd = {{1, 16, 1}, 16, 16, 1, 16, 1024, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_05f125862a2c9fdd(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_05f125862a2c9fdd(const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_05f125862a2c9fdd(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
...
void launcher_kernel_05f125862a2c9fdd(const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_05f125862a2c9fdd(numElements0, streamPtr);
  ...
  kernel_kernel_05f125862a2c9fdd(stream, grid, block, m0, m0_extraOffset, m1, m1_extraOffset, numElements0, flags0);
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_05f125862a2c9fdd(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0) {
          ...
          for (size_t v4_batchId0 = (item.get_local_id(1) + item.get_group().get_local_range(1) * (item.get_group().get_group_id(2))); v4_batchId0 < numElements0; v4_batchId0 += (item.get_group_range(2) * item.get_group().get_local_range(1))) {
            ...
            if (allowed) {
              ...
              for (int32_t v14_k0 = 0; v14_k0 < 1; ++v14_k0) {
                ...
                tensorforge::intel_esimd::simd<float, 16> v16_acc0(0.0f);
                #pragma unroll
