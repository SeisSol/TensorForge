// === base name ===
kernel_9660a42a1c3a6b4b

// === header ===
void launcher_kernel_9660a42a1c3a6b4b(const float** m0, size_t m0_extraOffset, const float** m1, size_t m1_extraOffset, float** m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_9660a42a1c3a6b4b(const float** m0, size_t m0_extraOffset, const float** m1, size_t m1_extraOffset, float** m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  ...
  kernel_kernel_9660a42a1c3a6b4b(stream, grid, block,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_9660a42a1c3a6b4b(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, const float** m0, size_t m0_extraOffset, const float** m1, size_t m1_extraOffset, float** m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 ) {
          ...
          for (size_t v0_batchId0 = (item.get_local_id(1) + item.get_group().get_local_range(1) * (item.get_group().get_group_id(0))); v0_batchId0 < numElements0; v0_batchId0 += (item.get_global_range(0) * item.get_group().get_local_range(1))) {
            ...
            if (allowed) {
              ...
              for (int32_t v15_i0 = 0; v15_i0 < 1; ++v15_i0) {
                float v21_data = glb_m0[(v14_lead + (v15_i0 * 32))];
                r0[v15_i0] = v21_data;
              }
              float r2[3]{};
              // r2 = load{g>r}(glb_m1);
              ...
              for (int32_t v26_i0 = 0; v26_i0 < 1; ++v26_i0) {
                ...
                for (int32_t v27_i1 = 0; v27_i1 < 3; ++v27_i1) {
                  float v35_data = glb_m1[(v32_lead + (v27_i1 * 32))];
