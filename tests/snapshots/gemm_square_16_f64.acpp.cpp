...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_a9768172db632a1f = {{16, 16, 1}, 16, 16, 1, 16, 2048, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_a9768172db632a1f(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_a9768172db632a1f(double * m0, size_t m0_extraOffset, const double * m1, size_t m1_extraOffset, const double * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_a9768172db632a1f(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
...
void launcher_kernel_a9768172db632a1f(double * m0, size_t m0_extraOffset, const double * m1, size_t m1_extraOffset, const double * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_a9768172db632a1f(numElements0, streamPtr);
  ...
  kernel_kernel_a9768172db632a1f(stream, grid, block, m0, m0_extraOffset, m1, m1_extraOffset, m2, m2_extraOffset, numElements0, flags0);
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_a9768172db632a1f(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, double * m0, size_t m0_extraOffset, const double * m1, size_t m1_extraOffset, const double * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0) {
        ...
        // tensorforge-meta: {"fp":"double","launch":{"active_threads":16,"block":[16,16,1],"cooperative":false,"lead_width":1,"mults_per_block":16,"persistent":true,"sections":[{"barrier":false,"mults_per_block":16,"shared_elements":256}],"shared_bytes":2048,"shared_elements":256,"threads_per_mult":16},"loops":[],"operands":[{"addressing":"strided","alias":"C","bbox":[[0,0],[16,16]],"name":"m0","ordered":false,"parts":1,"shape":[16,16],"variant":false},{"addressing":"strided","alias":"A","bbox":[[0,0],[16,16]],"name":"m1","ordered":false,"parts":1,"shape":[16,16],"variant":false},{"addressing":"strided","alias":"B","bbox":[[0,0],[16,16]],"name":"m2","ordered":false,"parts":1,"shape":[16,16],"variant":false}],"operations":[{"add":false,"dest":{"addressing":"strided","bbox":[[0,0],[16,16]],"is_tmp":false,"name":"m0","offset":[0,0],"shape":[16,16]},"kind":"multilinear","ops":[{"addressing":"strided","bbox":[[0,0],[16,16]],"is_tmp":false,"name":"m1","offset":[0,0],"shape":[16,16]},{"addressing":"strided","bbox":[[0,0],[16,16]],"is_tmp":false,"name":"m2","offset":[0,0],"shape":[16,16]}],"permute":[[0,1],[0,1]],"target":[[0,-1],[-1,1]]}],"version":"0.0.1\n"}
        {
          ...
          for (size_t v3_batchId0 = (item.get_local_id(1) + item.get_group().get_local_range(1) * (item.get_group().get_group_id(2))); v3_batchId0 < numElements0; v3_batchId0 += (item.get_group_range(2) * item.get_group().get_local_range(1))) {
            ...
            if (allowed) {
              ...
              double v50_data = r1[2];
              double v53_data = ir2[2];
              ...
              double v74_data = r1[6];
              double v77_data = ir2[6];
              ...
              double v86_data = r1[8];
              double v89_data = ir2[8];
              ...
              double v92_data = r1[9];
              double v95_data = ir2[9];
              ...
              double v98_data = r1[10];
              double v101_data = ir2[10];
              ...
              double v104_data = r1[11];
              double v107_data = ir2[11];
              ...
              double v110_data = r1[12];
              double v113_data = ir2[12];
              ...
              double v116_data = r1[13];
              double v119_data = ir2[13];
              ...
              double v122_data = r1[14];
              double v125_data = ir2[14];
              ...
              double v128_data = r1[15];
              double v131_data = ir2[15];
              ...
              double v325_data = r0[3];
              double v329_data = ir2[0];
              ...
              double v421_data = r0[4];
              double v425_data = ir2[0];
              ...
              double v517_data = r0[5];
              double v521_data = ir2[0];
              ...
              double v613_data = r0[6];
              double v617_data = ir2[0];
              ...
              double v805_data = r0[8];
              double v809_data = ir2[0];
              ...
              double v901_data = r0[9];
              double v905_data = ir2[0];
              ...
              double v997_data = r0[10];
              double v1001_data = ir2[0];
              ...
              double v1093_data = r0[11];
              double v1097_data = ir2[0];
              ...
              double v1189_data = r0[12];
              double v1193_data = ir2[0];
              ...
              double v1285_data = r0[13];
              double v1289_data = ir2[0];
              ...
              double v1381_data = r0[14];
              double v1385_data = ir2[0];
              ...
              double v1477_data = r0[15];
              double v1481_data = ir2[0];
              ...
              for (int32_t v1577_i0 = 0; v1577_i0 < 1; ++v1577_i0) {
                ...
                for (int32_t v1578_i1 = 0; v1578_i1 < 16; ++v1578_i1) {
                  double v1580_data = r2[(v1577_i0 + v1578_i1)];
