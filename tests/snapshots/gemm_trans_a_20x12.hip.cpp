    ...
    // m0 12×16(12×16) {0..12}×{0..16} strided({0..12}×{0..16})[0, 1] = m1 20×12(20×12) {0..20}×{0..12} strided({0..20}×{0..12})[-1, 0]×m2 20×16(20×16) {0..20}×{0..16} strided({0..20}×{0..16})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          bool v4_g = v3_lead < 12;
          #pragma unroll
          for (int32_t v0_i0 = 0; v0_i0 < 20; ++v0_i0) {
            if (v4_g) {
              int32_t v11_a = v0_i0 + (v3_lead * 20);
              float v12_data;
              {
                v12_data = __builtin_nontemporal_load(&glb_m1[v11_a]);
              }
              int32_t v13_a = v0_i0 + 0;
              r0[v13_a] = v12_data;
            }
          }
          float r1[32]{};
          ...
          ir2[3] = (v70_acc[3]);
          float v75_data = r1[8];
          float v76_data = r1[10];
          float v77_data = r1[12];
          float v78_data = r1[14];
          float v79_tp{};
          float v80_tp{};
          float v81_tp{};
          float v82_tp{};
          ...
          float v83_data = r1[9];
          float v84_data = r1[11];
          float v85_data = r1[13];
          float v86_data = r1[15];
          float v87_tp{};
          float v88_tp{};
          float v89_tp{};
          float v90_tp{};
          ...
          float v137_data = r1[18];
          float v138_data = r1[20];
          float v139_data = r1[22];
          float v140_tp{};
          float v141_tp{};
          float v142_tp{};
          float v143_tp{};
          tensorforge::transpose4x4b32(v140_tp, v141_tp, v142_tp, v143_tp, v136_data, v137_data, v138_data, v139_data);
          float v144_data = r1[17];
          float v145_data = r1[19];
          float v146_data = r1[21];
          float v147_data = r1[23];
          float v148_tp{};
          float v149_tp{};
          float v150_tp{};
          float v151_tp{};
          ...
          ir2[10] = (v192_acc[2]);
          ir2[11] = (v192_acc[3]);
          float v197_data = r1[24];
          float v198_data = r1[26];
          float v199_data = r1[28];
          float v200_data = r1[30];
          float v201_tp{};
          float v202_tp{};
          float v203_tp{};
          float v204_tp{};
          tensorforge::transpose4x4b32(v201_tp, v202_tp, v203_tp, v204_tp, v197_data, v198_data, v199_data, v200_data);
          float v205_data = r1[25];
          float v206_data = r1[27];
          float v207_data = r1[29];
          float v208_data = r1[31];
          float v209_tp{};
          float v210_tp{};
          float v211_tp{};
          float v212_tp{};
          ...
          if (v260_lead < 12) {
            ...
            for (int32_t v262_i1 = 0; v262_i1 < 16; ++v262_i1) {
              ...
              float v264_data = r2[v263_a];
              int32_t v271_a = v260_lead + (v262_i1 * 12);
              glb_m0[v271_a] = v264_data;
            }
          }
          ;
        }
