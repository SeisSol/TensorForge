    ...
    // m0 12×16(12×16) {0..12}×{0..16} strided({0..12}×{0..16})[0, 1] = m1 20×12(20×12) {0..20}×{0..12} strided({0..20}×{0..12})[-1, 0]×m2 20×16(20×16) {0..20}×{0..16} strided({0..20}×{0..16})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          bool v12_g = v11_lead < 12;
          #pragma unroll
          for (int32_t v8_i0 = 0; v8_i0 < 20; ++v8_i0) {
            if (v12_g) {
              int32_t v19_a = v8_i0 + (v11_lead * 20);
              float v27_data = __builtin_nontemporal_load(&glb_m1[(v8_i0 + (v11_lead * 20))]);
              r0[v8_i0] = v27_data;
            }
          }
          float r1[32]{};
          ...
          r2[6] = (v168_acc[2]);
          r2[7] = (v168_acc[3]);
          float v173_data = r1[16];
          float v174_data = r1[18];
          float v175_data = r1[20];
          float v176_data = r1[22];
          float v177_tp{};
          float v178_tp{};
          float v179_tp{};
          float v180_tp{};
          tensorforge::transpose4x4b32(v177_tp, v178_tp, v179_tp, v180_tp, v173_data, v174_data, v175_data, v176_data);
          float v181_data = r1[17];
          float v182_data = r1[19];
          float v183_data = r1[21];
          float v184_data = r1[23];
          float v185_tp{};
          float v186_tp{};
          float v187_tp{};
          float v188_tp{};
          ...
          r2[10] = (v229_acc[2]);
          r2[11] = (v229_acc[3]);
          float v234_data = r1[24];
          float v235_data = r1[26];
          float v236_data = r1[28];
          float v237_data = r1[30];
          float v238_tp{};
          float v239_tp{};
          float v240_tp{};
          float v241_tp{};
          tensorforge::transpose4x4b32(v238_tp, v239_tp, v240_tp, v241_tp, v234_data, v235_data, v236_data, v237_data);
          float v242_data = r1[25];
          float v243_data = r1[27];
          float v244_data = r1[29];
          float v245_data = r1[31];
          float v246_tp{};
          float v247_tp{};
          float v248_tp{};
          float v249_tp{};
