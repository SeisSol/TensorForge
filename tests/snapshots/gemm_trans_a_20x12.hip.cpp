    ...
    // m0 12×16(12×16) {0..12}×{0..16} strided({0..12}×{0..16})[0, 1] = m1 20×12(20×12) {0..20}×{0..12} strided({0..20}×{0..12})[-1, 0]×m2 20×16(20×16) {0..20}×{0..16} strided({0..20}×{0..16})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          #pragma unroll
          for (int32_t v4_i0 = 0; v4_i0 < 20; ++v4_i0) {
            if (v8_g) {
              int32_t v15_a = v4_i0 + (v7_lead * 20);
              float v23_data = __builtin_nontemporal_load(&glb_m1[(v4_i0 + (v7_lead * 20))]);
              int32_t v24_a = v4_i0 + 0;
              r0[v24_a] = v23_data;
            }
          }
          float r1[32]{};
          ...
          if (v293_lead < 12) {
            ...
            for (int32_t v295_i1 = 0; v295_i1 < 16; ++v295_i1) {
              ...
              int32_t v305_a = v293_lead + (v295_i1 * 12);
