        ...
        if (allowed) {
          ...
          for (int32_t v0_i0 = 0; v0_i0 < 20; ++v0_i0) {
            if (v4_g) {
              ...
              float v19_data = __builtin_nontemporal_load(&glb_m1[(v0_i0 + (v3_lead * 20))]);
              int32_t v20_a = v0_i0 + 0;
              r0[v20_a] = v19_data;
            }
          }
          float r1[32]{};
          ...
          float v92_data = r1[13];
          float v93_data = r1[15];
          float v94_tp{};
          float v95_tp{};
          float v96_tp{};
          float v97_tp{};
          ...
          float v144_data = r1[18];
          float v145_data = r1[20];
          float v146_data = r1[22];
          float v147_tp{};
          float v148_tp{};
          float v149_tp{};
          float v150_tp{};
          ...
          float v152_data = r1[19];
          float v153_data = r1[21];
          float v154_data = r1[23];
          float v155_tp{};
          float v156_tp{};
          float v157_tp{};
          float v158_tp{};
          ...
          ir2[10] = (v199_acc[2]);
          ir2[11] = (v199_acc[3]);
          float v204_data = r1[24];
          float v205_data = r1[26];
          float v206_data = r1[28];
          float v207_data = r1[30];
          float v208_tp{};
          float v209_tp{};
          float v210_tp{};
          float v211_tp{};
          tensorforge::transpose4x4b32(v208_tp, v209_tp, v210_tp, v211_tp, v204_data, v205_data, v206_data, v207_data);
          float v212_data = r1[25];
          float v213_data = r1[27];
          float v214_data = r1[29];
          float v215_data = r1[31];
          float v216_tp{};
          float v217_tp{};
          float v218_tp{};
          float v219_tp{};
