          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              *(sycl::vec<float, 4>*)&s0[0 + 0 + 4 * item.get_local_id(0) + 64] = *(sycl::vec<float, 4>*)&glb_m2[0 + 0 + 4 * item.get_local_id(0) + 64];
              ...
              int32_t v18_a = -4_i32 + 12;
              tensorforge::intel_esimd::simd<float, 16> v23_data;
              v23_data.copy_from(glb_m1 + (8_i32));
              int32_t v27_a = -4_i32 + 24;
              tensorforge::intel_esimd::simd<float, 16> v32_data;
              v32_data.copy_from(glb_m1 + (20_i32));
              int32_t v36_a = -4_i32 + 36;
              tensorforge::intel_esimd::simd<float, 16> v41_data;
              v41_data.copy_from(glb_m1 + (32_i32));
              int32_t v45_a = -4_i32 + 48;
              tensorforge::intel_esimd::simd<float, 16> v50_data;
              v50_data.copy_from(glb_m1 + (44_i32));
              int32_t v54_a = -4_i32 + 60;
              tensorforge::intel_esimd::simd<float, 16> v59_data;
              v59_data.copy_from(glb_m1 + (56_i32));
              int32_t v63_a = -4_i32 + 72;
              tensorforge::intel_esimd::simd<float, 16> v68_data;
              v68_data.copy_from(glb_m1 + (68_i32));
              int32_t v72_a = -4_i32 + 84;
              tensorforge::intel_esimd::simd<float, 16> v77_data;
              v77_data.copy_from(glb_m1 + (80_i32));
              int32_t v81_a = -4_i32 + 96;
              tensorforge::intel_esimd::simd<float, 16> v86_data;
              v86_data.copy_from(glb_m1 + (92_i32));
              int32_t v90_a = -4_i32 + 108;
              tensorforge::intel_esimd::simd<float, 16> v95_data;
              v95_data.copy_from(glb_m1 + (104_i32));
              int32_t v99_a = -4_i32 + 120;
              tensorforge::intel_esimd::simd<float, 16> v104_data;
              v104_data.copy_from(glb_m1 + (116_i32));
              int32_t v108_a = -4_i32 + 132;
              tensorforge::intel_esimd::simd<float, 16> v113_data;
              v113_data.copy_from(glb_m1 + (128_i32));
              int32_t v117_a = -4_i32 + 144;
              tensorforge::intel_esimd::simd<float, 16> v122_data;
              v122_data.copy_from(glb_m1 + (140_i32));
              int32_t v126_a = -4_i32 + 156;
              tensorforge::intel_esimd::simd<float, 16> v131_data;
              v131_data.copy_from(glb_m1 + (152_i32));
              int32_t v135_a = -4_i32 + 168;
              tensorforge::intel_esimd::simd<float, 16> v140_data;
              v140_data.copy_from(glb_m1 + (164_i32));
              int32_t v144_a = -4_i32 + 180;
              tensorforge::intel_esimd::simd<float, 16> v149_data;
              v149_data.copy_from(glb_m1 + (176_i32));
