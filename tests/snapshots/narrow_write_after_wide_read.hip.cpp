    ...
    // m3 32×13(32×13) {0..32}×{0..13} strided({0..32}×{0..13})[0, 1] = m0 32×13(32×13) {0..32}×{0..13} strided({0..32}×{0..13})[0, -1]×m4 13×13(13×13) {0..13}×{0..13} strided({0..13}×{0..13})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          // glb_m0 = store{r>g}(r5);
          int32_t v131_lead = threadIdx.x % 32;
          #pragma unroll
          for (int32_t v132_i0 = 0; v132_i0 < 1; ++v132_i0) {
            int32_t v141_lead = v131_lead + (v132_i0 * 32);
            #pragma unroll
            for (int32_t v133_i1 = 0; v133_i1 < 1; ++v133_i1) {
              int32_t v134_a = v132_i0 + v133_i1;
              float v136_data = r5[(v132_i0 + v133_i1)];
              int32_t v144_a = v141_lead + ((v133_i1 + 4) * 32);
              glb_m0[v144_a] = v136_data;
            }
          }
          float r6[13]{};
          // r6 = load{g>r}(glb_m0);
          int32_t v147_lead = threadIdx.x % 32;
          #pragma unroll
          for (int32_t v148_i0 = 0; v148_i0 < 1; ++v148_i0) {
            int32_t v154_lead = v147_lead + (v148_i0 * 32);
            #pragma unroll
            for (int32_t v149_i1 = 0; v149_i1 < 13; ++v149_i1) {
              int32_t v156_a = v154_lead + (v149_i1 * 32);
              float v157_data;
              {
                v157_data = glb_m0[v156_a];
              }
              int32_t v158_a = v148_i0 + v149_i1;
              r6[v158_a] = v157_data;
            }
          }
          float r7[13]{};
          ...
          // [(0, 32), (0, 13)] [(0, 13)]
          auto& ir8 = r8;
          float v159_data = r6[0];
          float v160_data = r6[1];
          float v161_data = r6[2];
          float v162_data = r6[3];
          float v163_data = r6[4];
          float v164_data = r6[5];
          float v165_data = r6[6];
          float v166_data = r6[7];
          float v167_data = r6[8];
          float v168_data = r6[9];
          float v169_data = r6[10];
          float v170_data = r6[11];
          float v171_data = r6[12];
          float v172_acc{};
          float v173_acc{};
          float v174_acc{};
          float v175_acc{};
          ...
          tensorforge::fmacdpp16<0>(v172_acc, v186_bc, v159_data);
          tensorforge::fmacdpp16<1>(v172_acc, v186_bc, v160_data);
          tensorforge::fmacdpp16<2>(v172_acc, v186_bc, v161_data);
          tensorforge::fmacdpp16<3>(v172_acc, v186_bc, v162_data);
          tensorforge::fmacdpp16<4>(v172_acc, v186_bc, v163_data);
          tensorforge::fmacdpp16<5>(v172_acc, v186_bc, v164_data);
          tensorforge::fmacdpp16<6>(v172_acc, v186_bc, v165_data);
          tensorforge::fmacdpp16<7>(v172_acc, v186_bc, v166_data);
          tensorforge::fmacdpp16<8>(v172_acc, v186_bc, v167_data);
          tensorforge::fmacdpp16<9>(v172_acc, v186_bc, v168_data);
          tensorforge::fmacdpp16<10>(v172_acc, v186_bc, v169_data);
          tensorforge::fmacdpp16<11>(v172_acc, v186_bc, v170_data);
          tensorforge::fmacdpp16<12>(v172_acc, v186_bc, v171_data);
          tensorforge::fmacdpp16<13>(v173_acc, v186_bc, v159_data);
          tensorforge::fmacdpp16<14>(v173_acc, v186_bc, v160_data);
          tensorforge::fmacdpp16<15>(v173_acc, v186_bc, v161_data);
          float v187_bc = tensorforge::broadcast<32, 16, 1>(v185_lin);
          tensorforge::fmacdpp16<0>(v173_acc, v187_bc, v162_data);
          tensorforge::fmacdpp16<1>(v173_acc, v187_bc, v163_data);
          tensorforge::fmacdpp16<2>(v173_acc, v187_bc, v164_data);
          tensorforge::fmacdpp16<3>(v173_acc, v187_bc, v165_data);
          tensorforge::fmacdpp16<4>(v173_acc, v187_bc, v166_data);
          tensorforge::fmacdpp16<5>(v173_acc, v187_bc, v167_data);
          tensorforge::fmacdpp16<6>(v173_acc, v187_bc, v168_data);
          tensorforge::fmacdpp16<7>(v173_acc, v187_bc, v169_data);
          tensorforge::fmacdpp16<8>(v173_acc, v187_bc, v170_data);
          tensorforge::fmacdpp16<9>(v173_acc, v187_bc, v171_data);
          tensorforge::fmacdpp16<10>(v174_acc, v187_bc, v159_data);
          tensorforge::fmacdpp16<11>(v174_acc, v187_bc, v160_data);
          tensorforge::fmacdpp16<12>(v174_acc, v187_bc, v161_data);
          tensorforge::fmacdpp16<13>(v174_acc, v187_bc, v162_data);
          tensorforge::fmacdpp16<14>(v174_acc, v187_bc, v163_data);
          tensorforge::fmacdpp16<15>(v174_acc, v187_bc, v164_data);
          float v188_lin = r7[1];
          float v189_bc = tensorforge::broadcast<32, 16, 0>(v188_lin);
          tensorforge::fmacdpp16<0>(v174_acc, v189_bc, v165_data);
          tensorforge::fmacdpp16<1>(v174_acc, v189_bc, v166_data);
          tensorforge::fmacdpp16<2>(v174_acc, v189_bc, v167_data);
          tensorforge::fmacdpp16<3>(v174_acc, v189_bc, v168_data);
          tensorforge::fmacdpp16<4>(v174_acc, v189_bc, v169_data);
          tensorforge::fmacdpp16<5>(v174_acc, v189_bc, v170_data);
          tensorforge::fmacdpp16<6>(v174_acc, v189_bc, v171_data);
          tensorforge::fmacdpp16<7>(v175_acc, v189_bc, v159_data);
          tensorforge::fmacdpp16<8>(v175_acc, v189_bc, v160_data);
          tensorforge::fmacdpp16<9>(v175_acc, v189_bc, v161_data);
          tensorforge::fmacdpp16<10>(v175_acc, v189_bc, v162_data);
          tensorforge::fmacdpp16<11>(v175_acc, v189_bc, v163_data);
          tensorforge::fmacdpp16<12>(v175_acc, v189_bc, v164_data);
          tensorforge::fmacdpp16<13>(v175_acc, v189_bc, v165_data);
          tensorforge::fmacdpp16<14>(v175_acc, v189_bc, v166_data);
          tensorforge::fmacdpp16<15>(v175_acc, v189_bc, v167_data);
          float v190_bc = tensorforge::broadcast<32, 16, 1>(v188_lin);
          tensorforge::fmacdpp16<0>(v175_acc, v190_bc, v168_data);
          tensorforge::fmacdpp16<1>(v175_acc, v190_bc, v169_data);
          tensorforge::fmacdpp16<2>(v175_acc, v190_bc, v170_data);
          tensorforge::fmacdpp16<3>(v175_acc, v190_bc, v171_data);
          tensorforge::fmacdpp16<4>(v176_acc, v190_bc, v159_data);
          tensorforge::fmacdpp16<5>(v176_acc, v190_bc, v160_data);
          tensorforge::fmacdpp16<6>(v176_acc, v190_bc, v161_data);
          tensorforge::fmacdpp16<7>(v176_acc, v190_bc, v162_data);
          tensorforge::fmacdpp16<8>(v176_acc, v190_bc, v163_data);
          tensorforge::fmacdpp16<9>(v176_acc, v190_bc, v164_data);
          tensorforge::fmacdpp16<10>(v176_acc, v190_bc, v165_data);
          tensorforge::fmacdpp16<11>(v176_acc, v190_bc, v166_data);
          tensorforge::fmacdpp16<12>(v176_acc, v190_bc, v167_data);
          tensorforge::fmacdpp16<13>(v176_acc, v190_bc, v168_data);
          tensorforge::fmacdpp16<14>(v176_acc, v190_bc, v169_data);
          tensorforge::fmacdpp16<15>(v176_acc, v190_bc, v170_data);
          float v191_lin = r7[2];
          float v192_bc = tensorforge::broadcast<32, 16, 0>(v191_lin);
          tensorforge::fmacdpp16<0>(v176_acc, v192_bc, v171_data);
          tensorforge::fmacdpp16<1>(v177_acc, v192_bc, v159_data);
          tensorforge::fmacdpp16<2>(v177_acc, v192_bc, v160_data);
          tensorforge::fmacdpp16<3>(v177_acc, v192_bc, v161_data);
          tensorforge::fmacdpp16<4>(v177_acc, v192_bc, v162_data);
          tensorforge::fmacdpp16<5>(v177_acc, v192_bc, v163_data);
          tensorforge::fmacdpp16<6>(v177_acc, v192_bc, v164_data);
          tensorforge::fmacdpp16<7>(v177_acc, v192_bc, v165_data);
          tensorforge::fmacdpp16<8>(v177_acc, v192_bc, v166_data);
          tensorforge::fmacdpp16<9>(v177_acc, v192_bc, v167_data);
          tensorforge::fmacdpp16<10>(v177_acc, v192_bc, v168_data);
          tensorforge::fmacdpp16<11>(v177_acc, v192_bc, v169_data);
          tensorforge::fmacdpp16<12>(v177_acc, v192_bc, v170_data);
          tensorforge::fmacdpp16<13>(v177_acc, v192_bc, v171_data);
          tensorforge::fmacdpp16<14>(v178_acc, v192_bc, v159_data);
          tensorforge::fmacdpp16<15>(v178_acc, v192_bc, v160_data);
          float v193_bc = tensorforge::broadcast<32, 16, 1>(v191_lin);
          tensorforge::fmacdpp16<0>(v178_acc, v193_bc, v161_data);
          tensorforge::fmacdpp16<1>(v178_acc, v193_bc, v162_data);
          tensorforge::fmacdpp16<2>(v178_acc, v193_bc, v163_data);
          tensorforge::fmacdpp16<3>(v178_acc, v193_bc, v164_data);
          tensorforge::fmacdpp16<4>(v178_acc, v193_bc, v165_data);
          tensorforge::fmacdpp16<5>(v178_acc, v193_bc, v166_data);
          tensorforge::fmacdpp16<6>(v178_acc, v193_bc, v167_data);
          tensorforge::fmacdpp16<7>(v178_acc, v193_bc, v168_data);
          tensorforge::fmacdpp16<8>(v178_acc, v193_bc, v169_data);
          tensorforge::fmacdpp16<9>(v178_acc, v193_bc, v170_data);
          tensorforge::fmacdpp16<10>(v178_acc, v193_bc, v171_data);
          tensorforge::fmacdpp16<11>(v179_acc, v193_bc, v159_data);
          tensorforge::fmacdpp16<12>(v179_acc, v193_bc, v160_data);
          tensorforge::fmacdpp16<13>(v179_acc, v193_bc, v161_data);
          tensorforge::fmacdpp16<14>(v179_acc, v193_bc, v162_data);
          tensorforge::fmacdpp16<15>(v179_acc, v193_bc, v163_data);
          float v194_lin = r7[3];
          float v195_bc = tensorforge::broadcast<32, 16, 0>(v194_lin);
          tensorforge::fmacdpp16<0>(v179_acc, v195_bc, v164_data);
          tensorforge::fmacdpp16<1>(v179_acc, v195_bc, v165_data);
          tensorforge::fmacdpp16<2>(v179_acc, v195_bc, v166_data);
          tensorforge::fmacdpp16<3>(v179_acc, v195_bc, v167_data);
          tensorforge::fmacdpp16<4>(v179_acc, v195_bc, v168_data);
          tensorforge::fmacdpp16<5>(v179_acc, v195_bc, v169_data);
          tensorforge::fmacdpp16<6>(v179_acc, v195_bc, v170_data);
          tensorforge::fmacdpp16<7>(v179_acc, v195_bc, v171_data);
          tensorforge::fmacdpp16<8>(v180_acc, v195_bc, v159_data);
          tensorforge::fmacdpp16<9>(v180_acc, v195_bc, v160_data);
          tensorforge::fmacdpp16<10>(v180_acc, v195_bc, v161_data);
          tensorforge::fmacdpp16<11>(v180_acc, v195_bc, v162_data);
          tensorforge::fmacdpp16<12>(v180_acc, v195_bc, v163_data);
          tensorforge::fmacdpp16<13>(v180_acc, v195_bc, v164_data);
          tensorforge::fmacdpp16<14>(v180_acc, v195_bc, v165_data);
          tensorforge::fmacdpp16<15>(v180_acc, v195_bc, v166_data);
          float v196_bc = tensorforge::broadcast<32, 16, 1>(v194_lin);
          tensorforge::fmacdpp16<0>(v180_acc, v196_bc, v167_data);
          tensorforge::fmacdpp16<1>(v180_acc, v196_bc, v168_data);
          tensorforge::fmacdpp16<2>(v180_acc, v196_bc, v169_data);
          tensorforge::fmacdpp16<3>(v180_acc, v196_bc, v170_data);
          tensorforge::fmacdpp16<4>(v180_acc, v196_bc, v171_data);
          tensorforge::fmacdpp16<5>(v181_acc, v196_bc, v159_data);
          tensorforge::fmacdpp16<6>(v181_acc, v196_bc, v160_data);
          tensorforge::fmacdpp16<7>(v181_acc, v196_bc, v161_data);
          tensorforge::fmacdpp16<8>(v181_acc, v196_bc, v162_data);
          tensorforge::fmacdpp16<9>(v181_acc, v196_bc, v163_data);
          tensorforge::fmacdpp16<10>(v181_acc, v196_bc, v164_data);
          tensorforge::fmacdpp16<11>(v181_acc, v196_bc, v165_data);
          tensorforge::fmacdpp16<12>(v181_acc, v196_bc, v166_data);
          tensorforge::fmacdpp16<13>(v181_acc, v196_bc, v167_data);
          tensorforge::fmacdpp16<14>(v181_acc, v196_bc, v168_data);
          tensorforge::fmacdpp16<15>(v181_acc, v196_bc, v169_data);
          float v197_lin = r7[4];
          float v198_bc = tensorforge::broadcast<32, 16, 0>(v197_lin);
          tensorforge::fmacdpp16<0>(v181_acc, v198_bc, v170_data);
          tensorforge::fmacdpp16<1>(v181_acc, v198_bc, v171_data);
          tensorforge::fmacdpp16<2>(v182_acc, v198_bc, v159_data);
          tensorforge::fmacdpp16<3>(v182_acc, v198_bc, v160_data);
          tensorforge::fmacdpp16<4>(v182_acc, v198_bc, v161_data);
          tensorforge::fmacdpp16<5>(v182_acc, v198_bc, v162_data);
          tensorforge::fmacdpp16<6>(v182_acc, v198_bc, v163_data);
          tensorforge::fmacdpp16<7>(v182_acc, v198_bc, v164_data);
          tensorforge::fmacdpp16<8>(v182_acc, v198_bc, v165_data);
          tensorforge::fmacdpp16<9>(v182_acc, v198_bc, v166_data);
          tensorforge::fmacdpp16<10>(v182_acc, v198_bc, v167_data);
          tensorforge::fmacdpp16<11>(v182_acc, v198_bc, v168_data);
          tensorforge::fmacdpp16<12>(v182_acc, v198_bc, v169_data);
          tensorforge::fmacdpp16<13>(v182_acc, v198_bc, v170_data);
          tensorforge::fmacdpp16<14>(v182_acc, v198_bc, v171_data);
          tensorforge::fmacdpp16<15>(v183_acc, v198_bc, v159_data);
          float v199_bc = tensorforge::broadcast<32, 16, 1>(v197_lin);
          tensorforge::fmacdpp16<0>(v183_acc, v199_bc, v160_data);
          tensorforge::fmacdpp16<1>(v183_acc, v199_bc, v161_data);
          tensorforge::fmacdpp16<2>(v183_acc, v199_bc, v162_data);
          tensorforge::fmacdpp16<3>(v183_acc, v199_bc, v163_data);
          tensorforge::fmacdpp16<4>(v183_acc, v199_bc, v164_data);
          tensorforge::fmacdpp16<5>(v183_acc, v199_bc, v165_data);
          tensorforge::fmacdpp16<6>(v183_acc, v199_bc, v166_data);
          tensorforge::fmacdpp16<7>(v183_acc, v199_bc, v167_data);
          tensorforge::fmacdpp16<8>(v183_acc, v199_bc, v168_data);
          tensorforge::fmacdpp16<9>(v183_acc, v199_bc, v169_data);
          tensorforge::fmacdpp16<10>(v183_acc, v199_bc, v170_data);
          tensorforge::fmacdpp16<11>(v183_acc, v199_bc, v171_data);
          tensorforge::fmacdpp16<12>(v184_acc, v199_bc, v159_data);
          tensorforge::fmacdpp16<13>(v184_acc, v199_bc, v160_data);
          tensorforge::fmacdpp16<14>(v184_acc, v199_bc, v161_data);
          tensorforge::fmacdpp16<15>(v184_acc, v199_bc, v162_data);
          float v200_lin = r7[5];
          float v201_bc = tensorforge::broadcast<32, 16, 0>(v200_lin);
          tensorforge::fmacdpp16<0>(v184_acc, v201_bc, v163_data);
          tensorforge::fmacdpp16<1>(v184_acc, v201_bc, v164_data);
          tensorforge::fmacdpp16<2>(v184_acc, v201_bc, v165_data);
          tensorforge::fmacdpp16<3>(v184_acc, v201_bc, v166_data);
          tensorforge::fmacdpp16<4>(v184_acc, v201_bc, v167_data);
          tensorforge::fmacdpp16<5>(v184_acc, v201_bc, v168_data);
          tensorforge::fmacdpp16<6>(v184_acc, v201_bc, v169_data);
          tensorforge::fmacdpp16<7>(v184_acc, v201_bc, v170_data);
          tensorforge::fmacdpp16<8>(v184_acc, v201_bc, v171_data);
          ir8[0] = v172_acc;
          ir8[1] = v173_acc;
          ir8[2] = v174_acc;
          ir8[3] = v175_acc;
          ...
          ir8[12] = v184_acc;
          // glb_m3 = store{r>g}(r8);
          int32_t v204_lead = threadIdx.x % 32;
          #pragma unroll
          for (int32_t v205_i0 = 0; v205_i0 < 1; ++v205_i0) {
            int32_t v214_lead = v204_lead + (v205_i0 * 32);
            #pragma unroll
            for (int32_t v206_i1 = 0; v206_i1 < 13; ++v206_i1) {
              int32_t v207_a = v205_i0 + v206_i1;
              float v209_data = r8[(v205_i0 + v206_i1)];
              int32_t v216_a = v214_lead + (v206_i1 * 32);
              glb_m3[v216_a] = v209_data;
            }
          }
          ;
        }
