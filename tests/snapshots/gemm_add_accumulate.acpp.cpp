            ...
            if (allowed) {
              ...
              if (v8_lead < 12) {
                ...
                for (int32_t v40_i1 = 0; v40_i1 < 8; ++v40_i1) {
                  float v48_data = glb_m0[(v8_lead + (v40_i1 * 12))];
                  r2[v40_i1] = v48_data;
                }
              }
              ...
              if (v8_lead < 12) {
                ...
                float v301_data = r1[6];
                float v304_data = ir3[6];
              ...
              if (v8_lead < 12) {
                ...
                float v601_data = r1[4];
                float v604_data = ir3[4];
              ...
              if (v8_lead < 12) {
                ...
                for (int32_t v888_n1 = 0; v888_n1 < 8; ++v888_n1) {
                  float v890_data = ir3[v888_n1];
                  float v892_data = r2[v888_n1];
