        ...
        // OUT = +(TMP, dims=[1])
        {
          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              // glb_m2 = +(s1, dims=[1])
              tensorforge::intel_esimd::simd<float, 8> v203_acc0(0.0f);
              #pragma unroll
              for (int32_t v202_r1 = 0; v202_r1 < 8; ++v202_r1) {
                tensorforge::intel_esimd::simd<float, 8> v208_data;
                v208_data.copy_from(s1 + ((v202_r1 * 8)));
                v203_acc0 = (v203_acc0 + v208_data);
              }
              v203_acc0.copy_to(glb_m2 + (0_i32));
            }
          }
        }
      });
