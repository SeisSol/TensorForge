        ...
        // OUT = +(TMP, dims=[1])
        {
          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              // glb_m2 = +(s1, dims=[1])
              tensorforge::intel_esimd::simd<float, 8> v179_acc0(0.0f);
              #pragma unroll
              for (int32_t v178_r1 = 0; v178_r1 < 8; ++v178_r1) {
                tensorforge::intel_esimd::simd<float, 8> v184_data;
                v184_data.copy_from(s1 + ((v178_r1 * 8)));
                v179_acc0 = (v179_acc0 + v184_data);
              }
              v179_acc0.copy_to(glb_m2 + (0_i32));
            }
          }
        }
      });
