        ...
        // m0 16×11(16×11) {0..16}×{0..11} strided({0..16}×{0..11})[0, 1] = m1 16×16(16×16) {0..16}×{0..16} strided({0..16}×{0..16})[0, -1]×m2 16×11(16×11) {0..16}×{0..11} strided({0..16}×{0..11})[-1, 1]
        {
          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              v19_ld.copy_from(glb_m2 + (0 + 0 + 2 * item.get_local_id(0) + 128));
              v19_ld.copy_to(s0 + (0 + 0 + 2 * item.get_local_id(0) + 128));
              ...
              for (int32_t v446_n0 = 0; v446_n0 < 1; ++v446_n0) {
                ...
                #pragma unroll
                for (int32_t v447_n1 = 0; v447_n1 < 11; ++v447_n1) {
                  int32_t v450_a = v448_a + (v447_n1 * 16);
                  tensorforge::intel_esimd::simd<float, 16> v451_data;
                  v451_data.copy_from(ir1 + (v450_a));
                  v451_data.copy_to(r1 + (v450_a));
                }
              }
              // glb_m0 = store{r>g}(r1);
              #pragma unroll
              for (int32_t v455_i0 = 0; v455_i0 < 1; ++v455_i0) {
                int32_t v457_a = v455_i0 * 16;
                #pragma unroll
                for (int32_t v456_i1 = 0; v456_i1 < 11; ++v456_i1) {
                  int32_t v459_a = v457_a + (v456_i1 * 16);
                  tensorforge::intel_esimd::simd<float, 16> v460_data;
                  v460_data.copy_from(r1 + (v459_a));
                  v460_data.copy_to(glb_m0 + (v459_a));
                }
              }
            }
          }
