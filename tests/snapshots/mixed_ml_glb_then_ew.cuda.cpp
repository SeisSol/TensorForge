...
void launcher_kernel_8c9d1a8467(float* m0, unsigned m0_extraOffset, const float* m1, unsigned m1_extraOffset, const float* m2, unsigned m2_extraOffset, float* m3, unsigned m3_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  ...
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_ERR;
        cudaOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_8c9d1a8467, block.x * block.y * block.z, 512 * sizeof(float));
        CHECK_ERR;
        if (blocksPerSM > 0) {
  ...
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        cudaFuncSetAttribute(kernel_kernel_8c9d1a8467, cudaFuncAttributeMaxDynamicSharedMemorySize, 512 * sizeof(float));
        CHECK_ERR;
        shmemsizeset = true;
      }
      
  cudaStream_t stream = (streamPtr != nullptr) ? static_cast<cudaStream_t>(streamPtr) : 0;
  kernel_kernel_8c9d1a8467<<<grid,block,512 * sizeof(float),stream>>>( m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  m3,  m3_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}
        ...
        if (allowed) {
          ...
          if (v14_lead < 8) {
            ...
            for (int32_t v16_i1 = 0; v16_i1 < 8; ++v16_i1) {
              float v24_data = __ldcg(&glb_m1[(v14_lead + (v16_i1 * 8))]);
              r0[v16_i1] = v24_data;
            }
          }
          ...
          if (v14_lead < 8) {
            ...
            for (int32_t v395_i1 = 0; v395_i1 < 8; ++v395_i1) {
              ...
              glb_m0[(v14_lead + (v395_i1 * 8))] = v397_data;
            }
          }
          // glb_m3 = abs(glb_m0)
          if (v14_lead < 8) {
            ...
            for (int32_t v409_k1 = 0; v409_k1 < 8; ++v409_k1) {
              ...
              float v417_data = glb_m0[(v14_lead + v415_a)];
              glb_m3[(v14_lead + v415_a)] = (fabsf(v417_data));
            }
          }
          __syncwarp();
        }
