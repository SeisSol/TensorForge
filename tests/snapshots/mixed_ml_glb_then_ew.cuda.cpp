// === base name ===
kernel_cc465579466bb529

// === header ===
void launcher_kernel_cc465579466bb529(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, float* m3, size_t m3_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_cc465579466bb529(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, float* m3, size_t m3_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  dim3 block (32, 8, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_ERR;
        cudaOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_cc465579466bb529, block.x * block.y * block.z, 512 * sizeof(float));
        CHECK_ERR;
        if (blocksPerSM > 0) {
  ...
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        cudaFuncSetAttribute(kernel_kernel_cc465579466bb529, cudaFuncAttributeMaxDynamicSharedMemorySize, 512 * sizeof(float));
        CHECK_ERR;
        shmemsizeset = true;
      }
      
  cudaStream_t stream = (streamPtr != nullptr) ? static_cast<cudaStream_t>(streamPtr) : 0;
  kernel_kernel_cc465579466bb529<<<grid,block,512 * sizeof(float),stream>>>( m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  m3,  m3_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}
...
__launch_bounds__(256)
 kernel_kernel_cc465579466bb529(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, float* m3, size_t m3_extraOffset, size_t numElements0, unsigned* flags0 ) {
        ...
        if (allowed) {
          ...
          if (v15_lead < 8) {
            ...
            for (int32_t v17_i1 = 0; v17_i1 < 8; ++v17_i1) {
              float v25_data = __ldcg(&glb_m1[(v15_lead + (v17_i1 * 8))]);
              r0[v17_i1] = v25_data;
            }
          }
          ...
          if (v15_lead < 8) {
            ...
            for (int32_t v395_i1 = 0; v395_i1 < 8; ++v395_i1) {
              ...
              glb_m0[(v15_lead + (v395_i1 * 8))] = v397_data;
            }
          }
          // glb_m3 = abs(glb_m0)
          if (v15_lead < 8) {
            #pragma unroll
            for (int32_t v409_k1 = 0; v409_k1 < 8; ++v409_k1) {
              int32_t v415_a = v409_k1 * 8;
              float v417_data = glb_m0[(v15_lead + v415_a)];
              glb_m3[(v15_lead + v415_a)] = (fabsf(v417_data));
            }
          }
          __syncwarp();
        }
