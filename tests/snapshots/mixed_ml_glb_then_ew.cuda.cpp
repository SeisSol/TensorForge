...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_56230154eb41d846 = {{8, 16, 1}, 8, 8, 1, 16, 4608, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_56230154eb41d846(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_56230154eb41d846(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, float * m3, size_t m3_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_56230154eb41d846(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
  dim3 block (8, 16, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_ERR;
        cudaOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_56230154eb41d846, block.x * block.y * block.z, 1152 * sizeof(float));
        CHECK_ERR;
        if (blocksPerSM > 0) {
...
void launcher_kernel_56230154eb41d846(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, float * m3, size_t m3_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_56230154eb41d846(numElements0, streamPtr);
  dim3 block (config.block[0], config.block[1], config.block[2]);
  dim3 grid (config.grid[0], config.grid[1], config.grid[2]);
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        cudaFuncSetAttribute(kernel_kernel_56230154eb41d846, cudaFuncAttributeMaxDynamicSharedMemorySize, config.sharedMemBytes);
        CHECK_ERR;
        shmemsizeset = true;
      }
      
  cudaStream_t stream = (streamPtr != nullptr) ? static_cast<cudaStream_t>(streamPtr) : 0;
  kernel_kernel_56230154eb41d846<<<grid,block,config.sharedMemBytes,stream>>>(m0, m0_extraOffset, m1, m1_extraOffset, m2, m2_extraOffset, m3, m3_extraOffset, numElements0, flags0);
  CHECK_ERR;
}
...
__launch_bounds__(128)
 kernel_kernel_56230154eb41d846(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, float * m3, size_t m3_extraOffset, size_t numElements0, unsigned * flags0) {
        ...
        if (allowed) {
          ...
          for (int32_t v21_i0 = 0; v21_i0 < 1; ++v21_i0) {
            ...
            for (int32_t v22_i1 = 0; v22_i1 < 8; ++v22_i1) {
              float v27_data = __ldcg(&glb_m1[(v24_lead + (v22_i1 * 8))]);
          ...
          for (int32_t v352_n0 = 0; v352_n0 < 1; ++v352_n0) {
            ...
            for (int32_t v353_n1 = 0; v353_n1 < 8; ++v353_n1) {
              int32_t v354_a = v352_n0 + v353_n1;
              float v355_data = ir1[v354_a];
              r1[v354_a] = v355_data;
            }
          }
          // glb_m0 = store{r>g}(r1);
          ...
          for (int32_t v356_i0 = 0; v356_i0 < 1; ++v356_i0) {
            int32_t v361_lead = v20_lead + (v356_i0 * 8);
            #pragma unroll
            for (int32_t v357_i1 = 0; v357_i1 < 8; ++v357_i1) {
              float v359_data = r1[(v356_i0 + v357_i1)];
              glb_m0[(v361_lead + (v357_i1 * 8))] = v359_data;
            }
          }
          // glb_m3 = abs(glb_m0)
          #pragma unroll
          for (int32_t v364_k0 = 0; v364_k0 < 1; ++v364_k0) {
            int32_t v367_lead = v20_lead + (v364_k0 * 8);
            #pragma unroll
            for (int32_t v365_k1 = 0; v365_k1 < 8; ++v365_k1) {
              int32_t v369_a = v367_lead + (v365_k1 * 8);
              float v370_data = glb_m0[v369_a];
              glb_m3[v369_a] = (fabsf(v370_data));
            }
          }
          __syncwarp(0x000000ffu << (threadIdx.y % 4 * 8));
        }
