...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_7ea87d17404e0836 = {{16, 16, 1}, 16, 10, 1, 16, 1792, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_7ea87d17404e0836(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_7ea87d17404e0836(float * m0, size_t m0_extraOffset, const float * m1, const float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_7ea87d17404e0836(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
  dim3 block (16, 16, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_RES(hipOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_7ea87d17404e0836, block.x * block.y * block.z, 448 * sizeof(float)));
        CHECK_ERR;
        int gfxMajor = 0;
        ...
        if (gfxMajor >= 10 && (448 * sizeof(float)) > 0) {
          ...
          CHECK_RES(hipOccupancyMaxActiveBlocksPerMultiprocessor(&blocksNoLds, kernel_kernel_7ea87d17404e0836, block.x * block.y * block.z, 0));
...
void launcher_kernel_7ea87d17404e0836(float * m0, size_t m0_extraOffset, const float * m1, const float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_7ea87d17404e0836(numElements0, streamPtr);
  dim3 block (config.block[0], config.block[1], config.block[2]);
  dim3 grid (config.grid[0], config.grid[1], config.grid[2]);
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        CHECK_RES(hipFuncSetAttribute(reinterpret_cast<const void*>(&kernel_kernel_7ea87d17404e0836), hipFuncAttributeMaxDynamicSharedMemorySize, config.sharedMemBytes));
        CHECK_ERR;
        shmemsizeset = true;
      }
  ...
  hipLaunchKernelGGL(kernel_kernel_7ea87d17404e0836, grid, block, config.sharedMemBytes, stream, m0Arg, m0_extraOffset, m1Arg, m2Arg, m2_extraOffset, numElements0, flags0Arg);
  CHECK_ERR;
}
...
__launch_bounds__(256)
 kernel_kernel_7ea87d17404e0836(tensorforge::SpacePtr<float, tensorforge::GlobalMemspace> m0, size_t m0_extraOffset, tensorforge::SpacePtr<const float, tensorforge::ConstantMemspace> m1, tensorforge::SpacePtr<const float, tensorforge::GlobalMemspace> m2, size_t m2_extraOffset, size_t numElements0, tensorforge::SpacePtr<unsigned, tensorforge::GlobalMemspace> flags0) {
  extern __shared__ char totalShrMemPtr[];
   {
    ...
    // tensorforge-meta: {"fp":"float","launch":{"active_threads":10,"block":[16,16,1],"cooperative":false,"lead_width":1,"mults_per_block":16,"persistent":true,"sections":[{"barrier":false,"mults_per_block":16,"shared_elements":448}],"shared_bytes":1792,"shared_elements":448,"threads_per_mult":16},"loops":[],"operands":[{"addressing":"strided","alias":"C","bbox":[[0,0],[10,9]],"name":"m0","ordered":false,"parts":1,"shape":[10,9],"variant":false},{"addressing":"none","alias":"A","bbox":[[0,1],[10,18]],"name":"m1","ordered":false,"parts":1,"shape":[16,20],"variant":false},{"addressing":"strided","alias":"B","bbox":[[1,0],[18,9]],"name":"m2","ordered":false,"parts":1,"shape":[20,9],"variant":false}],"operations":[{"add":false,"dest":{"addressing":"strided","bbox":[[0,0],[10,9]],"is_tmp":false,"name":"m0","offset":[0,0],"shape":[10,9]},"kind":"multilinear","ops":[{"addressing":"none","bbox":[[0,1],[10,18]],"is_tmp":false,"name":"m1","offset":[0,0],"shape":[16,20]},{"addressing":"strided","bbox":[[1,0],[18,9]],"is_tmp":false,"name":"m2","offset":[0,0],"shape":[20,9]}],"permute":[[0,1],[0,1]],"target":[[0,-1],[-1,1]]}],"version":"0.0.1\n"}
    {
      ...
      bool v35_g = v24_lead < 2;
      int32_t v67_a = v24_lead + ((threadIdx.y % 4) * 10);
      int32_t v74_a = v67_a + 40;
      int32_t v80_a = v67_a + 80;
      int32_t v86_a = v67_a + 120;
      int32_t v92_a = v24_lead + 160;
      int32_t v162_a = v24_lead + 10;
      int32_t v164_a = v24_lead + 20;
      int32_t v166_a = v24_lead + 30;
      int32_t v168_a = v24_lead + 40;
      int32_t v170_a = v24_lead + 50;
      int32_t v172_a = v24_lead + 60;
      int32_t v174_a = v24_lead + 70;
      int32_t v176_a = v24_lead + 80;
      int32_t v178_a = v24_lead + 90;
      int32_t v180_a = v24_lead + 100;
      int32_t v182_a = v24_lead + 110;
      int32_t v184_a = v24_lead + 120;
      int32_t v186_a = v24_lead + 130;
      int32_t v188_a = v24_lead + 140;
      int32_t v190_a = v24_lead + 150;
      bool v197_g = v24_lead < 10;
      for (size_t v8_batchIdGroup0 = (threadIdx.y - threadIdx.y % 4) + blockDim.y * (blockIdx.x); v8_batchIdGroup0 < numElements0; v8_batchIdGroup0 += (gridDim.x * blockDim.y)) {
        ...
        tensorforge::SpacePtrRestrict<float, tensorforge::GlobalMemspace> const glb_m0 = (tensorforge::SpacePtrRestrict<float, tensorforge::GlobalMemspace>)&m0[v11_batchId0 * 90 + 0 + m0_extraOffset];
        tensorforge::SpacePtrRestrict<const float, tensorforge::GlobalMemspace> const glb_m2 = (tensorforge::SpacePtrRestrict<const float, tensorforge::GlobalMemspace>)&m2[v11_batchId0 * 153 + 0 + m2_extraOffset];
        float r0[18]{};
        // r0 = load{g>r}(glb_m2);
        if (v25_g) {
          ...
          for (int32_t v26_i1 = 0; v26_i1 < 9; ++v26_i1) {
            float v32_data = __builtin_nontemporal_load(&glb_m2[(v29_a + (v26_i1 * 17))]);
        ...
        float v96_data = glb_m1[v24_lead];
        tensorforge::VectorT<float, 4> v97_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v59_tp, v96_data, v94_acc, 2, 0, 0);
        r1[0] = (v97_acc[0]);
        r1[1] = (v97_acc[1]);
        r1[2] = (v97_acc[2]);
        r1[3] = (v97_acc[3]);
        ...
        float v125_data = glb_m1[v67_a];
        tensorforge::VectorT<float, 4> v126_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v106_tp, v125_data, v118_acc, 2, 0, 4);
        tensorforge::VectorT<float, 4> v127_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v107_tp, v125_data, v126_acc, 2, 0, 5);
        tensorforge::VectorT<float, 4> v128_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v108_tp, v125_data, v127_acc, 2, 0, 6);
        tensorforge::VectorT<float, 4> v129_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v109_tp, v125_data, v128_acc, 2, 0, 7);
        float v131_data = glb_m1[v74_a];
        tensorforge::VectorT<float, 4> v132_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v106_tp, v131_data, v129_acc, 2, 1, 4);
        tensorforge::VectorT<float, 4> v133_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v107_tp, v131_data, v132_acc, 2, 1, 5);
        tensorforge::VectorT<float, 4> v134_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v108_tp, v131_data, v133_acc, 2, 1, 6);
        tensorforge::VectorT<float, 4> v135_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v109_tp, v131_data, v134_acc, 2, 1, 7);
        float v137_data = glb_m1[v80_a];
        tensorforge::VectorT<float, 4> v138_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v106_tp, v137_data, v135_acc, 2, 2, 4);
        tensorforge::VectorT<float, 4> v139_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v107_tp, v137_data, v138_acc, 2, 2, 5);
        tensorforge::VectorT<float, 4> v140_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v108_tp, v137_data, v139_acc, 2, 2, 6);
        tensorforge::VectorT<float, 4> v141_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v109_tp, v137_data, v140_acc, 2, 2, 7);
        float v143_data = glb_m1[v86_a];
        tensorforge::VectorT<float, 4> v144_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v106_tp, v143_data, v141_acc, 2, 3, 4);
        tensorforge::VectorT<float, 4> v145_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v107_tp, v143_data, v144_acc, 2, 3, 5);
        tensorforge::VectorT<float, 4> v146_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v108_tp, v143_data, v145_acc, 2, 3, 6);
        tensorforge::VectorT<float, 4> v147_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v109_tp, v143_data, v146_acc, 2, 3, 7);
        tensorforge::VectorT<float, 4> v150_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v114_tp, v93_data, v147_acc, 2, 0, 0);
        tensorforge::VectorT<float, 4> v153_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v115_tp, v96_data, v150_acc, 2, 0, 0);
        r1[4] = (v153_acc[0]);
        r1[5] = (v153_acc[1]);
        r1[6] = (v153_acc[2]);
        r1[7] = (v153_acc[3]);
        ...
        tensorforge::fmacdpp16<1>(v194_acc, v195_data, v96_data);
        ...
        tensorforge::fmacdpp16<1>(v194_acc, v196_data, v93_data);
        r1[8] = v194_acc;
        // glb_m0 = store{r>g}(r1);
        if (v197_g) {
          #pragma unroll
          for (int32_t v198_i1 = 0; v198_i1 < 9; ++v198_i1) {
            ...
            if (batchIdActive0) {
              glb_m0[(v24_lead + (v198_i1 * 10))] = v200_data;
            }
          }
        }
      }
