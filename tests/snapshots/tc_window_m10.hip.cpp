  ...
  extern __shared__ char totalShrMemPtr[];
   {
    ...
    // tensorforge-meta: {"fp":"float","launch":{"active_threads":10,"block":[16,16,1],"cooperative":false,"lead_width":1,"mults_per_block":16,"persistent":true,"sections":[{"barrier":false,"mults_per_block":16,"shared_elements":448}],"shared_bytes":1792,"shared_elements":448,"threads_per_mult":16},"loops":[],"operands":[{"addressing":"strided","alias":"C","bbox":[[0,0],[10,9]],"name":"m0","ordered":false,"parts":1,"shape":[10,9],"variant":false},{"addressing":"none","alias":"A","bbox":[[0,1],[10,18]],"name":"m1","ordered":false,"parts":1,"shape":[16,20],"variant":false},{"addressing":"strided","alias":"B","bbox":[[1,0],[18,9]],"name":"m2","ordered":false,"parts":1,"shape":[20,9],"variant":false}],"operations":[{"add":false,"dest":{"addressing":"strided","bbox":[[0,0],[10,9]],"is_tmp":false,"name":"m0","offset":[0,0],"shape":[10,9]},"kind":"multilinear","ops":[{"addressing":"none","bbox":[[0,1],[10,18]],"is_tmp":false,"name":"m1","offset":[0,0],"shape":[16,20]},{"addressing":"strided","bbox":[[1,0],[18,9]],"is_tmp":false,"name":"m2","offset":[0,0],"shape":[20,9]}],"permute":[[0,1],[0,1]],"target":[[0,-1],[-1,1]]}],"version":"0.0.1\n"}
    {
      ...
      int32_t v156_a = v24_lead + 10;
      int32_t v158_a = v24_lead + 20;
      int32_t v160_a = v24_lead + 30;
      int32_t v162_a = v24_lead + 40;
      int32_t v164_a = v24_lead + 50;
      int32_t v166_a = v24_lead + 60;
      int32_t v168_a = v24_lead + 70;
      int32_t v170_a = v24_lead + 80;
      int32_t v172_a = v24_lead + 90;
      int32_t v174_a = v24_lead + 100;
      int32_t v176_a = v24_lead + 110;
      int32_t v178_a = v24_lead + 120;
      int32_t v180_a = v24_lead + 130;
      int32_t v182_a = v24_lead + 140;
      int32_t v184_a = v24_lead + 150;
      bool v191_g = v24_lead < 10;
      for (size_t v8_batchIdGroup0 = (threadIdx.y - threadIdx.y % 4) + blockDim.y * (blockIdx.x); v8_batchIdGroup0 < numElements0; v8_batchIdGroup0 += (gridDim.x * blockDim.y)) {
        ...
        tensorforge::VectorT<float, 4> v94_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v59_tp, v93_data, v91_acc, 2, 0, 0);
        r1[0] = (v94_acc[0]);
        r1[1] = (v94_acc[1]);
        r1[2] = (v94_acc[2]);
        r1[3] = (v94_acc[3]);
        ...
        tensorforge::VectorT<float, 4> v147_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v112_tp, v93_data, v144_acc, 2, 0, 0);
        r1[4] = (v147_acc[0]);
        r1[5] = (v147_acc[1]);
        r1[6] = (v147_acc[2]);
        r1[7] = (v147_acc[3]);
        float v155_data = glb_m1[v24_lead];
        ...
        float v188_acc{};
        float v189_data = r0[16];
        float v190_data = r0[17];
        tensorforge::fmacdpp16<1>(v188_acc, v189_data, v155_data);
        tensorforge::fmacdpp16<2>(v188_acc, v189_data, v157_data);
        tensorforge::fmacdpp16<3>(v188_acc, v189_data, v159_data);
        tensorforge::fmacdpp16<4>(v188_acc, v189_data, v161_data);
        tensorforge::fmacdpp16<5>(v188_acc, v189_data, v163_data);
        tensorforge::fmacdpp16<6>(v188_acc, v189_data, v165_data);
        tensorforge::fmacdpp16<7>(v188_acc, v189_data, v167_data);
        tensorforge::fmacdpp16<8>(v188_acc, v189_data, v169_data);
        tensorforge::fmacdpp16<9>(v188_acc, v189_data, v171_data);
        tensorforge::fmacdpp16<10>(v188_acc, v189_data, v173_data);
        tensorforge::fmacdpp16<11>(v188_acc, v189_data, v175_data);
        tensorforge::fmacdpp16<12>(v188_acc, v189_data, v177_data);
        tensorforge::fmacdpp16<13>(v188_acc, v189_data, v179_data);
        tensorforge::fmacdpp16<14>(v188_acc, v189_data, v181_data);
        tensorforge::fmacdpp16<15>(v188_acc, v189_data, v183_data);
        tensorforge::fmacdpp16<0>(v188_acc, v190_data, v185_data);
        tensorforge::fmacdpp16<1>(v188_acc, v190_data, v93_data);
        r1[8] = v188_acc;
        // glb_m0 = store{r>g}(r1);
        if (v191_g) {
          #pragma unroll
          for (int32_t v192_i1 = 0; v192_i1 < 9; ++v192_i1) {
            float v194_data = r1[v192_i1];
            if (batchIdActive0) {
              glb_m0[(v24_lead + (v192_i1 * 10))] = v194_data;
            }
          }
        }
      }
