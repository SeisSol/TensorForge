    ...
    // m0 12×8(12×8) {0..12}×{0..8} strided({0..12}×{0..8})[0, 1] = m1 32×16(32×16) {0..32}×{0..16} strided({0..12}×{0..16})[0, -1]×m2 16×8(16×8) {0..16}×{0..8} strided({0..16}×{0..8})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          float v21_tp{};
          float v22_tp{};
          tensorforge::transpose4x4b32(v19_tp, v20_tp, v21_tp, v22_tp, v15_data, v16_data, v17_data, v18_data);
          tensorforge::VectorT<float, 4> v23_acc{};
          float v24_data = r0[0];
          float v25_data = r0[1];
          float v26_data = r0[2];
          float v27_data = r0[3];
          tensorforge::VectorT<float, 4> v28_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v19_tp, v24_data, v23_acc, 2, 0, 0);
          ...
          float v34_data = r0[6];
          float v35_data = r0[7];
          tensorforge::VectorT<float, 4> v36_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v19_tp, v32_data, v31_acc, 2, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v44_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v19_tp, v40_data, v39_acc, 2, 2, 0);
          ...
          float v48_data = r0[12];
          float v49_data = r0[13];
          float v50_data = r0[14];
          float v51_data = r0[15];
          tensorforge::VectorT<float, 4> v52_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v19_tp, v48_data, v47_acc, 2, 3, 0);
          ...
          tensorforge::VectorT<float, 4> v73_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v64_tp, v24_data, v68_acc, 2, 0, 0);
          ...
          tensorforge::VectorT<float, 4> v81_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v64_tp, v32_data, v76_acc, 2, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v89_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v64_tp, v40_data, v84_acc, 2, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v97_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v64_tp, v48_data, v92_acc, 2, 3, 0);
          ...
          if (v107_lead < 12) {
            ...
            for (int32_t v109_i1 = 0; v109_i1 < 8; ++v109_i1) {
              int32_t v110_a = 0 + v109_i1;
              float v111_data = r2[v110_a];
              int32_t v118_a = v107_lead + (v109_i1 * 12);
              glb_m0[v118_a] = v111_data;
            }
          }
          ;
        }
