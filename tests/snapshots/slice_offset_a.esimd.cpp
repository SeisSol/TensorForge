          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              for (int32_t v6_i1 = 0; v6_i1 < 16; ++v6_i1) {
                tensorforge::intel_esimd::simd<float, 12> v13_data;
                v13_data.copy_from(glb_m1 + ((v6_i1 * 12)));
                v13_data.copy_to(r0 + ((v6_i1 * 16)));
              }
              ...
              *(sycl::vec<float, 4>*)&s0[0 + 0 + 4 * item.get_local_id(0) + 64] = *(sycl::vec<float, 4>*)&glb_m2[0 + 0 + 4 * item.get_local_id(0) + 64];
              ...
              #pragma unroll
              for (int32_t v355_n1 = 0; v355_n1 < 8; ++v355_n1) {
                int32_t v356_a = v355_n1 * 16;
                tensorforge::intel_esimd::simd<float, 12> v358_data;
                v358_data.copy_from(ir1 + (v356_a));
                v358_data.copy_to(r1 + (v356_a));
              }
              // glb_m0 = store{r>g}(r1);
              #pragma unroll
              for (int32_t v361_i1 = 0; v361_i1 < 8; ++v361_i1) {
                tensorforge::intel_esimd::simd<float, 12> v364_data;
                v364_data.copy_from(r1 + ((v361_i1 * 16)));
                v364_data.copy_to(glb_m0 + ((v361_i1 * 12)));
              }
            }
          }
        }
