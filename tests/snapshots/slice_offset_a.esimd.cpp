          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              *(sycl::vec<float, 4>*)&s0[0 + 0 + 4 * item.get_local_id(0) + 64] = *(sycl::vec<float, 4>*)&glb_m2[0 + 0 + 4 * item.get_local_id(0) + 64];
              ...
              (v1084_data + (v976_data * v1082_data)).copy_to(ir0 + (112));
              ...
              (v1324_data + (v1216_data * v1322_data)).copy_to(ir0 + (112));
              ...
              (v1564_data + (v1456_data * v1562_data)).copy_to(ir0 + (112));
              ...
              (v1654_data + (v1576_data * v1652_data)).copy_to(ir0 + (80));
              int32_t v1660_a = 0_i32 + 156;
              float v1667_data = s0[109];
              tensorforge::intel_esimd::simd<float, 12> v1669_data;
              v1669_data.copy_from(ir0 + (96));
              (v1669_data + (v1576_data * v1667_data)).copy_to(ir0 + (96));
              int32_t v1675_a = 0_i32 + 156;
              float v1682_data = s0[125];
              tensorforge::intel_esimd::simd<float, 12> v1684_data;
              v1684_data.copy_from(ir0 + (112));
              (v1684_data + (v1576_data * v1682_data)).copy_to(ir0 + (112));
              ...
              (v1804_data + (v1696_data * v1802_data)).copy_to(ir0 + (112));
