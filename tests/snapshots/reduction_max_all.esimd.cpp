...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_15217a7fa6489def = {{1, 16, 1}, 16, 16, 1, 16, 1024, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_15217a7fa6489def(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_15217a7fa6489def(const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_15217a7fa6489def(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
...
void launcher_kernel_15217a7fa6489def(const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_15217a7fa6489def(numElements0, streamPtr);
  ...
  kernel_kernel_15217a7fa6489def(stream, grid, block, m0, m0_extraOffset, m1, m1_extraOffset, numElements0, flags0);
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_15217a7fa6489def(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0) {
