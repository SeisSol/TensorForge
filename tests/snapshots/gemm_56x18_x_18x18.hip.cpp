// === base name ===
kernel_c3e50fdbbccb6fba

// === header ===
void launcher_kernel_c3e50fdbbccb6fba(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_c3e50fdbbccb6fba(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  dim3 block (32, 8, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_RES(hipOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_c3e50fdbbccb6fba, block.x * block.y * block.z, 0 * sizeof(float)));
        CHECK_ERR;
        int gfxMajor = 0;
        ...
        if (gfxMajor >= 10 && (0 * sizeof(float)) > 0) {
          ...
          CHECK_RES(hipOccupancyMaxActiveBlocksPerMultiprocessor(&blocksNoLds, kernel_kernel_c3e50fdbbccb6fba, block.x * block.y * block.z, 0));
  ...
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        CHECK_RES(hipFuncSetAttribute(reinterpret_cast<const void*>(&kernel_kernel_c3e50fdbbccb6fba), hipFuncAttributeMaxDynamicSharedMemorySize, 0 * sizeof(float)));
        CHECK_ERR;
        shmemsizeset = true;
      }
      
  hipStream_t stream = (streamPtr != nullptr) ? static_cast<hipStream_t>(streamPtr) : 0;
  hipLaunchKernelGGL(kernel_kernel_c3e50fdbbccb6fba, grid, block, 0 * sizeof(float), stream,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}
...
__launch_bounds__(256)
 kernel_kernel_c3e50fdbbccb6fba(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 ) {
  extern __shared__ char totalShrMemPtr[];
   {
    ...
    // m0 56×18(56×18) {0..56}×{0..18} strided({0..56}×{0..18})[0, 1] = m1 56×18(56×18) {0..56}×{0..18} strided({0..56}×{0..18})[0, -1]×m2 18×18(18×18) {0..18}×{0..18} strided({0..18}×{0..18})[-1, 1]
    {
      ...
      for (size_t v0_batchId0 = (threadIdx.y + blockDim.y * (blockIdx.x)); v0_batchId0 < numElements0; v0_batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          tensorforge::SpacePtrRestrict<float, tensorforge::GlobalMemspace> const glb_m0 = (tensorforge::SpacePtrRestrict<float, tensorforge::GlobalMemspace>)&m0[v0_batchId0 * 1008 + 0 + m0_extraOffset];
          tensorforge::SpacePtrRestrict<const float, tensorforge::GlobalMemspace> const glb_m1 = (tensorforge::SpacePtrRestrict<const float, tensorforge::GlobalMemspace>)&m1[v0_batchId0 * 1008 + 0 + m1_extraOffset];
          tensorforge::SpacePtrRestrict<const float, tensorforge::GlobalMemspace> const glb_m2 = (tensorforge::SpacePtrRestrict<const float, tensorforge::GlobalMemspace>)&m2[v0_batchId0 * 324 + 0 + m2_extraOffset];
          float r0[36]{};
          // r0 = load{g>r}(glb_m1);
          ...
          for (int32_t v15_i0 = 0; v15_i0 < 1; ++v15_i0) {
            ...
            for (int32_t v16_i1 = 0; v16_i1 < 18; ++v16_i1) {
              float v24_data = __builtin_nontemporal_load(&glb_m1[(v21_lead + (v16_i1 * 56))]);
          ...
          if (v14_lead < 24) {
            ...
            for (int32_t v28_i1 = 0; v28_i1 < 18; ++v28_i1) {
              float v36_data = __builtin_nontemporal_load(&glb_m1[(v33_lead + (v28_i1 * 56))]);
          ...
          if (v14_lead < 18) {
            ...
            for (int32_t v44_i1 = 0; v44_i1 < 18; ++v44_i1) {
              float v52_data = __builtin_nontemporal_load(&glb_m2[(v14_lead + (v44_i1 * 18))]);
              r1[v44_i1] = v52_data;
            }
          }
          ...
          for (int32_t v524_i0 = 0; v524_i0 < 1; ++v524_i0) {
            int32_t v533_lead = v14_lead + (v524_i0 * 32);
            #pragma unroll
            for (int32_t v525_i1 = 0; v525_i1 < 18; ++v525_i1) {
              float v528_data = r2[(v524_i0 + (v525_i1 * 2))];
              glb_m0[(v533_lead + (v525_i1 * 56))] = v528_data;
            }
          }
          if (v14_lead < 24) {
            int32_t v545_lead = v14_lead + 32_i32;
            #pragma unroll
            for (int32_t v537_i1 = 0; v537_i1 < 18; ++v537_i1) {
              float v540_data = r2[(1 + (v537_i1 * 2))];
              glb_m0[(v545_lead + (v537_i1 * 56))] = v540_data;
            }
          }
        }
      }
