// === base name ===
kernel_77d4b47585447c08

// === header ===
void launcher_kernel_77d4b47585447c08(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_77d4b47585447c08(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  dim3 block (32, 8, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_ERR;
        cudaOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_77d4b47585447c08, block.x * block.y * block.z, 256 * sizeof(float));
        CHECK_ERR;
        if (blocksPerSM > 0) {
  ...
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        cudaFuncSetAttribute(kernel_kernel_77d4b47585447c08, cudaFuncAttributeMaxDynamicSharedMemorySize, 256 * sizeof(float));
        CHECK_ERR;
        shmemsizeset = true;
      }
      
  cudaStream_t stream = (streamPtr != nullptr) ? static_cast<cudaStream_t>(streamPtr) : 0;
  kernel_kernel_77d4b47585447c08<<<grid,block,256 * sizeof(float),stream>>>( m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}
...
__launch_bounds__(256)
 kernel_kernel_77d4b47585447c08(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 ) {
        ...
        if (allowed) {
          ...
          for (int32_t v15_i0 = 0; v15_i0 < 1; ++v15_i0) {
            ...
            for (int32_t v16_i1 = 0; v16_i1 < 8; ++v16_i1) {
              float v24_data = __ldcg(&glb_m1[(v21_lead + (v16_i1 * 35))]);
          ...
          if (v14_lead < 3) {
            ...
            for (int32_t v28_i1 = 0; v28_i1 < 8; ++v28_i1) {
              float v36_data = __ldcg(&glb_m1[(v33_lead + (v28_i1 * 35))]);
          ...
          for (int32_t v414_i0 = 0; v414_i0 < 1; ++v414_i0) {
            int32_t v423_lead = v14_lead + (v414_i0 * 32);
            #pragma unroll
          ...
          if (v14_lead < 3) {
            int32_t v435_lead = v14_lead + 32_i32;
            #pragma unroll
