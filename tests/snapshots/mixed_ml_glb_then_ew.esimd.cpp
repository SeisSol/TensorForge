          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              for (int32_t v345_i1 = 0; v345_i1 < 8; ++v345_i1) {
                ...
                v348_data.copy_to(glb_m0 + ((v345_i1 * 8)));
              }
              // glb_m3 = abs(glb_m0)
              #pragma unroll
              for (int32_t v353_k1 = 0; v353_k1 < 8; ++v353_k1) {
                int32_t v356_a = v353_k1 * 8;
                tensorforge::intel_esimd::simd<float, 8> v358_data;
                v358_data.copy_from(glb_m0 + (v356_a));
                (tensorforge::intel_esimd::abs(v358_data)).copy_to(glb_m3 + (v356_a));
              }
            }
          }
        }
