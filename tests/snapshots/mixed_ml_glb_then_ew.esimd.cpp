        ...
        // C = abs(M)
        {
          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              v28_lin.copy_from(s0 + (0 + item.get_local_id(0) * 1));
              ...
              for (int32_t v177_i1 = 0; v177_i1 < 8; ++v177_i1) {
                ...
                v180_data.copy_to(glb_m0 + ((v177_i1 * 8)));
              }
              // glb_m3 = abs(glb_m0)
              #pragma unroll
              for (int32_t v185_k1 = 0; v185_k1 < 8; ++v185_k1) {
                int32_t v188_a = v185_k1 * 8;
                tensorforge::intel_esimd::simd<float, 8> v190_data;
                v190_data.copy_from(glb_m0 + (v188_a));
                (tensorforge::intel_esimd::abs(v190_data)).copy_to(glb_m3 + (v188_a));
              }
            }
          }
        }
