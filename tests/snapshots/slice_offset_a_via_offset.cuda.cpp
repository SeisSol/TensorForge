        ...
        if (allowed) {
          ...
          if (v6_lead < 12) {
            ...
            for (int32_t v738_n1 = 0; v738_n1 < 8; ++v738_n1) {
              int32_t v739_a = 0 + v738_n1;
              float v741_data = ir1[v738_n1];
              int32_t v742_a = 0 + v738_n1;
              r1[v738_n1] = v741_data;
            }
          }
          // glb_m0 = store{r>g}(r1);
          if (v6_lead < 12) {
            ...
            for (int32_t v748_i1 = 0; v748_i1 < 8; ++v748_i1) {
              ...
              int32_t v758_a = v6_lead + (v748_i1 * 12);
              glb_m0[v758_a] = v751_data;
            }
          }
          __syncwarp();
        }
