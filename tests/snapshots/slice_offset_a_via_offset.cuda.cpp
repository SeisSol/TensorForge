        ...
        if (allowed) {
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v12_i1 = 0; v12_i1 < 16; ++v12_i1) {
              ...
              float v29_data = __ldcg(&glb_m1[(v26_off + v19_a)]);
              r0[v12_i1] = v29_data;
            }
          }
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v743_n1 = 0; v743_n1 < 8; ++v743_n1) {
              int32_t v744_a = 0 + v743_n1;
              float v746_data = ir1[v743_n1];
              r1[v743_n1] = v746_data;
            }
          }
          // glb_m0 = store{r>g}(r1);
          if (v10_lead < 12) {
            #pragma unroll
            for (int32_t v752_i1 = 0; v752_i1 < 8; ++v752_i1) {
              int32_t v753_a = 0 + v752_i1;
              float v755_data = r1[v752_i1];
              glb_m0[(v10_lead + (v752_i1 * 12))] = v755_data;
            }
          }
          __syncwarp();
        }
