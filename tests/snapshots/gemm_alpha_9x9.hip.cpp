        ...
        if (allowed) {
          ...
          if (v10_lead < 9) {
            ...
            for (int32_t v12_i1 = 0; v12_i1 < 9; ++v12_i1) {
              float v20_data = __builtin_nontemporal_load(&glb_m1[(v10_lead + (v12_i1 * 9))]);
              r0[v12_i1] = v20_data;
            }
          }
          float r1[9]{};
          ...
          if (v10_lead < 9) {
            ...
            for (int32_t v60_n1 = 0; v60_n1 < 9; ++v60_n1) {
              float v62_data = ir2[v60_n1];
              r2[v60_n1] = (v62_data * 13.0f);
            }
          }
          // glb_m0 = store{r>g}(r2);
          if (v10_lead < 9) {
            ...
            for (int32_t v69_i1 = 0; v69_i1 < 9; ++v69_i1) {
              float v71_data = r2[v69_i1];
              glb_m0[(v10_lead + (v69_i1 * 9))] = v71_data;
            }
          }
        }
      }
