...
void launcher_kernel_08888e2501(const float* m0, unsigned m0_extraOffset, float* m1, unsigned m1_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  ...
  kernel_kernel_08888e2501(stream, grid, block,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}
            ...
            if (allowed) {
              ...
              for (int32_t v4_k0 = 0; v4_k0 < 1; ++v4_k0) {
                ...
                for (int32_t v5_r1 = 0; v5_r1 < 16; ++v5_r1) {
                  ...
                  v6_acc0 = (tensorforge::intel_esimd::min(v6_acc0, v11_data));
                }
