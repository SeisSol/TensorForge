        ...
        if (allowed) {
          ...
          if (v196_lead < 16) {
            ...
            for (int32_t v198_i1 = 0; v198_i1 < 16; ++v198_i1) {
              ...
              float v201_data = r2[v198_i1];
              int32_t v208_a = v196_lead + (v198_i1 * 16);
              glb_m0[v208_a] = v201_data;
            }
          }
          ;
        }
    ...
    }
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements1; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          float r0[16]{};
          // r0 = load{g>r}(glb_m0);
          int32_t v211_lead = threadIdx.x % 32;
          if (v211_lead < 16) {
            #pragma unroll
            for (int32_t v213_i1 = 0; v213_i1 < 16; ++v213_i1) {
              int32_t v220_a = v211_lead + (v213_i1 * 16);
              float v221_data;
              {
                v221_data = __builtin_nontemporal_load(&glb_m0[v220_a]);
              }
              int32_t v222_a = 0 + v213_i1;
              r0[v222_a] = v221_data;
            }
          }
          float r1[16]{};
          ...
          float v232_data = r0[0];
          float v233_data = r0[1];
          float v234_data = r0[2];
          float v235_data = r0[3];
          tensorforge::VectorT<float, 4> v236_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v227_tp, v232_data, v231_acc, 3, 0, 0);
          ...
          tensorforge::VectorT<float, 4> v239_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v230_tp, v235_data, v238_acc, 3, 0, 0);
          float v240_data = r0[4];
          float v241_data = r0[5];
          float v242_data = r0[6];
          float v243_data = r0[7];
          tensorforge::VectorT<float, 4> v244_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v227_tp, v240_data, v239_acc, 3, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v247_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v230_tp, v243_data, v246_acc, 3, 1, 0);
          float v248_data = r0[8];
          float v249_data = r0[9];
          float v250_data = r0[10];
          float v251_data = r0[11];
          tensorforge::VectorT<float, 4> v252_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v227_tp, v248_data, v247_acc, 3, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v255_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v230_tp, v251_data, v254_acc, 3, 2, 0);
          float v256_data = r0[12];
          float v257_data = r0[13];
          float v258_data = r0[14];
          float v259_data = r0[15];
          tensorforge::VectorT<float, 4> v260_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v227_tp, v256_data, v255_acc, 3, 3, 0);
          ...
          tensorforge::VectorT<float, 4> v263_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v230_tp, v259_data, v262_acc, 3, 3, 0);
          ir2[0] = (v263_acc[0]);
          ir2[1] = (v263_acc[1]);
          ir2[2] = (v263_acc[2]);
          ir2[3] = (v263_acc[3]);
          ...
          tensorforge::VectorT<float, 4> v281_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v272_tp, v232_data, v276_acc, 3, 0, 0);
          ...
          tensorforge::VectorT<float, 4> v284_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v275_tp, v235_data, v283_acc, 3, 0, 0);
          tensorforge::VectorT<float, 4> v289_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v272_tp, v240_data, v284_acc, 3, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v292_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v275_tp, v243_data, v291_acc, 3, 1, 0);
          tensorforge::VectorT<float, 4> v297_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v272_tp, v248_data, v292_acc, 3, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v300_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v275_tp, v251_data, v299_acc, 3, 2, 0);
          tensorforge::VectorT<float, 4> v305_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v272_tp, v256_data, v300_acc, 3, 3, 0);
          ...
          tensorforge::VectorT<float, 4> v308_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v275_tp, v259_data, v307_acc, 3, 3, 0);
          ir2[4] = (v308_acc[0]);
          ir2[5] = (v308_acc[1]);
          ir2[6] = (v308_acc[2]);
          ir2[7] = (v308_acc[3]);
          float v313_data = r1[8];
          float v314_data = r1[9];
          float v315_data = r1[10];
          float v316_data = r1[11];
          float v317_tp{};
          float v318_tp{};
          float v319_tp{};
          float v320_tp{};
          ...
          tensorforge::VectorT<float, 4> v326_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v317_tp, v232_data, v321_acc, 3, 0, 0);
          ...
          tensorforge::VectorT<float, 4> v329_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v320_tp, v235_data, v328_acc, 3, 0, 0);
          tensorforge::VectorT<float, 4> v334_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v317_tp, v240_data, v329_acc, 3, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v337_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v320_tp, v243_data, v336_acc, 3, 1, 0);
          tensorforge::VectorT<float, 4> v342_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v317_tp, v248_data, v337_acc, 3, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v345_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v320_tp, v251_data, v344_acc, 3, 2, 0);
          tensorforge::VectorT<float, 4> v350_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v317_tp, v256_data, v345_acc, 3, 3, 0);
          ...
          tensorforge::VectorT<float, 4> v353_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v320_tp, v259_data, v352_acc, 3, 3, 0);
          ir2[8] = (v353_acc[0]);
          ir2[9] = (v353_acc[1]);
          ir2[10] = (v353_acc[2]);
          ir2[11] = (v353_acc[3]);
          float v358_data = r1[12];
          float v359_data = r1[13];
          float v360_data = r1[14];
          float v361_data = r1[15];
          float v362_tp{};
          float v363_tp{};
          float v364_tp{};
          float v365_tp{};
          ...
          tensorforge::VectorT<float, 4> v371_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v362_tp, v232_data, v366_acc, 3, 0, 0);
          ...
          tensorforge::VectorT<float, 4> v374_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v365_tp, v235_data, v373_acc, 3, 0, 0);
          tensorforge::VectorT<float, 4> v379_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v362_tp, v240_data, v374_acc, 3, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v382_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v365_tp, v243_data, v381_acc, 3, 1, 0);
          tensorforge::VectorT<float, 4> v387_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v362_tp, v248_data, v382_acc, 3, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v390_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v365_tp, v251_data, v389_acc, 3, 2, 0);
          tensorforge::VectorT<float, 4> v395_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v362_tp, v256_data, v390_acc, 3, 3, 0);
          ...
          tensorforge::VectorT<float, 4> v398_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v365_tp, v259_data, v397_acc, 3, 3, 0);
          ir2[12] = (v398_acc[0]);
          ir2[13] = (v398_acc[1]);
          ir2[14] = (v398_acc[2]);
          ir2[15] = (v398_acc[3]);
          // glb_m3 = store{r>g}(r2);
          int32_t v405_lead = threadIdx.x % 32;
          if (v405_lead < 16) {
            #pragma unroll
            for (int32_t v407_i1 = 0; v407_i1 < 16; ++v407_i1) {
              int32_t v408_a = 0 + v407_i1;
              float v410_data = r2[v407_i1];
              int32_t v417_a = v405_lead + (v407_i1 * 16);
              glb_m3[v417_a] = v410_data;
            }
          }
          ;
        }
