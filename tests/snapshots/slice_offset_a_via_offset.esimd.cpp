...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_5e83093d893bee18 = {{1, 16, 1}, 16, 12, 1, 16, 9216, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_5e83093d893bee18(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_5e83093d893bee18(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_5e83093d893bee18(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
...
void launcher_kernel_5e83093d893bee18(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_5e83093d893bee18(numElements0, streamPtr);
  ...
  kernel_kernel_5e83093d893bee18(stream, grid, block, m0, m0_extraOffset, m1, m1_extraOffset, m2, m2_extraOffset, numElements0, flags0);
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_5e83093d893bee18(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, size_t numElements0, unsigned * flags0) {
      ...
      tensorforge::slmReserve<2304 * sizeof(float)>(); {
        ...
        // tensorforge-meta: {"fp":"float","launch":{"active_threads":12,"block":[1,16,1],"cooperative":false,"lead_width":1,"mults_per_block":16,"persistent":true,"sections":[{"barrier":false,"mults_per_block":16,"shared_elements":2304}],"shared_bytes":9216,"shared_elements":2304,"threads_per_mult":16},"loops":[],"operands":[{"addressing":"strided","alias":"C","bbox":[[0,0],[12,8]],"name":"m0","ordered":false,"parts":1,"shape":[12,8],"variant":false},{"addressing":"strided","alias":"A","bbox":[[0,0],[32,16]],"name":"m1","ordered":false,"parts":1,"shape":[32,16],"variant":false},{"addressing":"strided","alias":"B","bbox":[[0,0],[16,8]],"name":"m2","ordered":false,"parts":1,"shape":[16,8],"variant":false}],"operations":[{"add":false,"dest":{"addressing":"strided","bbox":[[0,0],[12,8]],"is_tmp":false,"name":"m0","offset":[0,0],"shape":[12,8]},"kind":"multilinear","ops":[{"addressing":"strided","bbox":[[0,0],[12,16]],"is_tmp":false,"name":"m1","offset":[4,0],"shape":[32,16]},{"addressing":"strided","bbox":[[0,0],[16,8]],"is_tmp":false,"name":"m2","offset":[0,0],"shape":[16,8]}],"permute":[[0,1],[0,1]],"target":[[0,-1],[-1,1]]}],"version":"0.0.1\n"}
        {
          ...
          for (size_t v5_batchId0 = (item.get_local_id(1) + item.get_group().get_local_range(1) * (item.get_group().get_group_id(2))); v5_batchId0 < numElements0; v5_batchId0 += (item.get_group_range(2) * item.get_group().get_local_range(1))) {
            ...
            const float *const __restrict__ pf_glb_m1 = &m1[v8_batchId1 * 512 + 0 + m1_extraOffset];
            ...
            if (allowed) {
              ...
              for (int32_t v19_i1 = 0; v19_i1 < 16; ++v19_i1) {
                ...
                v25_data.copy_from(glb_m1 + ((4_i32 + (v19_i1 * 32))));
                r0.template select<12, 1>((v19_i1 * 16)) = v25_data;
              }
              ...
              for (int32_t v330_n1 = 0; v330_n1 < 8; ++v330_n1) {
                int32_t v331_a = v330_n1 * 16;
                tensorforge::intel_esimd::simd<float, 12> v333_data(ir1.template select<12, 1>(v331_a));
                r1.template select<12, 1>(v331_a) = v333_data;
              }
              // glb_m0 = store{r>g}(r1);
              #pragma unroll
              for (int32_t v334_i1 = 0; v334_i1 < 8; ++v334_i1) {
                tensorforge::intel_esimd::simd<float, 12> v337_data(r1.template select<12, 1>((v334_i1 * 16)));
                v337_data.copy_to(glb_m0 + ((v334_i1 * 12)));
              }
            }
            tensorforge::prefetchL2<496>(&pf_glb_m1[0]);
            tensorforge::prefetchRunsL2<64, 512>(&pf_glb_m1[496], &pf_glb_m2[0]);
          }
        }
      }
    });
