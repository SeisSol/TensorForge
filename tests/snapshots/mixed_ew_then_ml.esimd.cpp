          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              for (int32_t v201_i1 = 0; v201_i1 < 8; ++v201_i1) {
                ...
                v204_data.copy_to(glb_m1 + ((v201_i1 * 8)));
              }
            }
          }
        }
