// === base name ===
kernel_e1c48a6b0996d520

// === header ===
void launcher_kernel_e1c48a6b0996d520(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_e1c48a6b0996d520(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  dim3 block (16, 16, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_RES(hipOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_e1c48a6b0996d520, block.x * block.y * block.z, 256 * sizeof(float)));
        CHECK_ERR;
        if (blocksPerSM > 0) {
  ...
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        CHECK_RES(hipFuncSetAttribute(reinterpret_cast<const void*>(&kernel_kernel_e1c48a6b0996d520), hipFuncAttributeMaxDynamicSharedMemorySize, 256 * sizeof(float)));
        CHECK_ERR;
        shmemsizeset = true;
      }
      
  hipStream_t stream = (streamPtr != nullptr) ? static_cast<hipStream_t>(streamPtr) : 0;
  hipLaunchKernelGGL(kernel_kernel_e1c48a6b0996d520, grid, block, 256 * sizeof(float), stream,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}
...
__launch_bounds__(256)
 kernel_kernel_e1c48a6b0996d520(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 ) {
        ...
        if (allowed) {
          ...
          for (int32_t v31_i0 = 0; v31_i0 < 1; ++v31_i0) {
            ...
            for (int32_t v32_i1 = 0; v32_i1 < 8; ++v32_i1) {
              float v40_data = __builtin_nontemporal_load(&glb_m2[(v37_lead + (v32_i1 * 16))]);
          ...
          for (int32_t v136_i0 = 0; v136_i0 < 1; ++v136_i0) {
            int32_t v144_lead = v13_lead + (v136_i0 * 16);
            #pragma unroll
            for (int32_t v137_i1 = 0; v137_i1 < 8; ++v137_i1) {
              float v139_data = r2[(v136_i0 + v137_i1)];
              glb_m0[(v144_lead + (v137_i1 * 16))] = v139_data;
            }
          }
        }
      }
