        ...
        if (allowed) {
          ...
          for (int32_t v8_i0 = 0; v8_i0 < 1; ++v8_i0) {
            ...
            for (int32_t v9_i1 = 8; v9_i1 < 24; ++v9_i1) {
              ...
              float v26_data = __builtin_nontemporal_load(&glb_m1[(v23_off + v16_a)]);
          ...
          for (int32_t v132_i0 = 0; v132_i0 < 1; ++v132_i0) {
            int32_t v141_lead = v7_lead + (v132_i0 * 16);
            #pragma unroll
            for (int32_t v133_i1 = 0; v133_i1 < 8; ++v133_i1) {
              int32_t v134_a = v132_i0 + v133_i1;
              float v136_data = r2[(v132_i0 + v133_i1)];
              glb_m0[(v141_lead + (v133_i1 * 16))] = v136_data;
            }
          }
        }
      }
