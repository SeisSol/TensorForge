...
void launcher_kernel_b5ac3bb66a(const float* m0, unsigned m0_extraOffset, float* m1, unsigned m1_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  ...
  kernel_kernel_b5ac3bb66a(stream, grid, block,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_b5ac3bb66a(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, const float* m0, unsigned m0_extraOffset, float* m1, unsigned m1_extraOffset, size_t numElements0, unsigned* flags0 ) {
            ...
            if (allowed) {
              ...
              for (int32_t v7_k0 = 0; v7_k0 < 1; ++v7_k0) {
                ...
                for (int32_t v8_k1 = 0; v8_k1 < 16; ++v8_k1) {
                  ...
                  glb_m1[(v13_lead + v14_a)] = (sycl::sqrt(v16_data));
                }
              }
            }
          }
