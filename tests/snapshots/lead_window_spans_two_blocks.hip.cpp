        ...
        if (allowed) {
          ...
          if (v14_lead >= 20) {
            ...
            for (int32_t v240_i1 = 0; v240_i1 < 1; ++v240_i1) {
              ...
              int32_t v255_a = v14_lead + ((v240_i1 + 12) * 64);
              #pragma unroll
              for (int32_t v241_i2 = 0; v241_i2 < 6; ++v241_i2) {
                float v246_data = r2[(v242_a + (v241_i2 * 2))];
                int32_t v256_a = v255_a + (v241_i2 * 832);
                __builtin_amdgcn_global_atomic_fadd_f32(&glb_m2[v256_a], v246_data);
              }
            }
          }
          if (v14_lead < 3) {
            int32_t v269_lead = v14_lead + 32_i32;
            #pragma unroll
            for (int32_t v258_i1 = 0; v258_i1 < 1; ++v258_i1) {
              int32_t v262_a = 1 + (v258_i1 * 2);
              int32_t v273_a = v269_lead + ((v258_i1 + 12) * 64);
              #pragma unroll
              for (int32_t v259_i2 = 0; v259_i2 < 6; ++v259_i2) {
                float v264_data = r2[(v262_a + (v259_i2 * 2))];
                int32_t v274_a = v273_a + (v259_i2 * 832);
                __builtin_amdgcn_global_atomic_fadd_f32(&glb_m2[v274_a], v264_data);
              }
            }
          }
        }
