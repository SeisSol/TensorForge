        ...
        if (allowed) {
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v12_i1 = 0; v12_i1 < 16; ++v12_i1) {
              ...
              double v27_data = __builtin_nontemporal_load(&glb_m1[(v10_lead + v18_a)]);
              r0[v12_i1] = v27_data;
            }
          }
          double r1[8]{};
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v75_i1 = 0; v75_i1 < 8; ++v75_i1) {
              ...
              double v78_data = r2[v75_i1];
              int32_t v85_a = v10_lead + (v75_i1 * 12);
              __builtin_amdgcn_global_atomic_fadd_f64(&glb_m0[v85_a], v78_data);
            }
          }
        }
      }
