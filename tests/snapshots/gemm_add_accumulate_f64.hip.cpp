        ...
        if (allowed) {
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v12_i1 = 0; v12_i1 < 16; ++v12_i1) {
              double v20_data = __builtin_nontemporal_load(&glb_m1[(v10_lead + (v12_i1 * 12))]);
              r0[v12_i1] = v20_data;
            }
          }
          double r1[8]{};
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v68_i1 = 0; v68_i1 < 8; ++v68_i1) {
              double v70_data = r2[v68_i1];
              int32_t v77_a = v10_lead + (v68_i1 * 12);
              __builtin_amdgcn_global_atomic_fadd_f64(&glb_m0[v77_a], v70_data);
            }
          }
        }
      }
