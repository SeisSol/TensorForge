// === base name ===
kernel_5a4d1be70ed438e4

// === header ===
void launcher_kernel_5a4d1be70ed438e4(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_5a4d1be70ed438e4(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  dim3 block (32, 8, 1);
  static std::size_t gridsize = 0;
      if (gridsize == 0) {
        ...
        CHECK_ERR;
        cudaOccupancyMaxActiveBlocksPerMultiprocessor(&blocksPerSM, kernel_kernel_5a4d1be70ed438e4, block.x * block.y * block.z, 1536 * sizeof(float));
        CHECK_ERR;
        if (blocksPerSM > 0) {
  ...
  static bool shmemsizeset = false;
      if (!shmemsizeset) {
        cudaFuncSetAttribute(kernel_kernel_5a4d1be70ed438e4, cudaFuncAttributeMaxDynamicSharedMemorySize, 1536 * sizeof(float));
        CHECK_ERR;
        shmemsizeset = true;
      }
      
  cudaStream_t stream = (streamPtr != nullptr) ? static_cast<cudaStream_t>(streamPtr) : 0;
  kernel_kernel_5a4d1be70ed438e4<<<grid,block,1536 * sizeof(float),stream>>>( m0,  m0_extraOffset,  m1,  m1_extraOffset,  m2,  m2_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}
...
__launch_bounds__(256)
 kernel_kernel_5a4d1be70ed438e4(float* m0, size_t m0_extraOffset, const float* m1, size_t m1_extraOffset, const float* m2, size_t m2_extraOffset, size_t numElements0, unsigned* flags0 ) {
        ...
        if (allowed) {
          ...
          for (int32_t v148_n0 = 0; v148_n0 < 1; ++v148_n0) {
            ...
            for (int32_t v149_n1 = 6; v149_n1 < 13; ++v149_n1) {
              int32_t v151_a = v148_n0 + (v149_n1 - 6);
          ...
          for (int32_t v158_i0 = 0; v158_i0 < 1; ++v158_i0) {
            int32_t v163_lead = v158_i0 * 32;
            glb_m0[(v14_lead + v163_lead)] = 0.0f;
            glb_m0[((v14_lead + v163_lead) + 32)] = 0.0f;
            glb_m0[((v14_lead + v163_lead) + 64)] = 0.0f;
            glb_m0[((v14_lead + v163_lead) + 96)] = 0.0f;
            glb_m0[((v14_lead + v163_lead) + 128)] = 0.0f;
            glb_m0[((v14_lead + v163_lead) + 160)] = 0.0f;
            float v202_data = r1[v158_i0];
            glb_m0[((v14_lead + v163_lead) + 192)] = v202_data;
            float v210_data = r1[(v158_i0 + 1)];
            glb_m0[((v14_lead + v163_lead) + 224)] = v210_data;
            float v218_data = r1[(v158_i0 + 2)];
            glb_m0[((v14_lead + v163_lead) + 256)] = v218_data;
            float v226_data = r1[(v158_i0 + 3)];
            glb_m0[((v14_lead + v163_lead) + 288)] = v226_data;
            float v234_data = r1[(v158_i0 + 4)];
            glb_m0[((v14_lead + v163_lead) + 320)] = v234_data;
            float v242_data = r1[(v158_i0 + 5)];
            glb_m0[((v14_lead + v163_lead) + 352)] = v242_data;
            float v250_data = r1[(v158_i0 + 6)];
            glb_m0[((v14_lead + v163_lead) + 384)] = v250_data;
          }
          __syncwarp();
        }
      }
