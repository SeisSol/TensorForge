    ...
    // m2 32×32(12×6) {0..12}×{0..6} strided({0..12}×{0..6})[0, 1] = m3 32×32(12×12) {0..12}×{0..12} strided({0..12}×{0..12})[0, -1]×t0 12×6(12×6) {0..12}×{0..6} pointer_based({0..12}×{0..6})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          float v79_tp{};
          float v80_tp{};
          tensorforge::transpose4x4b32(v77_tp, v78_tp, v79_tp, v80_tp, v73_data, v74_data, 0.0f, 0.0f);
          tensorforge::VectorT<float, 4> v81_acc{};
          tensorforge::VectorT<float, 4> v86_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v77_tp, v55_data, v81_acc, 2, 0, 0);
          tensorforge::VectorT<float, 4> v87_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v78_tp, v56_data, v86_acc, 2, 0, 0);
          tensorforge::VectorT<float, 4> v88_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v79_tp, v57_data, v87_acc, 2, 0, 0);
          tensorforge::VectorT<float, 4> v89_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v80_tp, v58_data, v88_acc, 2, 0, 0);
          tensorforge::VectorT<float, 4> v94_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v77_tp, v63_data, v89_acc, 2, 1, 0);
          tensorforge::VectorT<float, 4> v95_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v78_tp, v64_data, v94_acc, 2, 1, 0);
          ir2[4] = (v95_acc[0]);
          ir2[5] = (v95_acc[1]);
          ...
          float v103_data = r3[4];
          float v104_data = r3[5];
          float v105_data = r3[6];
          float v106_data = r3[7];
          float v107_data = r3[8];
          float v108_data = r3[9];
          float v109_data = r3[10];
          float v110_data = r3[11];
          float v111_acc{};
          float v112_acc{};
          float v113_acc{};
          float v114_acc{};
          ...
          float v116_acc{};
          float v117_lin = r2[0];
          tensorforge::fmacdpp16<0>(v111_acc, v117_lin, v99_data);
          tensorforge::fmacdpp16<1>(v111_acc, v117_lin, v100_data);
          tensorforge::fmacdpp16<2>(v111_acc, v117_lin, v101_data);
          tensorforge::fmacdpp16<3>(v111_acc, v117_lin, v102_data);
          tensorforge::fmacdpp16<4>(v111_acc, v117_lin, v103_data);
          tensorforge::fmacdpp16<5>(v111_acc, v117_lin, v104_data);
          tensorforge::fmacdpp16<6>(v111_acc, v117_lin, v105_data);
          tensorforge::fmacdpp16<7>(v111_acc, v117_lin, v106_data);
          tensorforge::fmacdpp16<8>(v111_acc, v117_lin, v107_data);
          tensorforge::fmacdpp16<9>(v111_acc, v117_lin, v108_data);
          tensorforge::fmacdpp16<10>(v111_acc, v117_lin, v109_data);
          tensorforge::fmacdpp16<11>(v111_acc, v117_lin, v110_data);
          tensorforge::fmacdpp16<12>(v112_acc, v117_lin, v99_data);
          tensorforge::fmacdpp16<13>(v112_acc, v117_lin, v100_data);
          tensorforge::fmacdpp16<14>(v112_acc, v117_lin, v101_data);
          tensorforge::fmacdpp16<15>(v112_acc, v117_lin, v102_data);
          float v118_lin = r2[1];
          tensorforge::fmacdpp16<0>(v112_acc, v118_lin, v103_data);
          tensorforge::fmacdpp16<1>(v112_acc, v118_lin, v104_data);
          tensorforge::fmacdpp16<2>(v112_acc, v118_lin, v105_data);
          tensorforge::fmacdpp16<3>(v112_acc, v118_lin, v106_data);
          tensorforge::fmacdpp16<4>(v112_acc, v118_lin, v107_data);
          tensorforge::fmacdpp16<5>(v112_acc, v118_lin, v108_data);
          tensorforge::fmacdpp16<6>(v112_acc, v118_lin, v109_data);
          tensorforge::fmacdpp16<7>(v112_acc, v118_lin, v110_data);
          tensorforge::fmacdpp16<8>(v113_acc, v118_lin, v99_data);
          tensorforge::fmacdpp16<9>(v113_acc, v118_lin, v100_data);
          tensorforge::fmacdpp16<10>(v113_acc, v118_lin, v101_data);
          tensorforge::fmacdpp16<11>(v113_acc, v118_lin, v102_data);
          tensorforge::fmacdpp16<12>(v113_acc, v118_lin, v103_data);
          tensorforge::fmacdpp16<13>(v113_acc, v118_lin, v104_data);
          tensorforge::fmacdpp16<14>(v113_acc, v118_lin, v105_data);
          tensorforge::fmacdpp16<15>(v113_acc, v118_lin, v106_data);
          float v119_lin = r2[2];
          tensorforge::fmacdpp16<0>(v113_acc, v119_lin, v107_data);
          tensorforge::fmacdpp16<1>(v113_acc, v119_lin, v108_data);
          tensorforge::fmacdpp16<2>(v113_acc, v119_lin, v109_data);
          tensorforge::fmacdpp16<3>(v113_acc, v119_lin, v110_data);
          tensorforge::fmacdpp16<4>(v114_acc, v119_lin, v99_data);
          tensorforge::fmacdpp16<5>(v114_acc, v119_lin, v100_data);
          tensorforge::fmacdpp16<6>(v114_acc, v119_lin, v101_data);
          tensorforge::fmacdpp16<7>(v114_acc, v119_lin, v102_data);
          tensorforge::fmacdpp16<8>(v114_acc, v119_lin, v103_data);
          tensorforge::fmacdpp16<9>(v114_acc, v119_lin, v104_data);
          tensorforge::fmacdpp16<10>(v114_acc, v119_lin, v105_data);
          tensorforge::fmacdpp16<11>(v114_acc, v119_lin, v106_data);
          tensorforge::fmacdpp16<12>(v114_acc, v119_lin, v107_data);
          tensorforge::fmacdpp16<13>(v114_acc, v119_lin, v108_data);
          tensorforge::fmacdpp16<14>(v114_acc, v119_lin, v109_data);
          tensorforge::fmacdpp16<15>(v114_acc, v119_lin, v110_data);
          float v120_lin = r2[3];
          tensorforge::fmacdpp16<0>(v115_acc, v120_lin, v99_data);
          tensorforge::fmacdpp16<1>(v115_acc, v120_lin, v100_data);
          tensorforge::fmacdpp16<2>(v115_acc, v120_lin, v101_data);
          tensorforge::fmacdpp16<3>(v115_acc, v120_lin, v102_data);
          tensorforge::fmacdpp16<4>(v115_acc, v120_lin, v103_data);
          tensorforge::fmacdpp16<5>(v115_acc, v120_lin, v104_data);
          tensorforge::fmacdpp16<6>(v115_acc, v120_lin, v105_data);
          tensorforge::fmacdpp16<7>(v115_acc, v120_lin, v106_data);
          tensorforge::fmacdpp16<8>(v115_acc, v120_lin, v107_data);
          tensorforge::fmacdpp16<9>(v115_acc, v120_lin, v108_data);
          tensorforge::fmacdpp16<10>(v115_acc, v120_lin, v109_data);
          tensorforge::fmacdpp16<11>(v115_acc, v120_lin, v110_data);
          tensorforge::fmacdpp16<12>(v116_acc, v120_lin, v99_data);
          tensorforge::fmacdpp16<13>(v116_acc, v120_lin, v100_data);
          tensorforge::fmacdpp16<14>(v116_acc, v120_lin, v101_data);
          tensorforge::fmacdpp16<15>(v116_acc, v120_lin, v102_data);
          float v121_lin = r2[4];
          tensorforge::fmacdpp16<0>(v116_acc, v121_lin, v103_data);
          tensorforge::fmacdpp16<1>(v116_acc, v121_lin, v104_data);
          tensorforge::fmacdpp16<2>(v116_acc, v121_lin, v105_data);
          tensorforge::fmacdpp16<3>(v116_acc, v121_lin, v106_data);
          tensorforge::fmacdpp16<4>(v116_acc, v121_lin, v107_data);
          tensorforge::fmacdpp16<5>(v116_acc, v121_lin, v108_data);
          tensorforge::fmacdpp16<6>(v116_acc, v121_lin, v109_data);
          tensorforge::fmacdpp16<7>(v116_acc, v121_lin, v110_data);
          ir4[0] = v111_acc;
          ir4[1] = v112_acc;
          ir4[2] = v113_acc;
          ir4[3] = v114_acc;
          ...
          if (v3_lead < 12) {
            ...
            for (int32_t v126_i1 = 0; v126_i1 < 6; ++v126_i1) {
              ...
              float v129_data = r4[v126_i1];
              int32_t v136_a = v3_lead + (v126_i1 * 12);
              glb_m2[v136_a] = v129_data;
            }
          }
          ;
        }
