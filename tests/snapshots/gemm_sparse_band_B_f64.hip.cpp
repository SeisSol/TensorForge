    ...
    // m0 16×16(16×16) {0..16}×{0..16} strided({0..16}×{0..16})[0, 1] = m1 16×16(16×16) {0..16}×{0..16} strided({0..16}×{0..16})[0, -1]×m2 16×16(16×16) {0..16}×{0..16} strided({0..16}×{0..16})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          double v32_data = r0[1];
          double v33_data = r0[2];
          double v34_data = r0[3];
          double v35_data = r0[4];
          double v36_data = r0[5];
          double v37_data = r0[6];
          double v38_data = r0[7];
          double v39_data = r0[8];
          double v40_data = r0[9];
          double v41_data = r0[10];
          double v42_data = r0[11];
          double v43_data = r0[12];
          double v44_data = r0[13];
          double v45_data = r0[14];
          double v46_data = r0[15];
          double v47_acc{};
          double v48_acc{};
          double v49_acc{};
          double v50_acc{};
          ...
          for (int32_t v69_i0 = 0; v69_i0 < 1; ++v69_i0) {
            ...
            for (int32_t v70_i1 = 0; v70_i1 < 16; ++v70_i1) {
              ...
              double v73_data = r2[(v69_i0 + v70_i1)];
