...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_74eb45727af881fb = {{16, 16, 1}, 16, 16, 1, 16, 1024, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_74eb45727af881fb(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_74eb45727af881fb(const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_74eb45727af881fb(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
...
void launcher_kernel_74eb45727af881fb(const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_74eb45727af881fb(numElements0, streamPtr);
  ...
  kernel_kernel_74eb45727af881fb(stream, grid, block, m0, m0_extraOffset, m1, m1_extraOffset, numElements0, flags0);
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_74eb45727af881fb(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0) {
      ...
      cgh.parallel_for(sycl::nd_range<3>{{group_count.get(2) * group_size.get(2), group_count.get(1) * group_size.get(1), group_count.get(0) * group_size.get(0)}, {group_size.get(2), group_size.get(1), group_size.get(0)}}, [=](sycl::nd_item<3> item)  {
        ...
        // tensorforge-meta: {"fp":"float","launch":{"active_threads":16,"block":[16,16,1],"cooperative":false,"lead_width":1,"mults_per_block":16,"persistent":true,"sections":[{"barrier":false,"mults_per_block":16,"shared_elements":256}],"shared_bytes":1024,"shared_elements":256,"threads_per_mult":16},"loops":[],"operands":[{"addressing":"strided","alias":"A","bbox":[[0,0],[40,3]],"name":"m0","ordered":false,"parts":1,"shape":[40,3],"variant":false},{"addressing":"strided","alias":"OUT","bbox":[[0],[3]],"name":"m1","ordered":false,"parts":1,"shape":[3],"variant":false}],"operations":[{"add":false,"dest":{"addressing":"strided","bbox":[[0],[3]],"is_tmp":false,"name":"m1","offset":[0],"shape":[3]},"kind":"reduction","op":"+","ops":[{"addressing":"strided","bbox":[[0,0],[40,3]],"is_tmp":false,"name":"m0","offset":[0,0],"shape":[40,3]}],"permute":[[0,1]],"target":[[-1,0]]}],"version":"0.0.1\n"}
        {
          ...
          for (size_t v3_batchId0 = (item.get_local_id(1) + item.get_group().get_local_range(1) * (item.get_group().get_group_id(2))); v3_batchId0 < numElements0; v3_batchId0 += (item.get_group_range(2) * item.get_group().get_local_range(1))) {
            ...
            if (allowed) {
              const float *const __restrict__ glb_m0 = &m0[v3_batchId0 * 120 + 0 + m0_extraOffset];
              float *const __restrict__ glb_m1 = &m1[v3_batchId0 * 3 + 0 + m1_extraOffset];
              // glb_m1 = +(glb_m0, dims=[0])
              int32_t v16_lead = item.get_local_id(2) % 16;
              int32_t v23_lead = v16_lead + 16_i32;
              bool v27_own = v16_lead < 8;
              bool v43_w = v16_lead == 0;
              #pragma unroll
              for (int32_t v13_k1 = 0; v13_k1 < 3; ++v13_k1) {
                int32_t v19_a = v13_k1 * 40;
                float v21_data = glb_m0[(v16_lead + v19_a)];
                float v25_data = glb_m0[(v23_lead + v19_a)];
                float v26_r = v21_data + v25_data;
                float v33_sel0;
                if (v27_own) {
                  float v31_data = glb_m0[((v16_lead + 32_i32) + v19_a)];
                  v33_sel0 = v31_data;
                }
                else {
                  v33_sel0 = 0.0f;
                }
                float v34_r = v26_r + v33_sel0;
