            ...
            if (allowed) {
              ...
              *(sycl::vec<float, 2>*)&s0[0 + 0 + 2 * item.get_local_id(0) + 0] = *(sycl::vec<float, 2>*)&glb_m1[0 + 0 + 2 * item.get_local_id(0) + 0];
              ...
              if (v8_lead < 12) {
                ...
                float v254_data = ir0[1];
                ir0[1] = (v254_data + (v251_data * v252_data));
                ...
                ir0[3] = (v288_data + (v285_data * v286_data));
                int32_t v295_a = v8_lead + 24;
                float v302_data = glb_m0[(v8_lead + 24)];
                float v303_data = s0[26];
                float v305_data = ir0[4];
                ir0[4] = (v305_data + (v302_data * v303_data));
              ...
              if (v8_lead < 12) {
                ...
                float v483_data = ir0[2];
                ir0[2] = (v483_data + (v480_data * v481_data));
                int32_t v490_a = v8_lead + 48;
                float v497_data = glb_m0[(v8_lead + 48)];
                float v498_data = s0[22];
                float v500_data = ir0[3];
                ir0[3] = (v500_data + (v497_data * v498_data));
              ...
              if (v8_lead < 12) {
                ...
                float v572_data = ir0[1];
                ir0[1] = (v572_data + (v569_data * v570_data));
                ...
                float v606_data = ir0[3];
                ir0[3] = (v606_data + (v603_data * v604_data));
