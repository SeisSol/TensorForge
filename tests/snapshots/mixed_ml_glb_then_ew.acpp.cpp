...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_3b918c2352ab5609 = {{8, 2, 1}, 8, 8, 1, 2, 64, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_3b918c2352ab5609(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_3b918c2352ab5609(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, float * m3, size_t m3_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_3b918c2352ab5609(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
...
void launcher_kernel_3b918c2352ab5609(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, float * m3, size_t m3_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_3b918c2352ab5609(numElements0, streamPtr);
  ...
  kernel_kernel_3b918c2352ab5609(stream, grid, block, m0, m0_extraOffset, m1, m1_extraOffset, m2, m2_extraOffset, m3, m3_extraOffset, numElements0, flags0);
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_3b918c2352ab5609(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, float * m3, size_t m3_extraOffset, size_t numElements0, unsigned * flags0) {
      ...
      cgh.parallel_for(sycl::nd_range<3>{{group_count.get(2) * group_size.get(2), group_count.get(1) * group_size.get(1), group_count.get(0) * group_size.get(0)}, {group_size.get(2), group_size.get(1), group_size.get(0)}}, [=](sycl::nd_item<3> item)  {
        ...
        // tensorforge-meta: {"fp":"float","launch":{"active_threads":8,"block":[8,2,1],"cooperative":false,"lead_width":1,"mults_per_block":2,"persistent":true,"sections":[{"barrier":false,"mults_per_block":2,"shared_elements":16}],"shared_bytes":64,"shared_elements":16,"threads_per_mult":8},"loops":[],"operands":[{"addressing":"strided","alias":"M","bbox":[[0,0],[8,8]],"name":"m0","ordered":false,"parts":1,"shape":[8,8],"variant":false},{"addressing":"strided","alias":"A","bbox":[[0,0],[8,8]],"name":"m1","ordered":false,"parts":1,"shape":[8,8],"variant":false},{"addressing":"strided","alias":"B","bbox":[[0,0],[8,8]],"name":"m2","ordered":false,"parts":1,"shape":[8,8],"variant":false},{"addressing":"strided","alias":"C","bbox":[[0,0],[8,8]],"name":"m3","ordered":false,"parts":1,"shape":[8,8],"variant":false}],"operations":[{"add":false,"dest":{"addressing":"strided","bbox":[[0,0],[8,8]],"is_tmp":false,"name":"m0","offset":[0,0],"shape":[8,8]},"kind":"multilinear","ops":[{"addressing":"strided","bbox":[[0,0],[8,8]],"is_tmp":false,"name":"m1","offset":[0,0],"shape":[8,8]},{"addressing":"strided","bbox":[[0,0],[8,8]],"is_tmp":false,"name":"m2","offset":[0,0],"shape":[8,8]}],"permute":[[0,1],[0,1]],"target":[[0,-1],[-1,1]]},{"add":false,"dest":{"addressing":"strided","bbox":[[0,0],[8,8]],"is_tmp":false,"name":"m3","offset":[0,0],"shape":[8,8]},"kind":"elementwise","op":"ABS","ops":[{"addressing":"strided","bbox":[[0,0],[8,8]],"is_tmp":false,"name":"m0","offset":[0,0],"shape":[8,8]}],"permute":[[0,1]],"scalars":[],"target":[[0,1]]}],"version":"0.0.1\n"}
        {
          ...
          for (size_t v4_batchIdGroup0 = (item.get_local_id(1) - item.get_local_id(1) % 2) + item.get_group().get_local_range(1) * (item.get_group().get_group_id(2)); v4_batchIdGroup0 < numElements0; v4_batchIdGroup0 += (item.get_group_range(2) * item.get_group().get_local_range(1))) {
            ...
            float *const __restrict__ glb_m0 = &m0[v7_batchId0 * 64 + 0 + m0_extraOffset];
            ...
            for (int32_t v23_i0 = 0; v23_i0 < 1; ++v23_i0) {
              ...
              for (int32_t v24_i1 = 0; v24_i1 < 8; ++v24_i1) {
                float v29_data = glb_m1[(v26_lead + (v24_i1 * 8))];
            ...
            for (int32_t v32_i0 = 0; v32_i0 < 1; ++v32_i0) {
              ...
              for (int32_t v33_i1 = 0; v33_i1 < 8; ++v33_i1) {
                float v38_data = glb_m2[(v35_lead + (v33_i1 * 8))];
            ...
            for (int32_t v430_i0 = 0; v430_i0 < 1; ++v430_i0) {
              ...
              for (int32_t v431_i1 = 0; v431_i1 < 8; ++v431_i1) {
                ...
                if (batchIdActive0) {
                  glb_m0[((v22_lead + (v430_i0 * 8)) + (v431_i1 * 8))] = v433_data;
                }
              }
            }
            // glb_m3 = abs(glb_m0)
            #pragma unroll
            for (int32_t v438_k0 = 0; v438_k0 < 1; ++v438_k0) {
              int32_t v441_lead = v22_lead + (v438_k0 * 8);
              #pragma unroll
              for (int32_t v439_k1 = 0; v439_k1 < 8; ++v439_k1) {
                int32_t v443_a = v441_lead + (v439_k1 * 8);
                float v444_data = glb_m0[v443_a];
                float v445_e = sycl::fabs(v444_data);
                if (batchIdActive0) {
                  glb_m3[v443_a] = v445_e;
                }
              }
            }
            item.barrier();
