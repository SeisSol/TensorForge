            ...
            if (allowed) {
              ...
              if (v10_g) {
                ...
                for (int32_t v26_i1 = 0; v26_i1 < 8; ++v26_i1) {
                  float v34_data = glb_m2[(v9_lead + (v26_i1 * 8))];
                  r1[v26_i1] = v34_data;
                }
              }
              ...
              if (v10_g) {
                ...
                for (int32_t v466_i1 = 0; v466_i1 < 8; ++v466_i1) {
                  ...
                  glb_m0[(v9_lead + (v466_i1 * 8))] = v468_data;
                }
              }
              // glb_m3 = abs(glb_m0)
              if (v10_g) {
                #pragma unroll
                for (int32_t v480_k1 = 0; v480_k1 < 8; ++v480_k1) {
                  int32_t v487_a = v9_lead + (v480_k1 * 8);
                  float v488_data = glb_m0[v487_a];
                  glb_m3[v487_a] = (sycl::fabs(v488_data));
                }
              }
            }
          }
