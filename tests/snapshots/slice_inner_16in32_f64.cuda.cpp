        ...
        if (allowed) {
          ...
          for (int32_t v14_i0 = 0; v14_i0 < 1; ++v14_i0) {
            ...
            for (int32_t v15_i1 = 8; v15_i1 < 24; ++v15_i1) {
              double v24_data = __ldcg(&glb_m1[(v21_off + (v15_i1 * 32))]);
          ...
          for (int32_t v722_n0 = 0; v722_n0 < 1; ++v722_n0) {
            ...
            for (int32_t v723_n1 = 0; v723_n1 < 8; ++v723_n1) {
              ...
              double v725_data = ir1[v724_a];
              r1[v724_a] = v725_data;
            }
          }
          // glb_m0 = store{r>g}(r1);
          #pragma unroll
          for (int32_t v730_i0 = 0; v730_i0 < 1; ++v730_i0) {
            int32_t v738_lead = v13_lead + (v730_i0 * 16);
            #pragma unroll
            for (int32_t v731_i1 = 0; v731_i1 < 8; ++v731_i1) {
              double v733_data = r1[(v730_i0 + v731_i1)];
              glb_m0[(v738_lead + (v731_i1 * 16))] = v733_data;
            }
          }
          __syncwarp();
        }
