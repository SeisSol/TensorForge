// === base name ===
kernel_102571cb541deae6

// === header ===
void launcher_kernel_102571cb541deae6(const float* m0, size_t m0_extraOffset, float* m1, size_t m1_extraOffset, size_t numElements0, unsigned* flags0 = nullptr, void* streamPtr = nullptr);


// === launcher ===
void launcher_kernel_102571cb541deae6(const float* m0, size_t m0_extraOffset, float* m1, size_t m1_extraOffset, size_t numElements0, unsigned* flags0 , void* streamPtr) {
  ...
  kernel_kernel_102571cb541deae6(stream, grid, block,  m0,  m0_extraOffset,  m1,  m1_extraOffset,  numElements0,  flags0 );
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_102571cb541deae6(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, const float* m0, size_t m0_extraOffset, float* m1, size_t m1_extraOffset, size_t numElements0, unsigned* flags0 ) {
            ...
            if (allowed) {
              ...
              for (int32_t v12_k0 = 0; v12_k0 < 1; ++v12_k0) {
                ...
                for (int32_t v13_k1 = 0; v13_k1 < 16; ++v13_k1) {
                  ...
                  (tensorforge::intel_esimd::log(v18_data)).copy_to(glb_m1 + (v17_a));
                }
              }
            }
          }
