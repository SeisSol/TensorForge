          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              *(sycl::vec<float, 4>*)&s0[0 + 0 + 4 * item.get_local_id(0) + 64] = *(sycl::vec<float, 4>*)&glb_m2[0 + 0 + 4 * item.get_local_id(0) + 64];
              ...
              if (v8_lead < 12) {
                #pragma unroll
                for (int32_t v2772_i1 = 0; v2772_i1 < 8; ++v2772_i1) {
                  int32_t v2773_a = 0 + v2772_i1;
                  float v2775_data = r0[v2772_i1];
                  int32_t v2782_a = v8_lead + (v2772_i1 * 12);
                  glb_m0[v2782_a] = v2775_data;
                }
              }
            }
          }
