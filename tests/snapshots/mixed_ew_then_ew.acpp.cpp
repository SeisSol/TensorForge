...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_60cd609aa8e4493c = {{16, 16, 1}, 16, 16, 1, 16, 5120, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_60cd609aa8e4493c(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_60cd609aa8e4493c(const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_60cd609aa8e4493c(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
...
void launcher_kernel_60cd609aa8e4493c(const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_60cd609aa8e4493c(numElements0, streamPtr);
  ...
  kernel_kernel_60cd609aa8e4493c(stream, grid, block, m0, m0_extraOffset, m1, m1_extraOffset, numElements0, flags0);
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_60cd609aa8e4493c(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, const float * m0, size_t m0_extraOffset, float * m1, size_t m1_extraOffset, size_t numElements0, unsigned * flags0) {
            ...
            if (allowed) {
              ...
              if (v17_lead < 8) {
                ...
                for (int32_t v19_k1 = 0; v19_k1 < 8; ++v19_k1) {
                  float v24_data = glb_m0[(v17_lead + (v19_k1 * 8))];
                  r0[v19_k1] = (sycl::fabs(v24_data));
                }
              }
              // s0 = store{r>s}(localShrMem0, r0);
              bool v30_g = v17_lead < 8;
              if (v30_g) {
                #pragma unroll
                for (int32_t v31_i1 = 0; v31_i1 < 8; ++v31_i1) {
                  float v33_data = r0[v31_i1];
                  int32_t v37_a = v17_lead + (v31_i1 * 8);
                  s0[(v37_a ^ ((v37_a >> 5) & 31))] = v33_data;
                }
              }
              ...
              if (v30_g) {
                #pragma unroll
                for (int32_t v41_k1 = 0; v41_k1 < 8; ++v41_k1) {
                  int32_t v45_a = v17_lead + (v41_k1 * 8);
                  float v49_data = s0[(v45_a ^ ((v45_a >> 5) & 31))];
                  glb_m1[v45_a] = ((-v49_data));
                }
              }
              sycl::group_barrier(item.get_sub_group());
            }
