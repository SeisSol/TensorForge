    ...
    // m0 16×16(16×16) {0..16}×{0..16} strided({0..16}×{0..16})[0, 1] = m1 16×16(16×16) {0..16}×{0..16} strided({0..16}×{0..16})[0, -1]×m2 16×16(16×16) {0..16}×{0..16} strided({0..16}×{0..16})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          float v179_data = r0[5];
          float v184_data = s0[13];
          ...
          float v194_data = s0[17];
          float v196_data = ir1[6];
          ir1[6] = (v196_data + (v179_data * v194_data));
          float v210_data = r0[6];
          float v216_data = s0[16];
          ...
          for (int32_t v526_i0 = 0; v526_i0 < 1; ++v526_i0) {
            ...
            for (int32_t v527_i1 = 0; v527_i1 < 16; ++v527_i1) {
              ...
              float v530_data = r1[(v526_i0 + v527_i1)];
