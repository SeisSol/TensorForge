          ...
          if (batchId0 < numElements0) {
            ...
            if (allowed) {
              ...
              *(sycl::vec<float, 2>*)&s0[0 + 0 + 2 * item.get_local_id(0) + 0] = *(sycl::vec<float, 2>*)&glb_m2[0 + 0 + 2 * item.get_local_id(0) + 0];
              ...
              float v713_data = s0[7];
              float v715_data = ir0[2];
              ir0[2] = (v715_data + (v712_data * v713_data));
              int32_t v722_a = v8_lead + 48;
              float v729_data = glb_m1[(v8_lead + 48)];
              float v730_data = s0[9];
              float v732_data = ir0[3];
              ir0[3] = (v732_data + (v729_data * v730_data));
              int32_t v739_a = v8_lead + 48;
              float v746_data = glb_m1[(v8_lead + 48)];
              float v747_data = s0[11];
              float v749_data = ir0[4];
              ...
              float v1420_data = glb_m1[(v8_lead + 96)];
              float v1421_data = s0[16];
              float v1423_data = ir0[5];
              ir0[5] = (v1423_data + (v1420_data * v1421_data));
              int32_t v1430_a = v8_lead + 96;
              float v1437_data = glb_m1[(v8_lead + 96)];
              float v1438_data = s0[18];
              float v1440_data = ir0[6];
              ir0[6] = (v1440_data + (v1437_data * v1438_data));
              int32_t v1447_a = v8_lead + 96;
              float v1454_data = glb_m1[(v8_lead + 96)];
              float v1455_data = s0[20];
              float v1457_data = ir0[7];
              ...
              float v1656_data = glb_m1[(v8_lead + 112)];
              float v1657_data = s0[19];
              float v1659_data = ir0[6];
              ir0[6] = (v1659_data + (v1656_data * v1657_data));
              int32_t v1666_a = v8_lead + 112;
              float v1673_data = glb_m1[(v8_lead + 112)];
              float v1674_data = s0[21];
              float v1676_data = ir0[7];
              ir0[7] = (v1676_data + (v1673_data * v1674_data));
              int32_t v1683_a = v8_lead + 112;
              float v1690_data = glb_m1[(v8_lead + 112)];
              float v1691_data = s0[23];
              float v1693_data = ir0[8];
              ...
              float v1892_data = glb_m1[(v8_lead + 128)];
              float v1893_data = s0[22];
              float v1895_data = ir0[7];
              ir0[7] = (v1895_data + (v1892_data * v1893_data));
              int32_t v1902_a = v8_lead + 128;
              float v1909_data = glb_m1[(v8_lead + 128)];
              float v1910_data = s0[24];
              float v1912_data = ir0[8];
              ir0[8] = (v1912_data + (v1909_data * v1910_data));
              int32_t v1919_a = v8_lead + 128;
              float v1926_data = glb_m1[(v8_lead + 128)];
              float v1927_data = s0[26];
              float v1929_data = ir0[9];
              ...
              float v2128_data = glb_m1[(v8_lead + 144)];
              float v2129_data = s0[25];
              float v2131_data = ir0[8];
              ir0[8] = (v2131_data + (v2128_data * v2129_data));
              int32_t v2138_a = v8_lead + 144;
              float v2145_data = glb_m1[(v8_lead + 144)];
              float v2146_data = s0[27];
              float v2148_data = ir0[9];
              ir0[9] = (v2148_data + (v2145_data * v2146_data));
              int32_t v2155_a = v8_lead + 144;
              float v2162_data = glb_m1[(v8_lead + 144)];
              float v2163_data = s0[29];
              float v2165_data = ir0[10];
              ...
              float v2364_data = glb_m1[(v8_lead + 160)];
              float v2365_data = s0[28];
              float v2367_data = ir0[9];
              ir0[9] = (v2367_data + (v2364_data * v2365_data));
              int32_t v2374_a = v8_lead + 160;
              float v2381_data = glb_m1[(v8_lead + 160)];
              float v2382_data = s0[30];
              float v2384_data = ir0[10];
              ir0[10] = (v2384_data + (v2381_data * v2382_data));
              int32_t v2391_a = v8_lead + 160;
              float v2398_data = glb_m1[(v8_lead + 160)];
              float v2399_data = s0[32];
              float v2401_data = ir0[11];
              ...
              float v2600_data = glb_m1[(v8_lead + 176)];
              float v2601_data = s0[31];
              float v2603_data = ir0[10];
              ir0[10] = (v2603_data + (v2600_data * v2601_data));
              int32_t v2610_a = v8_lead + 176;
              float v2617_data = glb_m1[(v8_lead + 176)];
              float v2618_data = s0[33];
              float v2620_data = ir0[11];
              ir0[11] = (v2620_data + (v2617_data * v2618_data));
              int32_t v2627_a = v8_lead + 176;
              float v2634_data = glb_m1[(v8_lead + 176)];
              float v2635_data = s0[35];
              float v2637_data = ir0[12];
              ...
              float v2836_data = glb_m1[(v8_lead + 192)];
              float v2837_data = s0[34];
              float v2839_data = ir0[11];
              ir0[11] = (v2839_data + (v2836_data * v2837_data));
              int32_t v2846_a = v8_lead + 192;
              float v2853_data = glb_m1[(v8_lead + 192)];
              float v2854_data = s0[36];
              float v2856_data = ir0[12];
              ir0[12] = (v2856_data + (v2853_data * v2854_data));
              int32_t v2863_a = v8_lead + 192;
              float v2870_data = glb_m1[(v8_lead + 192)];
              float v2871_data = s0[38];
              float v2873_data = ir0[13];
              ...
              float v3072_data = glb_m1[(v8_lead + 208)];
              float v3073_data = s0[37];
              float v3075_data = ir0[12];
              ir0[12] = (v3075_data + (v3072_data * v3073_data));
              int32_t v3082_a = v8_lead + 208;
              float v3089_data = glb_m1[(v8_lead + 208)];
              float v3090_data = s0[39];
              float v3092_data = ir0[13];
              ir0[13] = (v3092_data + (v3089_data * v3090_data));
              int32_t v3099_a = v8_lead + 208;
              float v3106_data = glb_m1[(v8_lead + 208)];
              float v3107_data = s0[41];
              float v3109_data = ir0[14];
              ...
              float v3308_data = glb_m1[(v8_lead + 224)];
              float v3309_data = s0[40];
              float v3311_data = ir0[13];
              ir0[13] = (v3311_data + (v3308_data * v3309_data));
              int32_t v3318_a = v8_lead + 224;
              float v3325_data = glb_m1[(v8_lead + 224)];
              float v3326_data = s0[42];
              float v3328_data = ir0[14];
              ir0[14] = (v3328_data + (v3325_data * v3326_data));
              int32_t v3335_a = v8_lead + 224;
              float v3342_data = glb_m1[(v8_lead + 224)];
              float v3343_data = s0[44];
              float v3345_data = ir0[15];
              ...
              float v3544_data = glb_m1[(v8_lead + 240)];
              float v3545_data = s0[43];
              float v3547_data = ir0[14];
              ir0[14] = (v3547_data + (v3544_data * v3545_data));
              int32_t v3554_a = v8_lead + 240;
              float v3561_data = glb_m1[(v8_lead + 240)];
              float v3562_data = s0[45];
              float v3564_data = ir0[15];
              ...
              for (int32_t v3578_i0 = 0; v3578_i0 < 1; ++v3578_i0) {
                ...
                for (int32_t v3579_i1 = 0; v3579_i1 < 16; ++v3579_i1) {
                  ...
                  float v3582_data = r0[(v3578_i0 + v3579_i1)];
