...
#endif
inline constexpr tensorforge::LaunchInfo launch_info_kernel_26c48acc37df4422 = {{32, 1, 1}, 32, 20, 1, 1, 0, false, true, 1};
tensorforge::LaunchConfig launch_config_kernel_26c48acc37df4422(size_t numElements0, void* streamPtr = nullptr);
void launcher_kernel_26c48acc37df4422(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, const float * m3, size_t m3_extraOffset, const float * m4, size_t m4_extraOffset, size_t numElements0, unsigned * flags0 = nullptr, void* streamPtr = nullptr);
...
#endif
tensorforge::LaunchConfig launch_config_kernel_26c48acc37df4422(size_t numElements0, void* streamPtr) {
  (void)numElements0;
  (void)streamPtr;
...
void launcher_kernel_26c48acc37df4422(float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, const float * m3, size_t m3_extraOffset, const float * m4, size_t m4_extraOffset, size_t numElements0, unsigned * flags0, void* streamPtr) {
  const tensorforge::LaunchConfig config = launch_config_kernel_26c48acc37df4422(numElements0, streamPtr);
  ...
  kernel_kernel_26c48acc37df4422(stream, grid, block, m0, m0_extraOffset, m1, m1_extraOffset, m2, m2_extraOffset, m3, m3_extraOffset, m4, m4_extraOffset, numElements0, flags0);
  CHECK_ERR;
}


// === kernel ===
inline void kernel_kernel_26c48acc37df4422(sycl::queue *stream, sycl::range<3> group_count, sycl::range<3> group_size, float * m0, size_t m0_extraOffset, const float * m1, size_t m1_extraOffset, const float * m2, size_t m2_extraOffset, const float * m3, size_t m3_extraOffset, const float * m4, size_t m4_extraOffset, size_t numElements0, unsigned * flags0) {
            ...
            if (allowed) {
              ...
              if (v18_g) {
                ...
                for (int32_t v19_i1 = 0; v19_i1 < 9; ++v19_i1) {
                  float v24_data = glb_m1[(v17_lead + (v19_i1 * 20))];
                  r0[v19_i1] = v24_data;
                }
              }
              float r2[9]{};
              ...
              if (v17_lead < 10) {
                ...
                for (int32_t v28_i1 = 0; v28_i1 < 9; ++v28_i1) {
                  float v33_data = glb_m2[(v17_lead + (v28_i1 * 10))];
                  r2[v28_i1] = v33_data;
                }
              }
              ...
              if (v17_lead < 4) {
                ...
                for (int32_t v69_i1 = 0; v69_i1 < 9; ++v69_i1) {
                  float v74_data = glb_m3[(v17_lead + (v69_i1 * 4))];
                  r4[v69_i1] = v74_data;
                }
              }
              ...
              if (v17_lead < 1) {
                ...
                for (int32_t v112_i1 = 0; v112_i1 < 9; ++v112_i1) {
                  float v116_data = glb_m4[(v17_lead + v112_i1)];
