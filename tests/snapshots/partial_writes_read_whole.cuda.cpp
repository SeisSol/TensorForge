        ...
        if (allowed) {
          ...
          if (v2_lead < 16) {
            ...
            for (int32_t v25_i1 = 0; v25_i1 < 9; ++v25_i1) {
              ...
              float v40_data = __ldcg(&glb_m1[(v2_lead + v31_a)]);
          ...
          if (v2_lead < 16) {
            ...
            for (int32_t v91_i1 = 0; v91_i1 < 9; ++v91_i1) {
              ...
              float v106_data = __ldcg(&glb_m2[(v2_lead + v97_a)]);
          ...
          __syncwarp();
          {
            ...
            if (v2_lead < 16) {
              ...
              for (int32_t v143_n1 = 0; v143_n1 < 9; ++v143_n1) {
                ...
                int32_t v153_a = v2_lead + v152_a;
                float v161_data = s0[(v2_lead + v152_a)];
          ...
          if (v2_lead < 16) {
            ...
            for (int32_t v169_i1 = 0; v169_i1 < 9; ++v169_i1) {
              ...
              int32_t v179_a = v2_lead + (v169_i1 * 32);
              s0[v179_a] = v172_data;
            }
          }
          ...
          __syncwarp();
          {
            ...
            if (v2_lead < 16) {
              ...
              for (int32_t v215_n1 = 0; v215_n1 < 9; ++v215_n1) {
                ...
                int32_t v225_a = v2_lead + v224_a;
                float v233_data = s0[(v2_lead + v224_a)];
          ...
          if (v2_lead < 16) {
            ...
            for (int32_t v241_i1 = 0; v241_i1 < 9; ++v241_i1) {
              ...
              int32_t v251_a = v2_lead + (v241_i1 * 32);
              s0[v251_a] = v244_data;
            }
          }
          ...
          for (int32_t v1669_i0 = 0; v1669_i0 < 1; ++v1669_i0) {
            int32_t v1678_lead = v2_lead + (v1669_i0 * 32);
            #pragma unroll
