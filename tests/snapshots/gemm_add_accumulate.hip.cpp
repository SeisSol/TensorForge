    ...
    // m0 12×8(12×8) {0..12}×{0..8} strided({0..12}×{0..8})[0, 1] += m1 12×16(12×16) {0..12}×{0..16} strided({0..12}×{0..16})[0, -1]×m2 16×8(16×8) {0..16}×{0..8} strided({0..16}×{0..8})[-1, 1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          float v47_data = r0[2];
          float v48_data = r0[3];
          tensorforge::VectorT<float, 4> v49_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v40_tp, v45_data, v44_acc, 2, 0, 0);
          ...
          float v55_data = r0[6];
          float v56_data = r0[7];
          tensorforge::VectorT<float, 4> v57_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v40_tp, v53_data, v52_acc, 2, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v65_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v40_tp, v61_data, v60_acc, 2, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v73_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v40_tp, v69_data, v68_acc, 2, 3, 0);
          ...
          tensorforge::VectorT<float, 4> v94_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v85_tp, v45_data, v89_acc, 2, 0, 0);
          ...
          tensorforge::VectorT<float, 4> v102_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v85_tp, v53_data, v97_acc, 2, 1, 0);
          ...
          tensorforge::VectorT<float, 4> v110_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v85_tp, v61_data, v105_acc, 2, 2, 0);
          ...
          tensorforge::VectorT<float, 4> v118_acc = __builtin_amdgcn_mfma_f32_4x4x1f32(v85_tp, v69_data, v113_acc, 2, 3, 0);
          ...
          if (v7_lead < 12) {
            ...
            for (int32_t v130_i1 = 0; v130_i1 < 8; ++v130_i1) {
              int32_t v131_a = 0 + v130_i1;
              float v133_data = r2[v130_i1];
              int32_t v140_a = v7_lead + (v130_i1 * 12);
              __builtin_amdgcn_global_atomic_fadd_f32(&glb_m0[v140_a], v133_data);
            }
          }
        }
      }
