        ...
        if (allowed) {
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v12_i1 = 0; v12_i1 < 20; ++v12_i1) {
              float v20_data = __builtin_nontemporal_load(&glb_m1[(v10_lead + (v12_i1 * 12))]);
              r0[v12_i1] = v20_data;
            }
          }
          float r1[20]{};
          ...
          // r2 = +(r0 * r1) + None
          // [(0, 12), (0, 16)] [(0, 20)]
          float v44_data = tensorforge::broadcast<16, 1, 0>(r1[0]);
          float v45_data = tensorforge::broadcast<16, 1, 1>(r1[0]);
          float v46_data = tensorforge::broadcast<16, 1, 2>(r1[0]);
          float v47_data = tensorforge::broadcast<16, 1, 3>(r1[0]);
          float v48_tp{};
          float v49_tp{};
          float v50_tp{};
          float v51_tp{};
          tensorforge::transpose4x4b32(v48_tp, v49_tp, v50_tp, v51_tp, v44_data, v45_data, v46_data, v47_data);
          float v52_data = tensorforge::broadcast<16, 1, 0>(r1[1]);
          float v53_data = tensorforge::broadcast<16, 1, 1>(r1[1]);
          float v54_data = tensorforge::broadcast<16, 1, 2>(r1[1]);
          float v55_data = tensorforge::broadcast<16, 1, 3>(r1[1]);
          float v56_tp{};
          float v57_tp{};
          float v58_tp{};
          float v59_tp{};
          ...
          r2[2] = (v100_acc[2]);
          r2[3] = (v100_acc[3]);
          float v105_data = tensorforge::broadcast<16, 1, 4>(r1[0]);
          float v106_data = tensorforge::broadcast<16, 1, 5>(r1[0]);
          float v107_data = tensorforge::broadcast<16, 1, 6>(r1[0]);
          float v108_data = tensorforge::broadcast<16, 1, 7>(r1[0]);
          float v109_tp{};
          float v110_tp{};
          float v111_tp{};
          float v112_tp{};
          tensorforge::transpose4x4b32(v109_tp, v110_tp, v111_tp, v112_tp, v105_data, v106_data, v107_data, v108_data);
          float v113_data = tensorforge::broadcast<16, 1, 4>(r1[1]);
          float v114_data = tensorforge::broadcast<16, 1, 5>(r1[1]);
          float v115_data = tensorforge::broadcast<16, 1, 6>(r1[1]);
          float v116_data = tensorforge::broadcast<16, 1, 7>(r1[1]);
          float v117_tp{};
          float v118_tp{};
          float v119_tp{};
          float v120_tp{};
          ...
          r2[6] = (v161_acc[2]);
          r2[7] = (v161_acc[3]);
          float v166_data = tensorforge::broadcast<16, 1, 8>(r1[0]);
          float v167_data = tensorforge::broadcast<16, 1, 9>(r1[0]);
          float v168_data = tensorforge::broadcast<16, 1, 10>(r1[0]);
          float v169_data = tensorforge::broadcast<16, 1, 11>(r1[0]);
          float v170_tp{};
          float v171_tp{};
          float v172_tp{};
          float v173_tp{};
          tensorforge::transpose4x4b32(v170_tp, v171_tp, v172_tp, v173_tp, v166_data, v167_data, v168_data, v169_data);
          float v174_data = tensorforge::broadcast<16, 1, 8>(r1[1]);
          float v175_data = tensorforge::broadcast<16, 1, 9>(r1[1]);
          float v176_data = tensorforge::broadcast<16, 1, 10>(r1[1]);
          float v177_data = tensorforge::broadcast<16, 1, 11>(r1[1]);
          float v178_tp{};
          float v179_tp{};
          float v180_tp{};
          float v181_tp{};
          ...
          r2[10] = (v222_acc[2]);
          r2[11] = (v222_acc[3]);
          float v227_data = tensorforge::broadcast<16, 1, 12>(r1[0]);
          float v228_data = tensorforge::broadcast<16, 1, 13>(r1[0]);
          float v229_data = tensorforge::broadcast<16, 1, 14>(r1[0]);
          float v230_data = tensorforge::broadcast<16, 1, 15>(r1[0]);
          float v231_tp{};
          float v232_tp{};
          float v233_tp{};
          float v234_tp{};
          tensorforge::transpose4x4b32(v231_tp, v232_tp, v233_tp, v234_tp, v227_data, v228_data, v229_data, v230_data);
          float v235_data = tensorforge::broadcast<16, 1, 12>(r1[1]);
          float v236_data = tensorforge::broadcast<16, 1, 13>(r1[1]);
          float v237_data = tensorforge::broadcast<16, 1, 14>(r1[1]);
          float v238_data = tensorforge::broadcast<16, 1, 15>(r1[1]);
          float v239_tp{};
          float v240_tp{};
          float v241_tp{};
          float v242_tp{};
          ...
          if (v10_lead < 12) {
            ...
            for (int32_t v292_i1 = 0; v292_i1 < 16; ++v292_i1) {
              float v294_data = r2[v292_i1];
              glb_m0[(v10_lead + (v292_i1 * 12))] = v294_data;
            }
          }
        }
      }
