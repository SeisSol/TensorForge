    ...
    // m0 12×16(12×16) {0..12}×{0..16} strided({0..12}×{0..16})[0, 1] = m1 12×20(12×20) {0..12}×{0..20} strided({0..12}×{0..20})[0, -1]×m2 16×20(16×20) {0..16}×{0..20} strided({0..16}×{0..20})[1, -1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          // r2 = +(r0 * r1) + None
          // [(0, 12), (0, 16)] [(0, 20)]
          float v47_data = tensorforge::broadcast<16, 1, 0>(r1[0]);
          float v48_data = tensorforge::broadcast<16, 1, 1>(r1[0]);
          float v49_data = tensorforge::broadcast<16, 1, 2>(r1[0]);
          float v50_data = tensorforge::broadcast<16, 1, 3>(r1[0]);
          float v51_tp{};
          float v52_tp{};
          float v53_tp{};
          float v54_tp{};
          tensorforge::transpose4x4b32(v51_tp, v52_tp, v53_tp, v54_tp, v47_data, v48_data, v49_data, v50_data);
          float v55_data = tensorforge::broadcast<16, 1, 0>(r1[1]);
          float v56_data = tensorforge::broadcast<16, 1, 1>(r1[1]);
          float v57_data = tensorforge::broadcast<16, 1, 2>(r1[1]);
          float v58_data = tensorforge::broadcast<16, 1, 3>(r1[1]);
          float v59_tp{};
          float v60_tp{};
          float v61_tp{};
          float v62_tp{};
          ...
          r2[2] = (v103_acc[2]);
          r2[3] = (v103_acc[3]);
          float v108_data = tensorforge::broadcast<16, 1, 4>(r1[0]);
          float v109_data = tensorforge::broadcast<16, 1, 5>(r1[0]);
          float v110_data = tensorforge::broadcast<16, 1, 6>(r1[0]);
          float v111_data = tensorforge::broadcast<16, 1, 7>(r1[0]);
          float v112_tp{};
          float v113_tp{};
          float v114_tp{};
          float v115_tp{};
          tensorforge::transpose4x4b32(v112_tp, v113_tp, v114_tp, v115_tp, v108_data, v109_data, v110_data, v111_data);
          float v116_data = tensorforge::broadcast<16, 1, 4>(r1[1]);
          float v117_data = tensorforge::broadcast<16, 1, 5>(r1[1]);
          float v118_data = tensorforge::broadcast<16, 1, 6>(r1[1]);
          float v119_data = tensorforge::broadcast<16, 1, 7>(r1[1]);
          float v120_tp{};
          float v121_tp{};
          float v122_tp{};
          float v123_tp{};
          ...
          r2[6] = (v164_acc[2]);
          r2[7] = (v164_acc[3]);
          float v169_data = tensorforge::broadcast<16, 1, 8>(r1[0]);
          float v170_data = tensorforge::broadcast<16, 1, 9>(r1[0]);
          float v171_data = tensorforge::broadcast<16, 1, 10>(r1[0]);
          float v172_data = tensorforge::broadcast<16, 1, 11>(r1[0]);
          float v173_tp{};
          float v174_tp{};
          float v175_tp{};
          float v176_tp{};
          tensorforge::transpose4x4b32(v173_tp, v174_tp, v175_tp, v176_tp, v169_data, v170_data, v171_data, v172_data);
          float v177_data = tensorforge::broadcast<16, 1, 8>(r1[1]);
          float v178_data = tensorforge::broadcast<16, 1, 9>(r1[1]);
          float v179_data = tensorforge::broadcast<16, 1, 10>(r1[1]);
          float v180_data = tensorforge::broadcast<16, 1, 11>(r1[1]);
          float v181_tp{};
          float v182_tp{};
          float v183_tp{};
          float v184_tp{};
          ...
          r2[10] = (v225_acc[2]);
          r2[11] = (v225_acc[3]);
          float v230_data = tensorforge::broadcast<16, 1, 12>(r1[0]);
          float v231_data = tensorforge::broadcast<16, 1, 13>(r1[0]);
          float v232_data = tensorforge::broadcast<16, 1, 14>(r1[0]);
          float v233_data = tensorforge::broadcast<16, 1, 15>(r1[0]);
          float v234_tp{};
          float v235_tp{};
          float v236_tp{};
          float v237_tp{};
          tensorforge::transpose4x4b32(v234_tp, v235_tp, v236_tp, v237_tp, v230_data, v231_data, v232_data, v233_data);
          float v238_data = tensorforge::broadcast<16, 1, 12>(r1[1]);
          float v239_data = tensorforge::broadcast<16, 1, 13>(r1[1]);
          float v240_data = tensorforge::broadcast<16, 1, 14>(r1[1]);
          float v241_data = tensorforge::broadcast<16, 1, 15>(r1[1]);
          float v242_tp{};
          float v243_tp{};
          float v244_tp{};
          float v245_tp{};
          ...
          if (v6_lead < 12) {
            ...
            for (int32_t v295_i1 = 0; v295_i1 < 16; ++v295_i1) {
              int32_t v296_a = 0 + v295_i1;
              float v298_data = r2[v295_i1];
              glb_m0[(v6_lead + (v295_i1 * 12))] = v298_data;
            }
          }
        }
      }
