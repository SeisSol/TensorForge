    ...
    // m0 12×16(12×16) {0..12}×{0..16} strided({0..12}×{0..16})[0, 1] = m1 12×20(12×20) {0..12}×{0..20} strided({0..12}×{0..20})[0, -1]×m2 16×20(16×20) {0..16}×{0..20} strided({0..16}×{0..20})[1, -1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          // [(0, 12), (0, 16)] [(0, 20)]
          auto& ir2 = r2;
          float v24_data = tensorforge::broadcast<16, 1, 0>(r1[0]);
          float v25_data = tensorforge::broadcast<16, 1, 1>(r1[0]);
          float v26_data = tensorforge::broadcast<16, 1, 2>(r1[0]);
          float v27_data = tensorforge::broadcast<16, 1, 3>(r1[0]);
          float v28_tp{};
          float v29_tp{};
          float v30_tp{};
          float v31_tp{};
          tensorforge::transpose4x4b32(v28_tp, v29_tp, v30_tp, v31_tp, v24_data, v25_data, v26_data, v27_data);
          float v32_data = tensorforge::broadcast<16, 1, 0>(r1[1]);
          float v33_data = tensorforge::broadcast<16, 1, 1>(r1[1]);
          float v34_data = tensorforge::broadcast<16, 1, 2>(r1[1]);
          float v35_data = tensorforge::broadcast<16, 1, 3>(r1[1]);
          float v36_tp{};
          float v37_tp{};
          float v38_tp{};
          float v39_tp{};
          ...
          ir2[2] = (v80_acc[2]);
          ir2[3] = (v80_acc[3]);
          float v85_data = tensorforge::broadcast<16, 1, 4>(r1[0]);
          float v86_data = tensorforge::broadcast<16, 1, 5>(r1[0]);
          float v87_data = tensorforge::broadcast<16, 1, 6>(r1[0]);
          float v88_data = tensorforge::broadcast<16, 1, 7>(r1[0]);
          float v89_tp{};
          float v90_tp{};
          float v91_tp{};
          float v92_tp{};
          tensorforge::transpose4x4b32(v89_tp, v90_tp, v91_tp, v92_tp, v85_data, v86_data, v87_data, v88_data);
          float v93_data = tensorforge::broadcast<16, 1, 4>(r1[1]);
          float v94_data = tensorforge::broadcast<16, 1, 5>(r1[1]);
          float v95_data = tensorforge::broadcast<16, 1, 6>(r1[1]);
          float v96_data = tensorforge::broadcast<16, 1, 7>(r1[1]);
          float v97_tp{};
          float v98_tp{};
          float v99_tp{};
          float v100_tp{};
          ...
          ir2[6] = (v141_acc[2]);
          ir2[7] = (v141_acc[3]);
          float v146_data = tensorforge::broadcast<16, 1, 8>(r1[0]);
          float v147_data = tensorforge::broadcast<16, 1, 9>(r1[0]);
          float v148_data = tensorforge::broadcast<16, 1, 10>(r1[0]);
          float v149_data = tensorforge::broadcast<16, 1, 11>(r1[0]);
          float v150_tp{};
          float v151_tp{};
          float v152_tp{};
          float v153_tp{};
          tensorforge::transpose4x4b32(v150_tp, v151_tp, v152_tp, v153_tp, v146_data, v147_data, v148_data, v149_data);
          float v154_data = tensorforge::broadcast<16, 1, 8>(r1[1]);
          float v155_data = tensorforge::broadcast<16, 1, 9>(r1[1]);
          float v156_data = tensorforge::broadcast<16, 1, 10>(r1[1]);
          float v157_data = tensorforge::broadcast<16, 1, 11>(r1[1]);
          float v158_tp{};
          float v159_tp{};
          float v160_tp{};
          float v161_tp{};
          ...
          ir2[10] = (v202_acc[2]);
          ir2[11] = (v202_acc[3]);
          float v207_data = tensorforge::broadcast<16, 1, 12>(r1[0]);
          float v208_data = tensorforge::broadcast<16, 1, 13>(r1[0]);
          float v209_data = tensorforge::broadcast<16, 1, 14>(r1[0]);
          float v210_data = tensorforge::broadcast<16, 1, 15>(r1[0]);
          float v211_tp{};
          float v212_tp{};
          float v213_tp{};
          float v214_tp{};
          tensorforge::transpose4x4b32(v211_tp, v212_tp, v213_tp, v214_tp, v207_data, v208_data, v209_data, v210_data);
          float v215_data = tensorforge::broadcast<16, 1, 12>(r1[1]);
          float v216_data = tensorforge::broadcast<16, 1, 13>(r1[1]);
          float v217_data = tensorforge::broadcast<16, 1, 14>(r1[1]);
          float v218_data = tensorforge::broadcast<16, 1, 15>(r1[1]);
          float v219_tp{};
          float v220_tp{};
          float v221_tp{};
          float v222_tp{};
          ...
          if (v3_lead < 12) {
            ...
            for (int32_t v272_i1 = 0; v272_i1 < 16; ++v272_i1) {
              ...
              int32_t v282_a = v3_lead + (v272_i1 * 12);
