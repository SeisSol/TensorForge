    ...
    // m0 12×16(12×16) {0..12}×{0..16} strided({0..12}×{0..16})[0, 1] = m1 12×20(12×20) {0..12}×{0..20} strided({0..12}×{0..20})[0, -1]×m2 16×20(16×20) {0..16}×{0..20} strided({0..16}×{0..20})[1, -1]
    {
      ...
      for (size_t batchId0 = threadIdx.y + blockDim.y * (blockIdx.x); batchId0 < numElements0; batchId0 += (gridDim.x * blockDim.y)) {
        ...
        if (allowed) {
          ...
          // r2 = +(r0 * r1) + None
          // [(0, 12), (0, 16)] [(0, 20)]
          float v48_data = tensorforge::broadcast<16, 1, 0>(r1[0]);
          float v49_data = tensorforge::broadcast<16, 1, 1>(r1[0]);
          float v50_data = tensorforge::broadcast<16, 1, 2>(r1[0]);
          float v51_data = tensorforge::broadcast<16, 1, 3>(r1[0]);
          float v52_tp{};
          float v53_tp{};
          float v54_tp{};
          float v55_tp{};
          tensorforge::transpose4x4b32(v52_tp, v53_tp, v54_tp, v55_tp, v48_data, v49_data, v50_data, v51_data);
          float v56_data = tensorforge::broadcast<16, 1, 0>(r1[1]);
          float v57_data = tensorforge::broadcast<16, 1, 1>(r1[1]);
          float v58_data = tensorforge::broadcast<16, 1, 2>(r1[1]);
          float v59_data = tensorforge::broadcast<16, 1, 3>(r1[1]);
          float v60_tp{};
          float v61_tp{};
          float v62_tp{};
          float v63_tp{};
          ...
          r2[2] = (v104_acc[2]);
          r2[3] = (v104_acc[3]);
          float v109_data = tensorforge::broadcast<16, 1, 4>(r1[0]);
          float v110_data = tensorforge::broadcast<16, 1, 5>(r1[0]);
          float v111_data = tensorforge::broadcast<16, 1, 6>(r1[0]);
          float v112_data = tensorforge::broadcast<16, 1, 7>(r1[0]);
          float v113_tp{};
          float v114_tp{};
          float v115_tp{};
          float v116_tp{};
          tensorforge::transpose4x4b32(v113_tp, v114_tp, v115_tp, v116_tp, v109_data, v110_data, v111_data, v112_data);
          float v117_data = tensorforge::broadcast<16, 1, 4>(r1[1]);
          float v118_data = tensorforge::broadcast<16, 1, 5>(r1[1]);
          float v119_data = tensorforge::broadcast<16, 1, 6>(r1[1]);
          float v120_data = tensorforge::broadcast<16, 1, 7>(r1[1]);
          float v121_tp{};
          float v122_tp{};
          float v123_tp{};
          float v124_tp{};
          ...
          r2[6] = (v165_acc[2]);
          r2[7] = (v165_acc[3]);
          float v170_data = tensorforge::broadcast<16, 1, 8>(r1[0]);
          float v171_data = tensorforge::broadcast<16, 1, 9>(r1[0]);
          float v172_data = tensorforge::broadcast<16, 1, 10>(r1[0]);
          float v173_data = tensorforge::broadcast<16, 1, 11>(r1[0]);
          float v174_tp{};
          float v175_tp{};
          float v176_tp{};
          float v177_tp{};
          tensorforge::transpose4x4b32(v174_tp, v175_tp, v176_tp, v177_tp, v170_data, v171_data, v172_data, v173_data);
          float v178_data = tensorforge::broadcast<16, 1, 8>(r1[1]);
          float v179_data = tensorforge::broadcast<16, 1, 9>(r1[1]);
          float v180_data = tensorforge::broadcast<16, 1, 10>(r1[1]);
          float v181_data = tensorforge::broadcast<16, 1, 11>(r1[1]);
          float v182_tp{};
          float v183_tp{};
          float v184_tp{};
          float v185_tp{};
          ...
          r2[10] = (v226_acc[2]);
          r2[11] = (v226_acc[3]);
          float v231_data = tensorforge::broadcast<16, 1, 12>(r1[0]);
          float v232_data = tensorforge::broadcast<16, 1, 13>(r1[0]);
          float v233_data = tensorforge::broadcast<16, 1, 14>(r1[0]);
          float v234_data = tensorforge::broadcast<16, 1, 15>(r1[0]);
          float v235_tp{};
          float v236_tp{};
          float v237_tp{};
          float v238_tp{};
          tensorforge::transpose4x4b32(v235_tp, v236_tp, v237_tp, v238_tp, v231_data, v232_data, v233_data, v234_data);
          float v239_data = tensorforge::broadcast<16, 1, 12>(r1[1]);
          float v240_data = tensorforge::broadcast<16, 1, 13>(r1[1]);
          float v241_data = tensorforge::broadcast<16, 1, 14>(r1[1]);
          float v242_data = tensorforge::broadcast<16, 1, 15>(r1[1]);
          float v243_tp{};
          float v244_tp{};
          float v245_tp{};
          float v246_tp{};
          ...
          if (v7_lead < 12) {
            ...
            for (int32_t v296_i1 = 0; v296_i1 < 16; ++v296_i1) {
              ...
              glb_m0[(v7_lead + (v296_i1 * 12))] = v299_data;
            }
          }
        }
      }
