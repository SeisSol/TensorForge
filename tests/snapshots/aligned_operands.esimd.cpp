            ...
            if (allowed) {
              ...
              *(sycl::vec<float, 4>*)&s0[0 + 0 + 4 * item.get_local_id(0) + 64] = *(sycl::vec<float, 4>*)&glb_m2[0 + 0 + 4 * item.get_local_id(0) + 64];
              ...
              for (int32_t v355_n0 = 0; v355_n0 < 1; ++v355_n0) {
                int32_t v357_a = v355_n0 * 16;
                #pragma unroll
                for (int32_t v356_n1 = 0; v356_n1 < 8; ++v356_n1) {
                  int32_t v359_a = v357_a + (v356_n1 * 16);
              ...
              for (int32_t v364_i0 = 0; v364_i0 < 1; ++v364_i0) {
                int32_t v366_a = v364_i0 * 16;
                #pragma unroll
                for (int32_t v365_i1 = 0; v365_i1 < 8; ++v365_i1) {
                  int32_t v368_a = v366_a + (v365_i1 * 16);
                  tensorforge::intel_esimd::simd<float, 16> v369_data;
                  v369_data.copy_from(r1 + (v368_a));
                  v369_data.copy_to(glb_m0 + (v368_a));
                }
              }
            }
          }
