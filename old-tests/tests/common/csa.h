...
namespace csagen {
namespace reference {
void singleCsa(int M, int N, real Alpha, real *A, int lda, real Beta, real *B,
               int ldb);

real *findData(real *Data, unsigned Stride, unsigned BlockId);

template <typename AT, typename BT>
void csa(int M, int N, real Alpha, AT A, int lda, real Beta, BT B, int ldb,
         unsigned OffsetA, unsigned OffsetB, unsigned NumElements) {
