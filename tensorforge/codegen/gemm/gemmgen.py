...
from ...gemm_configuration import BLASlike, TensorForge
from ..common import BatchedOperationsAux
from tensorforge.common.basic_types import DataFlowDirection
from tensorforge.arch import getArchitectureIdentifiedBy
...
class GemmGen(object):
  ...
  def generate(self, cpp, routineCache):
    ...
    if isinstance(self._gemm_cfg, BLASlike):
    ...
    elif isinstance(self._gemm_cfg, TensorForge):
      aux = BatchedOperationsAux(self._arch.typename)

      matrix_a = tensorforge.interface.YatetoInterface.gen_matrix((m, k),
      ...
      matrix_b = tensorforge.interface.YatetoInterface.gen_matrix((k, n),
      ...
      matrix_c = tensorforge.interface.YatetoInterface.gen_matrix((m, n),
      ...
      try:
        ...
        forge_generator = tensorforge.generators.generator.Generator([tensorforge.generators.descriptions.GemmDescr(d.transA, d.transB, matrix_a, matrix_b, matrix_c, d.alpha, d.beta)], vm)
        ...
        print(f'ERROR from tensorforge: {err}')
        raise err
    else:
      gemm = {
        'M':            m.size(),
